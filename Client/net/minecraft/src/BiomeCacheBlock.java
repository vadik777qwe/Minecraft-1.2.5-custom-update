...
public class BiomeCacheBlock {
	...
	public BiomeCacheBlock(BiomeCache par1BiomeCache, int par2, int par3) {
		...
		xPosition = par2;
		zPosition = par3;
		BiomeCache.getChunkManager(par1BiomeCache).getTemperatures(
				temperatureValues, par2 << 4, par3 << 4, 16, 16);
		BiomeCache.getChunkManager(par1BiomeCache).getRainfall(rainfallValues,
				par2 << 4, par3 << 4, 16, 16);
		BiomeCache.getChunkManager(par1BiomeCache).getBiomeGenAt(biomes,
				par2 << 4, par3 << 4, 16, 16, false);
	}
