...
public class GuiSlider extends GuiButton {
	...
	public GuiSlider(int par1, int par2, int par3, EnumOptions par4EnumOptions,
			String par5Str, float par6) {
	...
	protected void mouseDragged(Minecraft par1Minecraft, int par2, int par3) {
		...
		drawTexturedModalRect(xPosition
				+ (int) (sliderValue * (float) (field_52008_a - 8)), yPosition,
				0, 66, 4, 20);
		drawTexturedModalRect(xPosition
				+ (int) (sliderValue * (float) (field_52008_a - 8)) + 4,
