...
public class GuiScreenAddServer extends GuiScreen {
	...
	public GuiScreenAddServer(GuiScreen par1GuiScreen,
	...
	public void drawScreen(int par1, int par2, float par3) {
		...
		drawCenteredString(fontRenderer,
				stringtranslate.translateKey("addServer.title"), width / 2,
				(height / 4 - 60) + 20, 0xffffff);
		drawString(fontRenderer,
				stringtranslate.translateKey("addServer.enterName"),
				width / 2 - 100, 63, 0xa0a0a0);
		drawString(fontRenderer,
				stringtranslate.translateKey("addServer.enterIp"),
