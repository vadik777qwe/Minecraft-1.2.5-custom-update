...
public class RenderList {
	...
	public void func_861_a(int par1, int par2, int par3, double par4,
			double par6, double par8) {
		field_1235_h = true;
		field_1236_g.clear();
		field_1242_a = par1;
		field_1241_b = par2;
	...
	public boolean func_862_a(int par1, int par2, int par3) {
		if (!field_1235_h) {
			...
			return par1 == field_1242_a && par2 == field_1241_b
					&& par3 == field_1240_c;
		}
	}
	...
	public void func_860_a() {
		...
		if (field_1236_g.remaining() > 0) {
			GL11.glPushMatrix();
			GL11.glTranslatef((float) ((double) field_1242_a - field_1239_d),
					(float) ((double) field_1241_b - field_1238_e),
					(float) ((double) field_1240_c - field_1237_f));
