...
public class KeyBinding {
	...
	public static void unPressAllKeys() {
		...
		for (Iterator iterator = keybindArray.iterator(); iterator.hasNext(); keybinding
				.unpressKey()) {
	...
	public static void resetKeyBindingArrayAndHash() {
		...
		for (Iterator iterator = keybindArray.iterator(); iterator.hasNext(); hash
				.addKey(keybinding.keyCode, keybinding)) {
			keybinding = (KeyBinding) iterator.next();
		}
	}
