...
public class PathPoint {
	...
	public static int makeHash(int par0, int par1, int par2) {
		return par1 & 0xff | (par0 & 0x7fff) << 8 | (par2 & 0x7fff) << 24
				| (par0 >= 0 ? 0 : 0x80000000) | (par2 >= 0 ? 0 : 0x8000);
	}
	...
	public boolean equals(Object par1Obj) {
		if (par1Obj instanceof PathPoint) {
			...
			return hash == pathpoint.hash && xCoord == pathpoint.xCoord
					&& yCoord == pathpoint.yCoord && zCoord == pathpoint.zCoord;
		} else {
			return false;
		}
	}
	...
	public String toString() {
		return (new StringBuilder()).append(xCoord).append(", ").append(yCoord)
