...
public class WorldChunkManagerHell extends WorldChunkManager {
	...
	public WorldChunkManagerHell(BiomeGenBase par1BiomeGenBase, float par2,
			float par3) {
	...
	public ChunkPosition findBiomePosition(int par1, int par2, int par3,
		...
		if (par4List.contains(biomeGenerator)) {
			return new ChunkPosition((par1 - par3)
					+ par5Random.nextInt(par3 * 2 + 1), 0, (par2 - par3)
					+ par5Random.nextInt(par3 * 2 + 1));
		} else {
			return null;
		}
	}
