...
public class SoundManager {
	...
	public void setListener(EntityLiving par1EntityLiving, float par2) {
		...
		if (par1EntityLiving == null) {
			...
			float f = par1EntityLiving.prevRotationYaw
					...
					* par2;
			double d = par1EntityLiving.prevPosX
					+ (par1EntityLiving.posX - par1EntityLiving.prevPosX)
					* (double) par2;
			double d1 = par1EntityLiving.prevPosY
					+ (par1EntityLiving.posY - par1EntityLiving.prevPosY)
					* (double) par2;
			double d2 = par1EntityLiving.prevPosZ
	...
	public void playStreaming(String par1Str, float par2, float par3,
		...
		SoundPoolEntry soundpoolentry = soundPoolStreaming
		...
		if (soundpoolentry != null && par5 > 0.0F) {
			...
			sndSystem.newStreamingSource(true, s, soundpoolentry.soundUrl,
					soundpoolentry.soundName, false, par2, par3, par4, 2,
					f * 4F);
	 ...
	 */
	public void playSound(String par1Str, float par2, float par3, float par4,
		...
		if (soundpoolentry != null && par5 > 0.0F) {
			...
			sndSystem.newSource(par5 > 1.0F, s, soundpoolentry.soundUrl,
					soundpoolentry.soundName, false, par2, par3, par4, 2, f);
