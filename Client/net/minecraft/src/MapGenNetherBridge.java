...
public class MapGenNetherBridge extends MapGenStructure {
	...
	public MapGenNetherBridge() {
		...
		spawnList.add(new SpawnListEntry(net.minecraft.src.EntityBlaze.class,
				10, 2, 3));
		spawnList.add(new SpawnListEntry(
				net.minecraft.src.EntityPigZombie.class, 10, 4, 4));
		spawnList.add(new SpawnListEntry(
				net.minecraft.src.EntityMagmaCube.class, 3, 4, 4));
	}
