...
public class NoiseGeneratorOctaves extends NoiseGenerator {
	...
	public double[] generateNoiseOctaves(double par1ArrayOfDouble[], int par2,
		...
		for (int j = 0; j < octaves; j++) {
			...
			d1 += l;
			d3 += l1;
			generatorCollection[j].func_805_a(par1ArrayOfDouble, d1, d2, d3,
					par5, par6, par7, par8 * d, par10 * d, par12 * d, d);
			d /= 2D;
		}
	...
	public double[] generateNoiseOctaves(double par1ArrayOfDouble[], int par2,
		...
		return generateNoiseOctaves(par1ArrayOfDouble, par2, 10, par3, par4, 1,
				par5, par6, 1.0D, par8);
	}
}
