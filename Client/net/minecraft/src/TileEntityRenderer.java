...
public class TileEntityRenderer {
	...
	private TileEntityRenderer() {
		...
		specialRendererMap.put(net.minecraft.src.TileEntitySign.class,
				new TileEntitySignRenderer());
		specialRendererMap.put(net.minecraft.src.TileEntityMobSpawner.class,
				new TileEntityMobSpawnerRenderer());
		specialRendererMap.put(net.minecraft.src.TileEntityPiston.class,
				new TileEntityRendererPiston());
		specialRendererMap.put(net.minecraft.src.TileEntityChest.class,
				new TileEntityChestRenderer());
		specialRendererMap.put(
				net.minecraft.src.TileEntityEnchantmentTable.class,
				new RenderEnchantmentTable());
		specialRendererMap.put(net.minecraft.src.TileEntityEndPortal.class,
				new RenderEndPortal());
	...
	public TileEntitySpecialRenderer getSpecialRendererForClass(Class par1Class) {
		...
		if (tileentityspecialrenderer == null
				&& par1Class != (net.minecraft.src.TileEntity.class)) {
