...
public class WeightedRandom {
	 ...
	 */
	public static WeightedRandomChoice getRandomItem(Random par0Random,
	...
	public static int getTotalWeight(
			WeightedRandomChoice par0ArrayOfWeightedRandomChoice[]) {
		int i = 0;
	 ...
	 */
	public static WeightedRandomChoice getRandomItem(Random par0Random,
			WeightedRandomChoice par1ArrayOfWeightedRandomChoice[], int par2) {
		if (par2 <= 0) {
			throw new IllegalArgumentException();
		}
	 ...
	 */
	public static WeightedRandomChoice getRandomItem(Random par0Random,
			WeightedRandomChoice par1ArrayOfWeightedRandomChoice[]) {
		return getRandomItem(par0Random, par1ArrayOfWeightedRandomChoice,
				getTotalWeight(par1ArrayOfWeightedRandomChoice));
	}
}
