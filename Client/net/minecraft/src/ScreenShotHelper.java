...
public class ScreenShotHelper {
	...
	public static String func_35879_a(File par0File, String par1Str, int par2,
			int par3) {
		try {
			...
			buffer.clear();
			GL11.glReadPixels(0, 0, par2, par3, GL11.GL_RGB,
			...
			if (par1Str == null) {
				for (int i = 1; (file1 = new File(file, (new StringBuilder())
						.append(s)
						.append(i != 1 ? (new StringBuilder()).append("_")
								.append(i).toString() : "").append(".png")
						.toString())).exists(); i++) {
				}
			} else {
			...
			return (new StringBuilder()).append("Saved screenshot as ")
					.append(file1.getName()).toString();
		} catch (Exception exception) {
			exception.printStackTrace();
			return (new StringBuilder()).append("Failed to save: ")
