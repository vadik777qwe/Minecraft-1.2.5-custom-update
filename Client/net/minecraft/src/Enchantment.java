...
public abstract class Enchantment {
	...
	/**
	 * Knockback enchantments for bows, the arrows will knockback the target
	 * when hit.
	 */
	...
	public String getName() {
		return (new StringBuilder()).append("enchantment.").append(name)
				.toString();
	}
	...
	public String getTranslatedName(int par1) {
		...
		return (new StringBuilder())
				...
				.append(StatCollector.translateToLocal((new StringBuilder())
						.append("enchantment.level.").append(par1).toString()))
				.toString();
	}
