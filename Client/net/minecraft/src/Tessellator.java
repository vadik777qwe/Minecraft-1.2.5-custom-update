...
public class Tessellator {
	/**
	 * Boolean used to check whether quads should be drawn as four triangles.
	 * Initialized to true and never changed.
	 */
	...
	public void setColorOpaque_F(float par1, float par2, float par3) {
		setColorOpaque((int) (par1 * 255F), (int) (par2 * 255F),
				(int) (par3 * 255F));
	}
	...
	public void setColorRGBA_F(float par1, float par2, float par3, float par4) {
		setColorRGBA((int) (par1 * 255F), (int) (par2 * 255F),
				(int) (par3 * 255F), (int) (par4 * 255F));
	}
	 ...
	 */
	public void addVertexWithUV(double par1, double par3, double par5,
			double par7, double par9) {
