...
public class EntityList {
	...
	static {
		...
		addMapping(net.minecraft.src.EntitySmallFireball.class,
				"SmallFireball", 13);
		addMapping(net.minecraft.src.EntityEnderPearl.class,
				"ThrownEnderpearl", 14);
		addMapping(net.minecraft.src.EntityEnderEye.class, "EyeOfEnderSignal",
				15);
		addMapping(net.minecraft.src.EntityPotion.class, "ThrownPotion", 16);
		addMapping(net.minecraft.src.EntityExpBottle.class, "ThrownExpBottle",
				17);
		...
		addMapping(net.minecraft.src.EntityZombie.class, "Zombie", 54, 44975,
				0x799c65);
		addMapping(net.minecraft.src.EntitySlime.class, "Slime", 55, 0x51a03e,
				0x7ebf6e);
		addMapping(net.minecraft.src.EntityGhast.class, "Ghast", 56, 0xf9f9f9,
				0xbcbcbc);
		...
		addMapping(net.minecraft.src.EntitySilverfish.class, "Silverfish", 60,
				0x6e6e6e, 0x303030);
		addMapping(net.minecraft.src.EntityBlaze.class, "Blaze", 61, 0xf6b201,
				0xfff87e);
		...
		addMapping(net.minecraft.src.EntityPig.class, "Pig", 90, 0xf0a5a2,
				0xdb635f);
		addMapping(net.minecraft.src.EntitySheep.class, "Sheep", 91, 0xe7e7e7,
				0xffb5b5);
		addMapping(net.minecraft.src.EntityCow.class, "Cow", 92, 0x443626,
				0xa1a1a1);
		addMapping(net.minecraft.src.EntityChicken.class, "Chicken", 93,
				0xa1a1a1, 0xff0000);
		addMapping(net.minecraft.src.EntitySquid.class, "Squid", 94, 0x223b4d,
				0x708899);
		addMapping(net.minecraft.src.EntityWolf.class, "Wolf", 95, 0xd7d3d3,
				0xceaf96);
		...
		addMapping(net.minecraft.src.EntityOcelot.class, "Ozelot", 98,
				0xefde7d, 0x564434);
		...
		addMapping(net.minecraft.src.EntityVillager.class, "Villager", 120,
				0x563c33, 0xbd8b72);
		addMapping(net.minecraft.src.EntityEnderCrystal.class, "EnderCrystal",
				200);
	}
}
