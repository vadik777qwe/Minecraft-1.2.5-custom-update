...
public abstract class GuiConfirmOpenLink extends GuiYesNo {
	...
	public GuiConfirmOpenLink(GuiScreen par1GuiScreen, String par2Str, int par3) {
		super(par1GuiScreen, StringTranslate.getInstance().translateKey(
				"chat.link.confirm"), par2Str, par3);
	 ...
	 */
	public void initGui() {
		controlList.add(new GuiButton(0, (width / 3 - 83) + 0, height / 6 + 96,
				100, 20, buttonText1));
		controlList.add(new GuiButton(2, (width / 3 - 83) + 105,
				height / 6 + 96, 100, 20, field_50053_b));
		controlList.add(new GuiButton(1, (width / 3 - 83) + 210,
				height / 6 + 96, 100, 20, buttonText2));
	}
	...
	public void drawScreen(int par1, int par2, float par3) {
		...
		drawCenteredString(fontRenderer, field_50054_a, width / 2, 110,
				0xffcccc);
	}
}
