...
public class ItemSign extends Item {
	...
	public boolean onItemUse(ItemStack par1ItemStack,
		...
		if (par7 == 1) {
			int i = MathHelper
					.floor_double((double) (((par2EntityPlayer.rotationYaw + 180F) * 16F) / 360F) + 0.5D) & 0xf;
			par3World.setBlockAndMetadataWithNotify(par4, par5, par6,
					Block.signPost.blockID, i);
		} else {
			par3World.setBlockAndMetadataWithNotify(par4, par5, par6,
					Block.signWall.blockID, par7);
		}

		par1ItemStack.stackSize--;
		TileEntitySign tileentitysign = (TileEntitySign) par3World
