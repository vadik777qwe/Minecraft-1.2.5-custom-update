...
public class MinecraftAppletImpl extends Minecraft {
	...
	public MinecraftAppletImpl(MinecraftApplet par1MinecraftApplet,
			Component par2Component, Canvas par3Canvas,
			MinecraftApplet par4MinecraftApplet, int par5, int par6,
			boolean par7) {
	 ...
	 */
	public void displayUnexpectedThrowable(
			UnexpectedThrowable par1UnexpectedThrowable) {
		mainFrame.removeAll();
