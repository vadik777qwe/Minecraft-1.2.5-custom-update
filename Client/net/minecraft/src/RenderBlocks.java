...
public class RenderBlocks {
	 ...
	 * default texture
	 */
	public void renderBlockUsingTexture(Block par1Block, int par2, int par3,
			int par4, int par5) {
	 ...
	 */
	public void renderBlockAllFaces(Block par1Block, int par2, int par3,
			int par4) {
		renderAllFaces = true;
		renderBlockByRenderType(par1Block, par2, par3, par4);
		renderAllFaces = false;
	...
	public boolean renderBlockByRenderType(Block par1Block, int par2, int par3,
		...
		if (i == 9) {
			return renderBlockMinecartTrack((BlockRail) par1Block, par2, par3,
					par4);
		}
		...
		if (i == 27) {
			return renderBlockDragonEgg((BlockDragonEgg) par1Block, par2, par3,
					par4);
		}
		...
		if (i == 21) {
			return renderBlockFenceGate((BlockFenceGate) par1Block, par2, par3,
					par4);
		}
	 ...
	 */
	private boolean renderBlockEndPortalFrame(Block par1Block, int par2,
			int par3, int par4) {
	...
	private boolean renderBlockBed(Block par1Block, int par2, int par3, int par4) {
		...
		float f14 = f2;
		float f15 = f3;
		int k = par1Block.getMixedBrightnessForBlock(blockAccess, par2, par3,
				par4);
		...
		if (l != 2
			...
			tessellator.setBrightness(par1Block.minZ <= 0.0D ? par1Block
					.getMixedBrightnessForBlock(blockAccess, par2, par3,
							par4 - 1) : k);
			tessellator.setColorOpaque_F(f8, f11, f14);
			flipTexture = i1 == 2;
			renderEastFace(par1Block, par2, par3, par4,
					par1Block.getBlockTexture(blockAccess, par2, par3, par4, 2));
		}

		if (l != 3
				&& (renderAllFaces || par1Block.shouldSideBeRendered(
						blockAccess, par2, par3, par4 + 1, 3))) {
			tessellator.setBrightness(par1Block.maxZ >= 1.0D ? par1Block
					.getMixedBrightnessForBlock(blockAccess, par2, par3,
							par4 + 1) : k);
			tessellator.setColorOpaque_F(f8, f11, f14);
			flipTexture = i1 == 3;
			renderWestFace(par1Block, par2, par3, par4,
					par1Block.getBlockTexture(blockAccess, par2, par3, par4, 3));
		}
		...
		if (l != 4
			...
			flipTexture = i1 == 4;
			renderNorthFace(par1Block, par2, par3, par4,
					par1Block.getBlockTexture(blockAccess, par2, par3, par4, 4));
		}
		...
		if (l != 5
			...
			tessellator.setColorOpaque_F(f9, f12, f15);
			flipTexture = i1 == 5;
			renderSouthFace(par1Block, par2, par3, par4,
					par1Block.getBlockTexture(blockAccess, par2, par3, par4, 5));
		}
	...
	public boolean renderBlockTorch(Block par1Block, int par2, int par3,
		...
		if (i == 1) {
			...
			renderTorchAtAngle(par1Block, par2, (double) par3 + d2,
					(double) par4 - d1, 0.0D, -d);
		} else if (i == 4) {
			renderTorchAtAngle(par1Block, par2, (double) par3 + d2,
					(double) par4 + d1, 0.0D, d);
		} else {
	 ...
	 */
	private boolean renderBlockRepeater(Block par1Block, int par2, int par3,
			int par4) {
		int i = blockAccess.getBlockMetadata(par2, par3, par4);
		int j = i & 3;
		int k = (i & 0xc) >> 2;
		...
		renderTorchAtAngle(par1Block, (double) par2 + d1, (double) par3 + d,
				(double) par4 + d2, 0.0D, 0.0D);
		renderTorchAtAngle(par1Block, (double) par2 + d3, (double) par3 + d,
				(double) par4 + d4, 0.0D, 0.0D);
	 ...
	 */
	public void renderPistonBaseAllFaces(Block par1Block, int par2, int par3,
			int par4) {
		renderAllFaces = true;
	 ...
	 */
	private boolean renderPistonBase(Block par1Block, int par2, int par3,
	 ...
	 */
	private void renderPistonRodUD(double par1, double par3, double par5,
			double par7, double par9, double par11, float par13, double par14) {
		int i = 108;
	 ...
	 */
	private void renderPistonRodSN(double par1, double par3, double par5,
			double par7, double par9, double par11, float par13, double par14) {
		int i = 108;
	 ...
	 */
	private void renderPistonRodEW(double par1, double par3, double par5,
			double par7, double par9, double par11, float par13, double par14) {
		int i = 108;
	 ...
	 */
	public void renderPistonExtensionAllFaces(Block par1Block, int par2,
	 ...
	 */
	private boolean renderPistonExtension(Block par1Block, int par2, int par3,
			int par4, boolean par5) {
		int i = blockAccess.getBlockMetadata(par2, par3, par4);
		...
		case 0:
			...
			renderStandardBlock(par1Block, par2, par3, par4);
			renderPistonRodUD((float) par2 + 0.375F, (float) par2 + 0.625F,
					(float) par3 + 0.25F, (float) par3 + 0.25F + f1,
					(float) par4 + 0.625F, (float) par4 + 0.625F, f * 0.8F, d);
			renderPistonRodUD((float) par2 + 0.625F, (float) par2 + 0.375F,
					(float) par3 + 0.25F, (float) par3 + 0.25F + f1,
					(float) par4 + 0.375F, (float) par4 + 0.375F, f * 0.8F, d);
			renderPistonRodUD((float) par2 + 0.375F, (float) par2 + 0.375F,
					(float) par3 + 0.25F, (float) par3 + 0.25F + f1,
					(float) par4 + 0.375F, (float) par4 + 0.625F, f * 0.6F, d);
			renderPistonRodUD((float) par2 + 0.625F, (float) par2 + 0.625F,
					(float) par3 + 0.25F, (float) par3 + 0.25F + f1,
					(float) par4 + 0.625F, (float) par4 + 0.375F, f * 0.6F, d);
			break;
		...
		case 1:
			...
			renderStandardBlock(par1Block, par2, par3, par4);
			renderPistonRodUD((float) par2 + 0.375F, (float) par2 + 0.625F,
					(((float) par3 - 0.25F) + 1.0F) - f1,
					((float) par3 - 0.25F) + 1.0F, (float) par4 + 0.625F,
					(float) par4 + 0.625F, f * 0.8F, d);
			renderPistonRodUD((float) par2 + 0.625F, (float) par2 + 0.375F,
					(((float) par3 - 0.25F) + 1.0F) - f1,
					((float) par3 - 0.25F) + 1.0F, (float) par4 + 0.375F,
					(float) par4 + 0.375F, f * 0.8F, d);
			renderPistonRodUD((float) par2 + 0.375F, (float) par2 + 0.375F,
					(((float) par3 - 0.25F) + 1.0F) - f1,
					((float) par3 - 0.25F) + 1.0F, (float) par4 + 0.375F,
					(float) par4 + 0.625F, f * 0.6F, d);
			renderPistonRodUD((float) par2 + 0.625F, (float) par2 + 0.625F,
					(((float) par3 - 0.25F) + 1.0F) - f1,
					((float) par3 - 0.25F) + 1.0F, (float) par4 + 0.625F,
					(float) par4 + 0.375F, f * 0.6F, d);
			break;
		...
		case 2:
			...
			renderStandardBlock(par1Block, par2, par3, par4);
			renderPistonRodSN((float) par2 + 0.375F, (float) par2 + 0.375F,
					(float) par3 + 0.625F, (float) par3 + 0.375F,
					(float) par4 + 0.25F, (float) par4 + 0.25F + f1, f * 0.6F,
					d);
			renderPistonRodSN((float) par2 + 0.625F, (float) par2 + 0.625F,
					(float) par3 + 0.375F, (float) par3 + 0.625F,
					(float) par4 + 0.25F, (float) par4 + 0.25F + f1, f * 0.6F,
					d);
			renderPistonRodSN((float) par2 + 0.375F, (float) par2 + 0.625F,
					(float) par3 + 0.375F, (float) par3 + 0.375F,
					(float) par4 + 0.25F, (float) par4 + 0.25F + f1, f * 0.5F,
					d);
			renderPistonRodSN((float) par2 + 0.625F, (float) par2 + 0.375F,
					(float) par3 + 0.625F, (float) par3 + 0.625F,
					(float) par4 + 0.25F, (float) par4 + 0.25F + f1, f, d);
			break;
		...
		case 3:
			...
			renderPistonRodSN((float) par2 + 0.375F, (float) par2 + 0.375F,
					(float) par3 + 0.625F, (float) par3 + 0.375F,
					(((float) par4 - 0.25F) + 1.0F) - f1,
					((float) par4 - 0.25F) + 1.0F, f * 0.6F, d);
			renderPistonRodSN((float) par2 + 0.625F, (float) par2 + 0.625F,
					(float) par3 + 0.375F, (float) par3 + 0.625F,
					(((float) par4 - 0.25F) + 1.0F) - f1,
					((float) par4 - 0.25F) + 1.0F, f * 0.6F, d);
			renderPistonRodSN((float) par2 + 0.375F, (float) par2 + 0.625F,
					(float) par3 + 0.375F, (float) par3 + 0.375F,
					(((float) par4 - 0.25F) + 1.0F) - f1,
					((float) par4 - 0.25F) + 1.0F, f * 0.5F, d);
			renderPistonRodSN((float) par2 + 0.625F, (float) par2 + 0.375F,
					(float) par3 + 0.625F, (float) par3 + 0.625F,
					(((float) par4 - 0.25F) + 1.0F) - f1,
					((float) par4 - 0.25F) + 1.0F, f, d);
			break;
		...
		case 4:
			...
			renderStandardBlock(par1Block, par2, par3, par4);
			renderPistonRodEW((float) par2 + 0.25F, (float) par2 + 0.25F + f1,
					(float) par3 + 0.375F, (float) par3 + 0.375F,
					(float) par4 + 0.625F, (float) par4 + 0.375F, f * 0.5F, d);
			renderPistonRodEW((float) par2 + 0.25F, (float) par2 + 0.25F + f1,
					(float) par3 + 0.625F, (float) par3 + 0.625F,
					(float) par4 + 0.375F, (float) par4 + 0.625F, f, d);
			renderPistonRodEW((float) par2 + 0.25F, (float) par2 + 0.25F + f1,
					(float) par3 + 0.375F, (float) par3 + 0.625F,
					(float) par4 + 0.375F, (float) par4 + 0.375F, f * 0.6F, d);
			renderPistonRodEW((float) par2 + 0.25F, (float) par2 + 0.25F + f1,
					(float) par3 + 0.625F, (float) par3 + 0.375F,
					(float) par4 + 0.625F, (float) par4 + 0.625F, f * 0.6F, d);
			break;
		...
		case 5:
			...
			renderStandardBlock(par1Block, par2, par3, par4);
			renderPistonRodEW((((float) par2 - 0.25F) + 1.0F) - f1,
					((float) par2 - 0.25F) + 1.0F, (float) par3 + 0.375F,
					(float) par3 + 0.375F, (float) par4 + 0.625F,
					(float) par4 + 0.375F, f * 0.5F, d);
			renderPistonRodEW((((float) par2 - 0.25F) + 1.0F) - f1,
					((float) par2 - 0.25F) + 1.0F, (float) par3 + 0.625F,
					(float) par3 + 0.625F, (float) par4 + 0.375F,
					(float) par4 + 0.625F, f, d);
			renderPistonRodEW((((float) par2 - 0.25F) + 1.0F) - f1,
					((float) par2 - 0.25F) + 1.0F, (float) par3 + 0.375F,
					(float) par3 + 0.625F, (float) par4 + 0.375F,
					(float) par4 + 0.375F, f * 0.6F, d);
	...
	public boolean renderBlockLever(Block par1Block, int par2, int par3,
		...
		if (j == 5) {
			par1Block.setBlockBounds(0.5F - f1, 0.0F, 0.5F - f, 0.5F + f1, f2,
					0.5F + f);
		} else if (j == 6) {
			par1Block.setBlockBounds(0.5F - f, 0.0F, 0.5F - f1, 0.5F + f, f2,
					0.5F + f1);
		} else if (j == 4) {
			par1Block.setBlockBounds(0.5F - f1, 0.5F - f, 1.0F - f2, 0.5F + f1,
					0.5F + f, 1.0F);
		} else if (j == 3) {
			par1Block.setBlockBounds(0.5F - f1, 0.5F - f, 0.0F, 0.5F + f1,
					0.5F + f, f2);
		} else if (j == 2) {
			par1Block.setBlockBounds(1.0F - f2, 0.5F - f, 0.5F - f1, 1.0F,
					0.5F + f, 0.5F + f1);
		} else if (j == 1) {
			par1Block.setBlockBounds(0.0F, 0.5F - f, 0.5F - f1, f2, 0.5F + f,
					0.5F + f1);
		}
		...
		for (int k1 = 0; k1 < 6; k1++) {
			...
			tessellator.addVertexWithUV(vec3d.xCoord, vec3d.yCoord,
					vec3d.zCoord, f4, f7);
			tessellator.addVertexWithUV(vec3d1.xCoord, vec3d1.yCoord,
					vec3d1.zCoord, f5, f7);
			tessellator.addVertexWithUV(vec3d2.xCoord, vec3d2.yCoord,
					vec3d2.zCoord, f5, f6);
			tessellator.addVertexWithUV(vec3d3.xCoord, vec3d3.yCoord,
					vec3d3.zCoord, f4, f6);
		}
	...
	public boolean renderBlockFire(Block par1Block, int par2, int par3, int par4) {
		...
		if (blockAccess.isBlockNormalCube(par2, par3 - 1, par4)
			...
			tessellator
					.addVertexWithUV(d16, (float) par3 + f, par4 + 1, d2, d4);
			...
			tessellator
					.addVertexWithUV(d18, (float) par3 + f, par4 + 0, d2, d4);
			...
			tessellator
					.addVertexWithUV(par2 + 1, (float) par3 + f, d22, d2, d4);
			...
			tessellator
					.addVertexWithUV(par2 + 0, (float) par3 + f, d20, d2, d4);
			...
			if (Block.fire.canBlockCatchFire(blockAccess, par2, par3 + 1, par4)) {
				...
				if ((par2 + par3 + par4 & 1) == 0) {
					tessellator.addVertexWithUV(d19, (float) par3 + f1,
							par4 + 0, d3, d5);
					tessellator
							.addVertexWithUV(d11, par3 + 0, par4 + 0, d3, d7);
					tessellator
							.addVertexWithUV(d11, par3 + 0, par4 + 1, d1, d7);
					tessellator.addVertexWithUV(d19, (float) par3 + f1,
							par4 + 1, d1, d5);
					d1 = (float) j / 256F;
					...
					tessellator.addVertexWithUV(d21, (float) par3 + f1,
							par4 + 1, d3, d5);
					tessellator
							.addVertexWithUV(d13, par3 + 0, par4 + 1, d3, d7);
					tessellator
							.addVertexWithUV(d13, par3 + 0, par4 + 0, d1, d7);
					tessellator.addVertexWithUV(d21, (float) par3 + f1,
							par4 + 0, d1, d5);
				} else {
					tessellator.addVertexWithUV(par2 + 0, (float) par3 + f1,
							d24, d3, d5);
					tessellator
							.addVertexWithUV(par2 + 0, par3 + 0, d17, d3, d7);
					tessellator
							.addVertexWithUV(par2 + 1, par3 + 0, d17, d1, d7);
					tessellator.addVertexWithUV(par2 + 1, (float) par3 + f1,
							d24, d1, d5);
					d1 = (float) j / 256F;
					d3 = ((float) j + 15.99F) / 256F;
					d5 = (float) (k + 16) / 256F;
					...
					tessellator.addVertexWithUV(par2 + 1, (float) par3 + f1,
							d23, d3, d5);
					tessellator
							.addVertexWithUV(par2 + 1, par3 + 0, d15, d3, d7);
					tessellator
							.addVertexWithUV(par2 + 0, par3 + 0, d15, d1, d7);
					tessellator.addVertexWithUV(par2 + 0, (float) par3 + f1,
							d23, d1, d5);
				}
			}
	...
	public boolean renderBlockRedstoneWire(Block par1Block, int par2, int par3,
		...
		boolean flag = BlockRedstoneWire.isPowerProviderOrWire(blockAccess,
				par2 - 1, par3, par4, 1)
				|| !blockAccess.isBlockNormalCube(par2 - 1, par3, par4)
				&& BlockRedstoneWire.isPowerProviderOrWire(blockAccess,
						par2 - 1, par3 - 1, par4, -1);
		boolean flag1 = BlockRedstoneWire.isPowerProviderOrWire(blockAccess,
				par2 + 1, par3, par4, 3)
				|| !blockAccess.isBlockNormalCube(par2 + 1, par3, par4)
				&& BlockRedstoneWire.isPowerProviderOrWire(blockAccess,
						par2 + 1, par3 - 1, par4, -1);
		boolean flag2 = BlockRedstoneWire.isPowerProviderOrWire(blockAccess,
				par2, par3, par4 - 1, 2)
				|| !blockAccess.isBlockNormalCube(par2, par3, par4 - 1)
				&& BlockRedstoneWire.isPowerProviderOrWire(blockAccess, par2,
						par3 - 1, par4 - 1, -1);
		boolean flag3 = BlockRedstoneWire.isPowerProviderOrWire(blockAccess,
				par2, par3, par4 + 1, 0)
				|| !blockAccess.isBlockNormalCube(par2, par3, par4 + 1)
				&& BlockRedstoneWire.isPowerProviderOrWire(blockAccess, par2,
						par3 - 1, par4 + 1, -1);
		...
		if (byte0 == 0) {
			...
			tessellator.addVertexWithUV(f6, (double) par3 + 0.015625D, f8, d2,
					d6);
			tessellator.addVertexWithUV(f6, (double) par3 + 0.015625D, f7, d2,
					d4);
			tessellator.addVertexWithUV(f5, (double) par3 + 0.015625D, f7, d,
					d4);
			tessellator.addVertexWithUV(f5, (double) par3 + 0.015625D, f8, d,
					d6);
			...
			tessellator.addVertexWithUV(f6, (double) par3 + 0.015625D, f8, d2,
					d6);
			tessellator.addVertexWithUV(f6, (double) par3 + 0.015625D, f7, d,
					d6);
			tessellator.addVertexWithUV(f5, (double) par3 + 0.015625D, f7, d,
					d4);
			tessellator.addVertexWithUV(f5, (double) par3 + 0.015625D, f8, d2,
					d4);
			tessellator.setColorOpaque_F(f, f, f);
			tessellator.addVertexWithUV(f6, (double) par3 + 0.015625D, f8, d2,
					d6 + 0.0625D);
		...
		if (!blockAccess.isBlockNormalCube(par2, par3 + 1, par4)) {
			...
			if (blockAccess.isBlockNormalCube(par2 - 1, par3, par4)
				...
				tessellator.addVertexWithUV((double) par2 + 0.015625D,
						(float) (par3 + 1) + 0.021875F, par4 + 1, d3, d5);
				tessellator.addVertexWithUV((double) par2 + 0.015625D,
						par3 + 0, par4 + 1, d1, d5);
				tessellator.addVertexWithUV((double) par2 + 0.015625D,
						par3 + 0, par4 + 0, d1, d7);
				tessellator.addVertexWithUV((double) par2 + 0.015625D,
						(float) (par3 + 1) + 0.021875F, par4 + 0, d3, d7);
				tessellator.setColorOpaque_F(f, f, f);
				tessellator.addVertexWithUV((double) par2 + 0.015625D,
						(float) (par3 + 1) + 0.021875F, par4 + 1, d3,
						d5 + 0.0625D);
				tessellator.addVertexWithUV((double) par2 + 0.015625D,
						par3 + 0, par4 + 1, d1, d5 + 0.0625D);
				tessellator.addVertexWithUV((double) par2 + 0.015625D,
						par3 + 0, par4 + 0, d1, d7 + 0.0625D);
				tessellator.addVertexWithUV((double) par2 + 0.015625D,
						(float) (par3 + 1) + 0.021875F, par4 + 0, d3,
						d7 + 0.0625D);
			}
			...
			if (blockAccess.isBlockNormalCube(par2 + 1, par3, par4)
					&& blockAccess.getBlockId(par2 + 1, par3 + 1, par4) == Block.redstoneWire.blockID) {
				tessellator.setColorOpaque_F(f * f2, f * f3, f * f4);
				tessellator.addVertexWithUV((double) (par2 + 1) - 0.015625D,
						par3 + 0, par4 + 1, d1, d7);
				tessellator.addVertexWithUV((double) (par2 + 1) - 0.015625D,
						(float) (par3 + 1) + 0.021875F, par4 + 1, d3, d7);
				tessellator.addVertexWithUV((double) (par2 + 1) - 0.015625D,
						(float) (par3 + 1) + 0.021875F, par4 + 0, d3, d5);
				tessellator.addVertexWithUV((double) (par2 + 1) - 0.015625D,
						par3 + 0, par4 + 0, d1, d5);
				tessellator.setColorOpaque_F(f, f, f);
				tessellator.addVertexWithUV((double) (par2 + 1) - 0.015625D,
						par3 + 0, par4 + 1, d1, d7 + 0.0625D);
				tessellator.addVertexWithUV((double) (par2 + 1) - 0.015625D,
						(float) (par3 + 1) + 0.021875F, par4 + 1, d3,
						d7 + 0.0625D);
				tessellator.addVertexWithUV((double) (par2 + 1) - 0.015625D,
			...
			if (blockAccess.isBlockNormalCube(par2, par3, par4 - 1)
				...
				tessellator.addVertexWithUV(par2 + 1, par3 + 0,
						(double) par4 + 0.015625D, d1, d7);
				tessellator.addVertexWithUV(par2 + 1,
						(float) (par3 + 1) + 0.021875F,
						(double) par4 + 0.015625D, d3, d7);
				tessellator.addVertexWithUV(par2 + 0,
						(float) (par3 + 1) + 0.021875F,
						(double) par4 + 0.015625D, d3, d5);
				tessellator.addVertexWithUV(par2 + 0, par3 + 0,
						(double) par4 + 0.015625D, d1, d5);
				tessellator.setColorOpaque_F(f, f, f);
				tessellator.addVertexWithUV(par2 + 1, par3 + 0,
						(double) par4 + 0.015625D, d1, d7 + 0.0625D);
				tessellator.addVertexWithUV(par2 + 1,
						(float) (par3 + 1) + 0.021875F,
						(double) par4 + 0.015625D, d3, d7 + 0.0625D);
				tessellator.addVertexWithUV(par2 + 0,
						(float) (par3 + 1) + 0.021875F,
						(double) par4 + 0.015625D, d3, d5 + 0.0625D);
				tessellator.addVertexWithUV(par2 + 0, par3 + 0,
						(double) par4 + 0.015625D, d1, d5 + 0.0625D);
			}
			...
			if (blockAccess.isBlockNormalCube(par2, par3, par4 + 1)
				...
				tessellator.addVertexWithUV(par2 + 1,
						(float) (par3 + 1) + 0.021875F,
						(double) (par4 + 1) - 0.015625D, d3, d5);
				tessellator.addVertexWithUV(par2 + 1, par3 + 0,
						(double) (par4 + 1) - 0.015625D, d1, d5);
				tessellator.addVertexWithUV(par2 + 0, par3 + 0,
						(double) (par4 + 1) - 0.015625D, d1, d7);
				tessellator.addVertexWithUV(par2 + 0,
						(float) (par3 + 1) + 0.021875F,
						(double) (par4 + 1) - 0.015625D, d3, d7);
				tessellator.setColorOpaque_F(f, f, f);
				tessellator.addVertexWithUV(par2 + 1,
						(float) (par3 + 1) + 0.021875F,
						(double) (par4 + 1) - 0.015625D, d3, d5 + 0.0625D);
				tessellator.addVertexWithUV(par2 + 1, par3 + 0,
						(double) (par4 + 1) - 0.015625D, d1, d5 + 0.0625D);
				tessellator.addVertexWithUV(par2 + 0, par3 + 0,
						(double) (par4 + 1) - 0.015625D, d1, d7 + 0.0625D);
				tessellator.addVertexWithUV(par2 + 0,
						(float) (par3 + 1) + 0.021875F,
						(double) (par4 + 1) - 0.015625D, d3, d7 + 0.0625D);
			}
		}
	 ...
	 */
	public boolean renderBlockMinecartTrack(BlockRail par1BlockRail, int par2,
			int par3, int par4) {
		Tessellator tessellator = Tessellator.instance;
		int i = blockAccess.getBlockMetadata(par2, par3, par4);
		...
		tessellator.setBrightness(par1BlockRail.getMixedBrightnessForBlock(
				blockAccess, par2, par3, par4));
		tessellator.setColorOpaque_F(1.0F, 1.0F, 1.0F);
		int k = (j & 0xf) << 4;
		int l = j & 0xf0;
	...
	public boolean renderBlockLadder(Block par1Block, int par2, int par3,
		...
		if (k == 5) {
			tessellator.addVertexWithUV((double) par2 + d5, (double) (par3 + 1)
					+ d4, (double) (par4 + 1) + d4, d, d2);
			tessellator.addVertexWithUV((double) par2 + d5, (double) (par3 + 0)
					- d4, (double) (par4 + 1) + d4, d, d3);
			tessellator.addVertexWithUV((double) par2 + d5, (double) (par3 + 0)
					- d4, (double) (par4 + 0) - d4, d1, d3);
			tessellator.addVertexWithUV((double) par2 + d5, (double) (par3 + 1)
					+ d4, (double) (par4 + 0) - d4, d1, d2);
		}

		if (k == 4) {
			tessellator.addVertexWithUV((double) (par2 + 1) - d5,
					(double) (par3 + 0) - d4, (double) (par4 + 1) + d4, d1, d3);
			tessellator.addVertexWithUV((double) (par2 + 1) - d5,
					(double) (par3 + 1) + d4, (double) (par4 + 1) + d4, d1, d2);
			tessellator.addVertexWithUV((double) (par2 + 1) - d5,
					(double) (par3 + 1) + d4, (double) (par4 + 0) - d4, d, d2);
			tessellator.addVertexWithUV((double) (par2 + 1) - d5,
					(double) (par3 + 0) - d4, (double) (par4 + 0) - d4, d, d3);
		}

		if (k == 3) {
			tessellator.addVertexWithUV((double) (par2 + 1) + d4,
					(double) (par3 + 0) - d4, (double) par4 + d5, d1, d3);
			tessellator.addVertexWithUV((double) (par2 + 1) + d4,
					(double) (par3 + 1) + d4, (double) par4 + d5, d1, d2);
			tessellator.addVertexWithUV((double) (par2 + 0) - d4,
					(double) (par3 + 1) + d4, (double) par4 + d5, d, d2);
			tessellator.addVertexWithUV((double) (par2 + 0) - d4,
					(double) (par3 + 0) - d4, (double) par4 + d5, d, d3);
		}

		if (k == 2) {
			tessellator.addVertexWithUV((double) (par2 + 1) + d4,
					(double) (par3 + 1) + d4, (double) (par4 + 1) - d5, d, d2);
			tessellator.addVertexWithUV((double) (par2 + 1) + d4,
					(double) (par3 + 0) - d4, (double) (par4 + 1) - d5, d, d3);
			tessellator.addVertexWithUV((double) (par2 + 0) - d4,
					(double) (par3 + 0) - d4, (double) (par4 + 1) - d5, d1, d3);
			tessellator.addVertexWithUV((double) (par2 + 0) - d4,
					(double) (par3 + 1) + d4, (double) (par4 + 1) - d5, d1, d2);
		}
	...
	public boolean renderBlockVine(Block par1Block, int par2, int par3, int par4) {
		...
		if ((k & 2) != 0) {
			tessellator.addVertexWithUV((double) par2 + d4, par3 + 1, par4 + 1,
					d, d2);
			tessellator.addVertexWithUV((double) par2 + d4, par3 + 0, par4 + 1,
					d, d3);
			tessellator.addVertexWithUV((double) par2 + d4, par3 + 0, par4 + 0,
					d1, d3);
			tessellator.addVertexWithUV((double) par2 + d4, par3 + 1, par4 + 0,
					d1, d2);
			tessellator.addVertexWithUV((double) par2 + d4, par3 + 1, par4 + 0,
					d1, d2);
			tessellator.addVertexWithUV((double) par2 + d4, par3 + 0, par4 + 0,
		...
		if ((k & 8) != 0) {
			tessellator.addVertexWithUV((double) (par2 + 1) - d4, par3 + 0,
					par4 + 1, d1, d3);
			tessellator.addVertexWithUV((double) (par2 + 1) - d4, par3 + 1,
					par4 + 1, d1, d2);
			tessellator.addVertexWithUV((double) (par2 + 1) - d4, par3 + 1,
					par4 + 0, d, d2);
			tessellator.addVertexWithUV((double) (par2 + 1) - d4, par3 + 0,
		...
		if ((k & 4) != 0) {
			tessellator.addVertexWithUV(par2 + 1, par3 + 0, (double) par4 + d4,
					d1, d3);
			tessellator.addVertexWithUV(par2 + 1, par3 + 1, (double) par4 + d4,
					d1, d2);
			tessellator.addVertexWithUV(par2 + 0, par3 + 1, (double) par4 + d4,
					d, d2);
			tessellator.addVertexWithUV(par2 + 0, par3 + 0, (double) par4 + d4,
					d, d3);
			tessellator.addVertexWithUV(par2 + 0, par3 + 0, (double) par4 + d4,
					d, d3);
			tessellator.addVertexWithUV(par2 + 0, par3 + 1, (double) par4 + d4,
		...
		if ((k & 1) != 0) {
			tessellator.addVertexWithUV(par2 + 1, par3 + 1, (double) (par4 + 1)
					- d4, d, d2);
			tessellator.addVertexWithUV(par2 + 1, par3 + 0, (double) (par4 + 1)
					- d4, d, d3);
			tessellator.addVertexWithUV(par2 + 0, par3 + 0, (double) (par4 + 1)
					- d4, d1, d3);
			tessellator.addVertexWithUV(par2 + 0, par3 + 1, (double) (par4 + 1)
					- d4, d1, d2);
			tessellator.addVertexWithUV(par2 + 0, par3 + 1, (double) (par4 + 1)
					- d4, d1, d2);
			tessellator.addVertexWithUV(par2 + 0, par3 + 0, (double) (par4 + 1)
		...
		if (blockAccess.isBlockNormalCube(par2, par3 + 1, par4)) {
			tessellator.addVertexWithUV(par2 + 1, (double) (par3 + 1) - d4,
					par4 + 0, d, d2);
			tessellator.addVertexWithUV(par2 + 1, (double) (par3 + 1) - d4,
					par4 + 1, d, d3);
			tessellator.addVertexWithUV(par2 + 0, (double) (par3 + 1) - d4,
					par4 + 1, d1, d3);
			tessellator.addVertexWithUV(par2 + 0, (double) (par3 + 1) - d4,
					par4 + 0, d1, d2);
		}
	...
	public boolean renderBlockPane(BlockPane par1BlockPane, int par2, int par3,
		...
		Tessellator tessellator = Tessellator.instance;
		tessellator.setBrightness(par1BlockPane.getMixedBrightnessForBlock(
				blockAccess, par2, par3, par4));
		float f = 1.0F;
		...
		boolean flag = par1BlockPane
				.canThisPaneConnectToThisBlockID(blockAccess.getBlockId(par2,
						par3, par4 - 1));
		boolean flag1 = par1BlockPane
				.canThisPaneConnectToThisBlockID(blockAccess.getBlockId(par2,
						par3, par4 + 1));
		boolean flag2 = par1BlockPane
				.canThisPaneConnectToThisBlockID(blockAccess.getBlockId(
						par2 - 1, par3, par4));
		boolean flag3 = par1BlockPane
				.canThisPaneConnectToThisBlockID(blockAccess.getBlockId(
						par2 + 1, par3, par4));
		boolean flag4 = par1BlockPane.shouldSideBeRendered(blockAccess, par2,
				par3 + 1, par4, 1);
		boolean flag5 = par1BlockPane.shouldSideBeRendered(blockAccess, par2,
				par3 - 1, par4, 0);
		...
		if (flag2 && flag3 || !flag2 && !flag3 && !flag && !flag1) {
			...
			if (flag4) {
				tessellator.addVertexWithUV(d10, (double) (par3 + 1) + 0.01D,
						d19, d6, d9);
				tessellator.addVertexWithUV(d12, (double) (par3 + 1) + 0.01D,
						d19, d6, d7);
				tessellator.addVertexWithUV(d12, (double) (par3 + 1) + 0.01D,
						d18, d5, d7);
				tessellator.addVertexWithUV(d10, (double) (par3 + 1) + 0.01D,
				...
				if (par3 < i - 1
					...
					tessellator.addVertexWithUV(d10,
							(double) (par3 + 1) + 0.01D, d19, d6, d8);
					tessellator.addVertexWithUV(d11,
							(double) (par3 + 1) + 0.01D, d19, d6, d9);
					tessellator.addVertexWithUV(d11,
							(double) (par3 + 1) + 0.01D, d18, d5, d9);
					tessellator.addVertexWithUV(d10,
							(double) (par3 + 1) + 0.01D, d18, d5, d8);
					tessellator.addVertexWithUV(d11,
							(double) (par3 + 1) + 0.01D, d19, d6, d8);
					tessellator.addVertexWithUV(d10,
							(double) (par3 + 1) + 0.01D, d19, d6, d9);
				...
				if (par3 < i - 1
						&& blockAccess.isAirBlock(par2 + 1, par3 + 1, par4)) {
					tessellator.addVertexWithUV(d11,
							(double) (par3 + 1) + 0.01D, d19, d6, d7);
					tessellator.addVertexWithUV(d12,
							(double) (par3 + 1) + 0.01D, d19, d6, d8);
					tessellator.addVertexWithUV(d12,
							(double) (par3 + 1) + 0.01D, d18, d5, d8);
					tessellator.addVertexWithUV(d11,
							(double) (par3 + 1) + 0.01D, d18, d5, d7);
					tessellator.addVertexWithUV(d12,
							(double) (par3 + 1) + 0.01D, d19, d6, d7);
					tessellator.addVertexWithUV(d11,
							(double) (par3 + 1) + 0.01D, d19, d6, d8);
			...
			if (flag5) {
				tessellator.addVertexWithUV(d10, (double) par3 - 0.01D, d19,
						d6, d9);
				tessellator.addVertexWithUV(d12, (double) par3 - 0.01D, d19,
						d6, d7);
				tessellator.addVertexWithUV(d12, (double) par3 - 0.01D, d18,
						d5, d7);
				tessellator.addVertexWithUV(d10, (double) par3 - 0.01D, d18,
						d5, d9);
				tessellator.addVertexWithUV(d12, (double) par3 - 0.01D, d19,
						d6, d9);
				tessellator.addVertexWithUV(d10, (double) par3 - 0.01D, d19,
				...
				if (par3 > 1
						&& blockAccess.isAirBlock(par2 - 1, par3 - 1, par4)) {
					tessellator.addVertexWithUV(d10, (double) par3 - 0.01D,
							d19, d6, d8);
					tessellator.addVertexWithUV(d11, (double) par3 - 0.01D,
							d19, d6, d9);
					tessellator.addVertexWithUV(d11, (double) par3 - 0.01D,
							d18, d5, d9);
					tessellator.addVertexWithUV(d10, (double) par3 - 0.01D,
				...
				if (par3 > 1
					...
					tessellator.addVertexWithUV(d11, (double) par3 - 0.01D,
							d19, d6, d7);
					tessellator.addVertexWithUV(d12, (double) par3 - 0.01D,
							d19, d6, d8);
					tessellator.addVertexWithUV(d12, (double) par3 - 0.01D,
							d18, d5, d8);
					tessellator.addVertexWithUV(d11, (double) par3 - 0.01D,
			...
			if (flag4 || par3 < i - 1
				...
				tessellator.addVertexWithUV(d10, (double) (par3 + 1) + 0.01D,
						d19, d6, d8);
				tessellator.addVertexWithUV(d11, (double) (par3 + 1) + 0.01D,
						d19, d6, d9);
				tessellator.addVertexWithUV(d11, (double) (par3 + 1) + 0.01D,
						d18, d5, d9);
				tessellator.addVertexWithUV(d10, (double) (par3 + 1) + 0.01D,
			...
			if (flag5 || par3 > 1
				...
				tessellator.addVertexWithUV(d10, (double) par3 - 0.01D, d19,
						d6, d8);
				tessellator.addVertexWithUV(d11, (double) par3 - 0.01D, d19,
						d6, d9);
				tessellator.addVertexWithUV(d11, (double) par3 - 0.01D, d18,
						d5, d9);
				tessellator.addVertexWithUV(d10, (double) par3 - 0.01D, d18,
						d5, d8);
				tessellator.addVertexWithUV(d11, (double) par3 - 0.01D, d19,
	...
	public boolean renderCrossedSquares(Block par1Block, int par2, int par3,
		...
		drawCrossedSquares(par1Block,
				blockAccess.getBlockMetadata(par2, par3, par4), d, d1, d2);
		return true;
	}
	...
	public boolean renderBlockStem(Block par1Block, int par2, int par3, int par4) {
		...
		Tessellator tessellator = Tessellator.instance;
		tessellator.setBrightness(blockstem.getMixedBrightnessForBlock(
				blockAccess, par2, par3, par4));
		float f = 1.0F;
		...
		if (j < 0) {
			renderBlockStemSmall(blockstem,
					blockAccess.getBlockMetadata(par2, par3, par4),
					blockstem.maxY, par2, par3, par4);
		} else {
			renderBlockStemSmall(blockstem,
					blockAccess.getBlockMetadata(par2, par3, par4), 0.5D, par2,
					par3, par4);
			renderBlockStemBig(blockstem,
					blockAccess.getBlockMetadata(par2, par3, par4), j,
					blockstem.maxY, par2, par3, par4);
		}
	 ...
	 * Render block crops
	 */
	public boolean renderBlockCrops(Block par1Block, int par2, int par3,
			int par4) {
		Tessellator tessellator = Tessellator.instance;
		tessellator.setBrightness(par1Block.getMixedBrightnessForBlock(
				blockAccess, par2, par3, par4));
	 ...
	 * given delta
	 */
	public void renderTorchAtAngle(Block par1Block, double par2, double par4,
		...
		double d8 = 0.0625D;
		double d9 = 0.625D;
		tessellator.addVertexWithUV((par2 + par8 * (1.0D - d9)) - d8,
				par4 + d9, (par6 + par10 * (1.0D - d9)) - d8, d, d1);
		tessellator.addVertexWithUV((par2 + par8 * (1.0D - d9)) - d8,
				par4 + d9, par6 + par10 * (1.0D - d9) + d8, d, d3);
		tessellator.addVertexWithUV(par2 + par8 * (1.0D - d9) + d8, par4 + d9,
				par6 + par10 * (1.0D - d9) + d8, d2, d3);
		tessellator.addVertexWithUV(par2 + par8 * (1.0D - d9) + d8, par4 + d9,
				(par6 + par10 * (1.0D - d9)) - d8, d2, d1);
		tessellator.addVertexWithUV(par2 - d8, par4 + 1.0D, d6, f, f2);
		tessellator.addVertexWithUV((par2 - d8) + par8, par4 + 0.0D,
				d6 + par10, f, f3);
		tessellator.addVertexWithUV((par2 - d8) + par8, par4 + 0.0D,
				d7 + par10, f1, f3);
		tessellator.addVertexWithUV(par2 - d8, par4 + 1.0D, d7, f1, f2);
		tessellator.addVertexWithUV(par2 + d8, par4 + 1.0D, d7, f, f2);
		tessellator.addVertexWithUV(par2 + par8 + d8, par4 + 0.0D, d7 + par10,
				f, f3);
		tessellator.addVertexWithUV(par2 + par8 + d8, par4 + 0.0D, d6 + par10,
				f1, f3);
		tessellator.addVertexWithUV(par2 + d8, par4 + 1.0D, d6, f1, f2);
		tessellator.addVertexWithUV(d4, par4 + 1.0D, par6 + d8, f, f2);
		tessellator.addVertexWithUV(d4 + par8, par4 + 0.0D, par6 + d8 + par10,
				f, f3);
		tessellator.addVertexWithUV(d5 + par8, par4 + 0.0D, par6 + d8 + par10,
				f1, f3);
		tessellator.addVertexWithUV(d5, par4 + 1.0D, par6 + d8, f1, f2);
		tessellator.addVertexWithUV(d5, par4 + 1.0D, par6 - d8, f, f2);
		tessellator.addVertexWithUV(d5 + par8, par4 + 0.0D,
				(par6 - d8) + par10, f, f3);
		tessellator.addVertexWithUV(d4 + par8, par4 + 0.0D,
				(par6 - d8) + par10, f1, f3);
	 ...
	 */
	public void drawCrossedSquares(Block par1Block, int par2, double par3,
	 ...
	 */
	public void renderBlockStemSmall(Block par1Block, int par2, double par3,
			double par5, double par7, double par9) {
		Tessellator tessellator = Tessellator.instance;
		int i = par1Block.getBlockTextureFromSideAndMetadata(0, par2);
	 ...
	 * Render BlockLilyPad
	 */
	public boolean renderBlockLilyPad(Block par1Block, int par2, int par3,
			int par4) {
		Tessellator tessellator = Tessellator.instance;
		...
		float f4 = (float) (i1 + 1 & 1) * 0.5F
				* (float) (1 - (((i1 + 1) / 2) % 2) * 2);
		tessellator.setColorOpaque_I(par1Block.getBlockColor());
		tessellator.addVertexWithUV((f1 + f3) - f4, (float) par3 + f, f2 + f3
				+ f4, d, d2);
		tessellator.addVertexWithUV(f1 + f3 + f4, (float) par3 + f, (f2 - f3)
				+ f4, d1, d2);
		tessellator.addVertexWithUV((f1 - f3) + f4, (float) par3 + f, f2 - f3
		...
		tessellator.addVertexWithUV(f1 - f3 - f4, (float) par3 + f, (f2 + f3)
				- f4, d, d3);
		tessellator
				.setColorOpaque_I((par1Block.getBlockColor() & 0xfefefe) >> 1);
		tessellator.addVertexWithUV(f1 - f3 - f4, (float) par3 + f, (f2 + f3)
				- f4, d, d3);
		tessellator.addVertexWithUV((f1 - f3) + f4, (float) par3 + f, f2 - f3
				- f4, d1, d3);
	 ...
	 */
	public void renderBlockStemBig(Block par1Block, int par2, int par3,
			double par4, double par6, double par8, double par10) {
		Tessellator tessellator = Tessellator.instance;
	 ...
	 */
	public void renderBlockCropsImpl(Block par1Block, int par2, double par3,
			double par5, double par7) {
		Tessellator tessellator = Tessellator.instance;
		int i = par1Block.getBlockTextureFromSideAndMetadata(0, par2);
	 ...
	 */
	public boolean renderBlockFluids(Block par1Block, int par2, int par3,
			int par4) {
		Tessellator tessellator = Tessellator.instance;
		int i = par1Block.colorMultiplier(blockAccess, par2, par3, par4);
		...
		boolean flag = par1Block.shouldSideBeRendered(blockAccess, par2,
				par3 + 1, par4, 1);
		boolean flag1 = par1Block.shouldSideBeRendered(blockAccess, par2,
				par3 - 1, par4, 0);
		boolean aflag[] = new boolean[4];
		aflag[0] = par1Block.shouldSideBeRendered(blockAccess, par2, par3,
				par4 - 1, 2);
		aflag[1] = par1Block.shouldSideBeRendered(blockAccess, par2, par3,
				par4 + 1, 3);
		aflag[2] = par1Block.shouldSideBeRendered(blockAccess, par2 - 1, par3,
				par4, 4);
		aflag[3] = par1Block.shouldSideBeRendered(blockAccess, par2 + 1, par3,
				par4, 5);
		...
		if (renderAllFaces || flag) {
			...
			float f8 = (float) BlockFluid.func_293_a(blockAccess, par2, par3,
					par4, material);
			...
			tessellator.setBrightness(par1Block.getMixedBrightnessForBlock(
					blockAccess, par2, par3, par4));
			float f9 = 1.0F;
			tessellator.setColorOpaque_F(f4 * f9 * f, f4 * f9 * f1, f4 * f9
					* f2);
			tessellator.addVertexWithUV(par2 + 0, (double) par3 + d2, par4 + 0,
					d7 - d12 - d10, (d8 - d12) + d10);
			tessellator.addVertexWithUV(par2 + 0, (double) par3 + d3, par4 + 1,
					(d7 - d12) + d10, d8 + d12 + d10);
			tessellator.addVertexWithUV(par2 + 1, (double) par3 + d4, par4 + 1,
					d7 + d12 + d10, (d8 + d12) - d10);
			tessellator.addVertexWithUV(par2 + 1, (double) par3 + d5, par4 + 0,
					(d7 + d12) - d10, d8 - d12 - d10);
		}
		...
		for (int l = 0; l < 4; l++) {
			...
			tessellator.setColorOpaque_F(f4 * f10 * f, f4 * f10 * f1, f4 * f10
					* f2);
			tessellator.addVertexWithUV(d13, (double) par3 + d9, d14, d17, d19);
			tessellator
					.addVertexWithUV(d15, (double) par3 + d11, d16, d18, d20);
	 ...
	 * Get fluid height
	 */
	private float getFluidHeight(int par1, int par2, int par3,
	...
	public void renderBlockFallingSand(Block par1Block, World par2World,
		...
		renderBottomFace(par1Block, -0.5D, -0.5D, -0.5D,
				par1Block.getBlockTextureFromSide(0));
		f5 = 1.0F;
		...
		renderTopFace(par1Block, -0.5D, -0.5D, -0.5D,
				par1Block.getBlockTextureFromSide(1));
		f5 = 1.0F;
		...
		renderEastFace(par1Block, -0.5D, -0.5D, -0.5D,
				par1Block.getBlockTextureFromSide(2));
		f5 = 1.0F;
		...
		tessellator.setColorOpaque_F(f2 * f5, f2 * f5, f2 * f5);
		renderWestFace(par1Block, -0.5D, -0.5D, -0.5D,
				par1Block.getBlockTextureFromSide(3));
		f5 = 1.0F;
		...
		renderNorthFace(par1Block, -0.5D, -0.5D, -0.5D,
				par1Block.getBlockTextureFromSide(4));
		f5 = 1.0F;
		...
		tessellator.setColorOpaque_F(f3 * f5, f3 * f5, f3 * f5);
		renderSouthFace(par1Block, -0.5D, -0.5D, -0.5D,
				par1Block.getBlockTextureFromSide(5));
		tessellator.draw();
	}
	...
	public boolean renderStandardBlock(Block par1Block, int par2, int par3,
		...
		if (Minecraft.isAmbientOcclusionEnabled()
			...
			return renderStandardBlockWithAmbientOcclusion(par1Block, par2,
					par3, par4, f, f1, f2);
		} else {
			return renderStandardBlockWithColorMultiplier(par1Block, par2,
					par3, par4, f, f1, f2);
		}
	}

	public boolean renderStandardBlockWithAmbientOcclusion(Block par1Block,
			int par2, int par3, int par4, float par5, float par6, float par7) {
		enableAO = true;
		boolean flag = false;
		...
		boolean flag5 = true;
		boolean flag6 = true;
		lightValueOwn = par1Block.getAmbientOcclusionLightValue(blockAccess,
				par2, par3, par4);
		aoLightValueXNeg = par1Block.getAmbientOcclusionLightValue(blockAccess,
				par2 - 1, par3, par4);
		aoLightValueYNeg = par1Block.getAmbientOcclusionLightValue(blockAccess,
				par2, par3 - 1, par4);
		aoLightValueZNeg = par1Block.getAmbientOcclusionLightValue(blockAccess,
				par2, par3, par4 - 1);
		aoLightValueXPos = par1Block.getAmbientOcclusionLightValue(blockAccess,
				par2 + 1, par3, par4);
		aoLightValueYPos = par1Block.getAmbientOcclusionLightValue(blockAccess,
				par2, par3 + 1, par4);
		aoLightValueZPos = par1Block.getAmbientOcclusionLightValue(blockAccess,
				par2, par3, par4 + 1);
		int i = par1Block.getMixedBrightnessForBlock(blockAccess, par2, par3,
				par4);
		int j = i;
		int k = i;
		int l = i;
		...
		if (par1Block.minY <= 0.0D) {
			k = par1Block.getMixedBrightnessForBlock(blockAccess, par2,
					par3 - 1, par4);
		}

		if (par1Block.maxY >= 1.0D) {
			j1 = par1Block.getMixedBrightnessForBlock(blockAccess, par2,
					par3 + 1, par4);
		}

		if (par1Block.minX <= 0.0D) {
			j = par1Block.getMixedBrightnessForBlock(blockAccess, par2 - 1,
					par3, par4);
		}

		if (par1Block.maxX >= 1.0D) {
			i1 = par1Block.getMixedBrightnessForBlock(blockAccess, par2 + 1,
					par3, par4);
		}

		if (par1Block.minZ <= 0.0D) {
			l = par1Block.getMixedBrightnessForBlock(blockAccess, par2, par3,
					par4 - 1);
		}

		if (par1Block.maxZ >= 1.0D) {
			k1 = par1Block.getMixedBrightnessForBlock(blockAccess, par2, par3,
					par4 + 1);
		}

		Tessellator tessellator = Tessellator.instance;
		tessellator.setBrightness(0xf000f);
		aoGrassXYZPPC = Block.canBlockGrass[blockAccess.getBlockId(par2 + 1,
				par3 + 1, par4)];
		aoGrassXYZPNC = Block.canBlockGrass[blockAccess.getBlockId(par2 + 1,
				par3 - 1, par4)];
		aoGrassXYZPCP = Block.canBlockGrass[blockAccess.getBlockId(par2 + 1,
				par3, par4 + 1)];
		aoGrassXYZPCN = Block.canBlockGrass[blockAccess.getBlockId(par2 + 1,
				par3, par4 - 1)];
		aoGrassXYZNPC = Block.canBlockGrass[blockAccess.getBlockId(par2 - 1,
				par3 + 1, par4)];
		aoGrassXYZNNC = Block.canBlockGrass[blockAccess.getBlockId(par2 - 1,
				par3 - 1, par4)];
		aoGrassXYZNCN = Block.canBlockGrass[blockAccess.getBlockId(par2 - 1,
				par3, par4 - 1)];
		aoGrassXYZNCP = Block.canBlockGrass[blockAccess.getBlockId(par2 - 1,
				par3, par4 + 1)];
		aoGrassXYZCPP = Block.canBlockGrass[blockAccess.getBlockId(par2,
				par3 + 1, par4 + 1)];
		aoGrassXYZCPN = Block.canBlockGrass[blockAccess.getBlockId(par2,
				par3 + 1, par4 - 1)];
		aoGrassXYZCNP = Block.canBlockGrass[blockAccess.getBlockId(par2,
				par3 - 1, par4 + 1)];
		aoGrassXYZCNN = Block.canBlockGrass[blockAccess.getBlockId(par2,
				par3 - 1, par4 - 1)];
		...
		if (renderAllFaces
			...
			if (aoType > 0) {
				...
				aoBrightnessXYPN = par1Block.getMixedBrightnessForBlock(
						blockAccess, par2 + 1, par3, par4);
				aoLightValueScratchXYNN = par1Block
						.getAmbientOcclusionLightValue(blockAccess, par2 - 1,
								par3, par4);
				aoLightValueScratchYZNN = par1Block
						.getAmbientOcclusionLightValue(blockAccess, par2, par3,
								par4 - 1);
				aoLightValueScratchYZNP = par1Block
						.getAmbientOcclusionLightValue(blockAccess, par2, par3,
								par4 + 1);
				...
				if (aoGrassXYZCNN || aoGrassXYZNNC) {
					aoLightValueScratchXYZNNN = par1Block
							.getAmbientOcclusionLightValue(blockAccess,
									par2 - 1, par3, par4 - 1);
				...
				if (aoGrassXYZCNP || aoGrassXYZNNC) {
					aoLightValueScratchXYZNNP = par1Block
							.getAmbientOcclusionLightValue(blockAccess,
									par2 - 1, par3, par4 + 1);
				...
				if (aoGrassXYZCNN || aoGrassXYZPNC) {
					aoLightValueScratchXYZPNN = par1Block
							.getAmbientOcclusionLightValue(blockAccess,
									par2 + 1, par3, par4 - 1);
				...
				if (aoGrassXYZCNP || aoGrassXYZPNC) {
					aoLightValueScratchXYZPNP = par1Block
							.getAmbientOcclusionLightValue(blockAccess,
									par2 + 1, par3, par4 + 1);
				...
				f1 = (aoLightValueScratchXYZNNP + aoLightValueScratchXYNN
						+ aoLightValueScratchYZNP + aoLightValueYNeg) / 4F;
				f22 = (aoLightValueScratchYZNP + aoLightValueYNeg
						+ aoLightValueScratchXYZPNP + aoLightValueScratchXYPN) / 4F;
				f15 = (aoLightValueYNeg + aoLightValueScratchYZNN
						+ aoLightValueScratchXYPN + aoLightValueScratchXYZPNN) / 4F;
				f8 = (aoLightValueScratchXYNN + aoLightValueScratchXYZNNN
						+ aoLightValueYNeg + aoLightValueScratchYZNN) / 4F;
				brightnessTopLeft = getAoBrightness(aoBrightnessXYZNNP,
						aoBrightnessXYNN, aoBrightnessYZNP, k);
				brightnessTopRight = getAoBrightness(aoBrightnessYZNP,
						aoBrightnessXYZPNP, aoBrightnessXYPN, k);
				brightnessBottomRight = getAoBrightness(aoBrightnessYZNN,
						aoBrightnessXYPN, aoBrightnessXYZPNN, k);
				brightnessBottomLeft = getAoBrightness(aoBrightnessXYNN,
						aoBrightnessXYZNNN, aoBrightnessYZNN, k);
			} else {
			...
			colorRedTopLeft = colorRedBottomLeft = colorRedBottomRight = colorRedTopRight = (flag1 ? par5
					: 1.0F) * 0.5F;
			colorGreenTopLeft = colorGreenBottomLeft = colorGreenBottomRight = colorGreenTopRight = (flag1 ? par6
					: 1.0F) * 0.5F;
			colorBlueTopLeft = colorBlueBottomLeft = colorBlueBottomRight = colorBlueTopRight = (flag1 ? par7
					: 1.0F) * 0.5F;
			colorRedTopLeft *= f1;
			...
			renderBottomFace(par1Block, par2, par3, par4,
					par1Block.getBlockTexture(blockAccess, par2, par3, par4, 0));
			flag = true;
		}
		...
		if (renderAllFaces
			...
			if (aoType > 0) {
				...
				aoBrightnessYZPP = par1Block.getMixedBrightnessForBlock(
						blockAccess, par2, par3, par4 + 1);
				aoLightValueScratchXYNP = par1Block
						.getAmbientOcclusionLightValue(blockAccess, par2 - 1,
								par3, par4);
				aoLightValueScratchXYPP = par1Block
						.getAmbientOcclusionLightValue(blockAccess, par2 + 1,
								par3, par4);
				aoLightValueScratchYZPN = par1Block
						.getAmbientOcclusionLightValue(blockAccess, par2, par3,
								par4 - 1);
				aoLightValueScratchYZPP = par1Block
						.getAmbientOcclusionLightValue(blockAccess, par2, par3,
								par4 + 1);

				if (aoGrassXYZCPN || aoGrassXYZNPC) {
					aoLightValueScratchXYZNPN = par1Block
							.getAmbientOcclusionLightValue(blockAccess,
									par2 - 1, par3, par4 - 1);
				...
				if (aoGrassXYZCPN || aoGrassXYZPPC) {
					aoLightValueScratchXYZPPN = par1Block
							.getAmbientOcclusionLightValue(blockAccess,
									par2 + 1, par3, par4 - 1);
				...
				if (aoGrassXYZCPP || aoGrassXYZNPC) {
					aoLightValueScratchXYZNPP = par1Block
							.getAmbientOcclusionLightValue(blockAccess,
									par2 - 1, par3, par4 + 1);
				...
				if (aoGrassXYZCPP || aoGrassXYZPPC) {
					aoLightValueScratchXYZPPP = par1Block
							.getAmbientOcclusionLightValue(blockAccess,
									par2 + 1, par3, par4 + 1);
				...
				f23 = (aoLightValueScratchXYZNPP + aoLightValueScratchXYNP
						+ aoLightValueScratchYZPP + aoLightValueYPos) / 4F;
				f2 = (aoLightValueScratchYZPP + aoLightValueYPos
						+ aoLightValueScratchXYZPPP + aoLightValueScratchXYPP) / 4F;
				f9 = (aoLightValueYPos + aoLightValueScratchYZPN
						+ aoLightValueScratchXYPP + aoLightValueScratchXYZPPN) / 4F;
				f16 = (aoLightValueScratchXYNP + aoLightValueScratchXYZNPN
						+ aoLightValueYPos + aoLightValueScratchYZPN) / 4F;
				brightnessTopRight = getAoBrightness(aoBrightnessXYZNPP,
						aoBrightnessXYNP, aoBrightnessYZPP, j1);
				brightnessTopLeft = getAoBrightness(aoBrightnessYZPP,
						aoBrightnessXYZPPP, aoBrightnessXYPP, j1);
				brightnessBottomLeft = getAoBrightness(aoBrightnessYZPN,
						aoBrightnessXYPP, aoBrightnessXYZPPN, j1);
				brightnessBottomRight = getAoBrightness(aoBrightnessXYNP,
						aoBrightnessXYZNPN, aoBrightnessYZPN, j1);
			} else {
				f2 = f9 = f16 = f23 = aoLightValueYPos;
				brightnessTopLeft = brightnessBottomLeft = brightnessBottomRight = brightnessTopRight = j1;
			}

			colorRedTopLeft = colorRedBottomLeft = colorRedBottomRight = colorRedTopRight = flag2 ? par5
					: 1.0F;
			colorGreenTopLeft = colorGreenBottomLeft = colorGreenBottomRight = colorGreenTopRight = flag2 ? par6
					: 1.0F;
			colorBlueTopLeft = colorBlueBottomLeft = colorBlueBottomRight = colorBlueTopRight = flag2 ? par7
					: 1.0F;
			colorRedTopLeft *= f2;
			...
			renderTopFace(par1Block, par2, par3, par4,
					par1Block.getBlockTexture(blockAccess, par2, par3, par4, 1));
			flag = true;
		}
		...
		if (renderAllFaces
			...
			if (aoType > 0) {
				...
				aoLightValueScratchXZNN = par1Block
						.getAmbientOcclusionLightValue(blockAccess, par2 - 1,
								par3, par4);
				aoLightValueScratchYZNN = par1Block
						.getAmbientOcclusionLightValue(blockAccess, par2,
								par3 - 1, par4);
				aoLightValueScratchYZPN = par1Block
						.getAmbientOcclusionLightValue(blockAccess, par2,
								par3 + 1, par4);
				aoLightValueScratchXZPN = par1Block
						.getAmbientOcclusionLightValue(blockAccess, par2 + 1,
								par3, par4);
				...
				f3 = (aoLightValueScratchXZNN + aoLightValueScratchXYZNPN
						+ aoLightValueZNeg + aoLightValueScratchYZPN) / 4F;
				f10 = (aoLightValueZNeg + aoLightValueScratchYZPN
						+ aoLightValueScratchXZPN + aoLightValueScratchXYZPPN) / 4F;
				f17 = (aoLightValueScratchYZNN + aoLightValueZNeg
						+ aoLightValueScratchXYZPNN + aoLightValueScratchXZPN) / 4F;
				f24 = (aoLightValueScratchXYZNNN + aoLightValueScratchXZNN
						+ aoLightValueScratchYZNN + aoLightValueZNeg) / 4F;
				brightnessTopLeft = getAoBrightness(aoBrightnessXZNN,
						aoBrightnessXYZNPN, aoBrightnessYZPN, l);
				brightnessBottomLeft = getAoBrightness(aoBrightnessYZPN,
						aoBrightnessXZPN, aoBrightnessXYZPPN, l);
				brightnessBottomRight = getAoBrightness(aoBrightnessYZNN,
						aoBrightnessXYZPNN, aoBrightnessXZPN, l);
				brightnessTopRight = getAoBrightness(aoBrightnessXYZNNN,
						aoBrightnessXZNN, aoBrightnessYZNN, l);
			} else {
				f3 = f10 = f17 = f24 = aoLightValueZNeg;
				brightnessTopLeft = brightnessBottomLeft = brightnessBottomRight = brightnessTopRight = l;
			}

			colorRedTopLeft = colorRedBottomLeft = colorRedBottomRight = colorRedTopRight = (flag3 ? par5
					: 1.0F) * 0.8F;
			colorGreenTopLeft = colorGreenBottomLeft = colorGreenBottomRight = colorGreenTopRight = (flag3 ? par6
					: 1.0F) * 0.8F;
			colorBlueTopLeft = colorBlueBottomLeft = colorBlueBottomRight = colorBlueTopRight = (flag3 ? par7
					: 1.0F) * 0.8F;
			colorRedTopLeft *= f3;
			...
			int l1 = par1Block
					.getBlockTexture(blockAccess, par2, par3, par4, 2);
		...
		if (renderAllFaces
			...
			if (aoType > 0) {
				...
				aoLightValueScratchXZNP = par1Block
						.getAmbientOcclusionLightValue(blockAccess, par2 - 1,
								par3, par4);
				aoLightValueScratchXZPP = par1Block
						.getAmbientOcclusionLightValue(blockAccess, par2 + 1,
								par3, par4);
				aoLightValueScratchYZNP = par1Block
						.getAmbientOcclusionLightValue(blockAccess, par2,
				...
				f4 = (aoLightValueScratchXZNP + aoLightValueScratchXYZNPP
						+ aoLightValueZPos + aoLightValueScratchYZPP) / 4F;
				f25 = (aoLightValueZPos + aoLightValueScratchYZPP
						+ aoLightValueScratchXZPP + aoLightValueScratchXYZPPP) / 4F;
				f18 = (aoLightValueScratchYZNP + aoLightValueZPos
						+ aoLightValueScratchXYZPNP + aoLightValueScratchXZPP) / 4F;
				f11 = (aoLightValueScratchXYZNNP + aoLightValueScratchXZNP
						+ aoLightValueScratchYZNP + aoLightValueZPos) / 4F;
				brightnessTopLeft = getAoBrightness(aoBrightnessXZNP,
						aoBrightnessXYZNPP, aoBrightnessYZPP, k1);
				brightnessTopRight = getAoBrightness(aoBrightnessYZPP,
						aoBrightnessXZPP, aoBrightnessXYZPPP, k1);
				brightnessBottomRight = getAoBrightness(aoBrightnessYZNP,
						aoBrightnessXYZPNP, aoBrightnessXZPP, k1);
				brightnessBottomLeft = getAoBrightness(aoBrightnessXYZNNP,
						aoBrightnessXZNP, aoBrightnessYZNP, k1);
			} else {
				f4 = f11 = f18 = f25 = aoLightValueZPos;
				brightnessTopLeft = brightnessBottomLeft = brightnessBottomRight = brightnessTopRight = k1;
			}

			colorRedTopLeft = colorRedBottomLeft = colorRedBottomRight = colorRedTopRight = (flag4 ? par5
					: 1.0F) * 0.8F;
			colorGreenTopLeft = colorGreenBottomLeft = colorGreenBottomRight = colorGreenTopRight = (flag4 ? par6
					: 1.0F) * 0.8F;
			colorBlueTopLeft = colorBlueBottomLeft = colorBlueBottomRight = colorBlueTopRight = (flag4 ? par7
					: 1.0F) * 0.8F;
			colorRedTopLeft *= f4;
			...
			int i2 = par1Block
					.getBlockTexture(blockAccess, par2, par3, par4, 3);
			renderWestFace(par1Block, par2, par3, par4,
					par1Block.getBlockTexture(blockAccess, par2, par3, par4, 3));
		...
		if (renderAllFaces
			...
			if (aoType > 0) {
				...
				f26 = (aoLightValueScratchXYNN + aoLightValueScratchXYZNNP
						+ aoLightValueXNeg + aoLightValueScratchXZNP) / 4F;
				f5 = (aoLightValueXNeg + aoLightValueScratchXZNP
						+ aoLightValueScratchXYNP + aoLightValueScratchXYZNPP) / 4F;
				f12 = (aoLightValueScratchXZNN + aoLightValueXNeg
						+ aoLightValueScratchXYZNPN + aoLightValueScratchXYNP) / 4F;
				f19 = (aoLightValueScratchXYZNNN + aoLightValueScratchXYNN
						+ aoLightValueScratchXZNN + aoLightValueXNeg) / 4F;
				brightnessTopRight = getAoBrightness(aoBrightnessXYNN,
						aoBrightnessXYZNNP, aoBrightnessXZNP, j);
				brightnessTopLeft = getAoBrightness(aoBrightnessXZNP,
						aoBrightnessXYNP, aoBrightnessXYZNPP, j);
				brightnessBottomLeft = getAoBrightness(aoBrightnessXZNN,
						aoBrightnessXYZNPN, aoBrightnessXYNP, j);
				brightnessBottomRight = getAoBrightness(aoBrightnessXYZNNN,
						aoBrightnessXYNN, aoBrightnessXZNN, j);
			} else {
				f5 = f12 = f19 = f26 = aoLightValueXNeg;
				brightnessTopLeft = brightnessBottomLeft = brightnessBottomRight = brightnessTopRight = j;
			}

			colorRedTopLeft = colorRedBottomLeft = colorRedBottomRight = colorRedTopRight = (flag5 ? par5
					: 1.0F) * 0.6F;
			colorGreenTopLeft = colorGreenBottomLeft = colorGreenBottomRight = colorGreenTopRight = (flag5 ? par6
					: 1.0F) * 0.6F;
			colorBlueTopLeft = colorBlueBottomLeft = colorBlueBottomRight = colorBlueTopRight = (flag5 ? par7
					: 1.0F) * 0.6F;
			colorRedTopLeft *= f5;
			...
			int j2 = par1Block
					.getBlockTexture(blockAccess, par2, par3, par4, 4);
		...
		if (renderAllFaces
			...
			if (aoType > 0) {
				...
				f6 = (aoLightValueScratchXYPN + aoLightValueScratchXYZPNP
						+ aoLightValueXPos + aoLightValueScratchXZPP) / 4F;
				f27 = (aoLightValueXPos + aoLightValueScratchXZPP
						+ aoLightValueScratchXYPP + aoLightValueScratchXYZPPP) / 4F;
				f20 = (aoLightValueScratchXZPN + aoLightValueXPos
						+ aoLightValueScratchXYZPPN + aoLightValueScratchXYPP) / 4F;
				f13 = (aoLightValueScratchXYZPNN + aoLightValueScratchXYPN
						+ aoLightValueScratchXZPN + aoLightValueXPos) / 4F;
				brightnessTopLeft = getAoBrightness(aoBrightnessXYPN,
						aoBrightnessXYZPNP, aoBrightnessXZPP, i1);
				brightnessTopRight = getAoBrightness(aoBrightnessXZPP,
						aoBrightnessXYPP, aoBrightnessXYZPPP, i1);
				brightnessBottomRight = getAoBrightness(aoBrightnessXZPN,
						aoBrightnessXYZPPN, aoBrightnessXYPP, i1);
				brightnessBottomLeft = getAoBrightness(aoBrightnessXYZPNN,
						aoBrightnessXYPN, aoBrightnessXZPN, i1);
			} else {
				f6 = f13 = f20 = f27 = aoLightValueXPos;
				brightnessTopLeft = brightnessBottomLeft = brightnessBottomRight = brightnessTopRight = i1;
			}

			colorRedTopLeft = colorRedBottomLeft = colorRedBottomRight = colorRedTopRight = (flag6 ? par5
					: 1.0F) * 0.6F;
			colorGreenTopLeft = colorGreenBottomLeft = colorGreenBottomRight = colorGreenTopRight = (flag6 ? par6
					: 1.0F) * 0.6F;
			colorBlueTopLeft = colorBlueBottomLeft = colorBlueBottomRight = colorBlueTopRight = (flag6 ? par7
					: 1.0F) * 0.6F;
			colorRedTopLeft *= f6;
			...
			int k2 = par1Block
					.getBlockTexture(blockAccess, par2, par3, par4, 5);
	...
	public boolean renderStandardBlockWithColorMultiplier(Block par1Block,
		...
		if (renderAllFaces
				|| par1Block.shouldSideBeRendered(blockAccess, par2, par3 - 1,
						par4, 0)) {
			tessellator.setBrightness(par1Block.minY <= 0.0D ? par1Block
		...
		if (renderAllFaces
				|| par1Block.shouldSideBeRendered(blockAccess, par2, par3 + 1,
						par4, 1)) {
			tessellator.setBrightness(par1Block.maxY >= 1.0D ? par1Block
					.getMixedBrightnessForBlock(blockAccess, par2, par3 + 1,
							par4) : i);
			tessellator.setColorOpaque_F(f4, f5, f6);
			renderTopFace(par1Block, par2, par3, par4,
		...
		if (renderAllFaces
				|| par1Block.shouldSideBeRendered(blockAccess, par2 - 1, par3,
						par4, 4)) {
			tessellator.setBrightness(par1Block.minX <= 0.0D ? par1Block
					.getMixedBrightnessForBlock(blockAccess, par2 - 1, par3,
							par4) : i);
			tessellator.setColorOpaque_F(f9, f12, f15);
		...
		if (renderAllFaces
				|| par1Block.shouldSideBeRendered(blockAccess, par2 + 1, par3,
						par4, 5)) {
			tessellator.setBrightness(par1Block.maxX >= 1.0D ? par1Block
					.getMixedBrightnessForBlock(blockAccess, par2 + 1, par3,
							par4) : i);
			tessellator.setColorOpaque_F(f9, f12, f15);
			int i1 = par1Block
	 ...
	 */
	public boolean renderBlockCactusImpl(Block par1Block, int par2, int par3,
			int par4, float par5, float par6, float par7) {
		Tessellator tessellator = Tessellator.instance;
		boolean flag = false;
		float f = 0.5F;
		float f1 = 1.0F;
	...
	public boolean renderBlockFence(BlockFence par1BlockFence, int par2,
			int par3, int par4) {
		boolean flag = false;
		float f = 0.375F;
		float f1 = 0.625F;
		...
		boolean flag3 = par1BlockFence.canConnectFenceTo(blockAccess, par2 - 1,
				par3, par4);
		boolean flag4 = par1BlockFence.canConnectFenceTo(blockAccess, par2 + 1,
				par3, par4);
		boolean flag5 = par1BlockFence.canConnectFenceTo(blockAccess, par2,
				par3, par4 - 1);
		boolean flag6 = par1BlockFence.canConnectFenceTo(blockAccess, par2,
				par3, par4 + 1);
	...
	public boolean renderBlockDragonEgg(BlockDragonEgg par1BlockDragonEgg,
		...
		for (int j = 0; j < 8; j++) {
			...
			i += byte0;
			par1BlockDragonEgg.setBlockBounds(0.5F - f, f2, 0.5F - f, 0.5F + f,
					f1, 0.5F + f);
	...
	public boolean renderBlockFenceGate(BlockFenceGate par1BlockFenceGate,
		...
		if (!flag1) {
			if (j == 3 || j == 1) {
				...
				float f10 = 0.375F;
				float f14 = 0.5F;
				par1BlockFenceGate.setBlockBounds(f2, 0.375F, f10, f6, 0.9375F,
						f14);
				renderStandardBlock(par1BlockFenceGate, par2, par3, par4);
				f10 = 0.5F;
				f14 = 0.625F;
				...
				f10 = 0.625F;
				f14 = 0.875F;
				par1BlockFenceGate.setBlockBounds(f2, 0.375F, f10, f6, 0.5625F,
						f14);
				renderStandardBlock(par1BlockFenceGate, par2, par3, par4);
				par1BlockFenceGate.setBlockBounds(f2, 0.75F, f10, f6, 0.9375F,
						f14);
				renderStandardBlock(par1BlockFenceGate, par2, par3, par4);
				f10 = 0.125F;
				f14 = 0.375F;
				...
				float f11 = 0.4375F;
				float f15 = 0.5625F;
				par1BlockFenceGate.setBlockBounds(f3, 0.375F, f11, f7, 0.9375F,
						f15);
				renderStandardBlock(par1BlockFenceGate, par2, par3, par4);
				f3 = 0.5F;
				f7 = 0.625F;
				...
				f3 = 0.625F;
				f7 = 0.875F;
				par1BlockFenceGate.setBlockBounds(f3, 0.375F, f11, f7, 0.5625F,
						f15);
				renderStandardBlock(par1BlockFenceGate, par2, par3, par4);
				par1BlockFenceGate.setBlockBounds(f3, 0.75F, f11, f7, 0.9375F,
						f15);
				renderStandardBlock(par1BlockFenceGate, par2, par3, par4);
				f3 = 0.125F;
				f7 = 0.375F;
			...
			par1BlockFenceGate.setBlockBounds(0.8125F, 0.375F, 0.0F, 0.9375F,
					0.9375F, 0.125F);
			renderStandardBlock(par1BlockFenceGate, par2, par3, par4);
			par1BlockFenceGate.setBlockBounds(0.8125F, 0.375F, 0.875F, 0.9375F,
					0.9375F, 1.0F);
			renderStandardBlock(par1BlockFenceGate, par2, par3, par4);
			par1BlockFenceGate.setBlockBounds(0.5625F, 0.375F, 0.0F, 0.8125F,
					0.5625F, 0.125F);
			renderStandardBlock(par1BlockFenceGate, par2, par3, par4);
			par1BlockFenceGate.setBlockBounds(0.5625F, 0.375F, 0.875F, 0.8125F,
					0.5625F, 1.0F);
			renderStandardBlock(par1BlockFenceGate, par2, par3, par4);
			par1BlockFenceGate.setBlockBounds(0.5625F, 0.75F, 0.0F, 0.8125F,
					0.9375F, 0.125F);
			renderStandardBlock(par1BlockFenceGate, par2, par3, par4);
			par1BlockFenceGate.setBlockBounds(0.5625F, 0.75F, 0.875F, 0.8125F,
					0.9375F, 1.0F);
			renderStandardBlock(par1BlockFenceGate, par2, par3, par4);
		} else if (j == 1) {
			par1BlockFenceGate.setBlockBounds(0.0625F, 0.375F, 0.0F, 0.1875F,
					0.9375F, 0.125F);
			renderStandardBlock(par1BlockFenceGate, par2, par3, par4);
			par1BlockFenceGate.setBlockBounds(0.0625F, 0.375F, 0.875F, 0.1875F,
					0.9375F, 1.0F);
			renderStandardBlock(par1BlockFenceGate, par2, par3, par4);
			par1BlockFenceGate.setBlockBounds(0.1875F, 0.375F, 0.0F, 0.4375F,
					0.5625F, 0.125F);
			renderStandardBlock(par1BlockFenceGate, par2, par3, par4);
			par1BlockFenceGate.setBlockBounds(0.1875F, 0.375F, 0.875F, 0.4375F,
					0.5625F, 1.0F);
			renderStandardBlock(par1BlockFenceGate, par2, par3, par4);
			par1BlockFenceGate.setBlockBounds(0.1875F, 0.75F, 0.0F, 0.4375F,
					0.9375F, 0.125F);
			renderStandardBlock(par1BlockFenceGate, par2, par3, par4);
			par1BlockFenceGate.setBlockBounds(0.1875F, 0.75F, 0.875F, 0.4375F,
					0.9375F, 1.0F);
			renderStandardBlock(par1BlockFenceGate, par2, par3, par4);
		} else if (j == 0) {
			par1BlockFenceGate.setBlockBounds(0.0F, 0.375F, 0.8125F, 0.125F,
					0.9375F, 0.9375F);
			renderStandardBlock(par1BlockFenceGate, par2, par3, par4);
			par1BlockFenceGate.setBlockBounds(0.875F, 0.375F, 0.8125F, 1.0F,
					0.9375F, 0.9375F);
			renderStandardBlock(par1BlockFenceGate, par2, par3, par4);
			par1BlockFenceGate.setBlockBounds(0.0F, 0.375F, 0.5625F, 0.125F,
					0.5625F, 0.8125F);
			renderStandardBlock(par1BlockFenceGate, par2, par3, par4);
			par1BlockFenceGate.setBlockBounds(0.875F, 0.375F, 0.5625F, 1.0F,
					0.5625F, 0.8125F);
			renderStandardBlock(par1BlockFenceGate, par2, par3, par4);
			par1BlockFenceGate.setBlockBounds(0.0F, 0.75F, 0.5625F, 0.125F,
					0.9375F, 0.8125F);
			renderStandardBlock(par1BlockFenceGate, par2, par3, par4);
			par1BlockFenceGate.setBlockBounds(0.875F, 0.75F, 0.5625F, 1.0F,
					0.9375F, 0.8125F);
			renderStandardBlock(par1BlockFenceGate, par2, par3, par4);
		} else if (j == 2) {
			par1BlockFenceGate.setBlockBounds(0.0F, 0.375F, 0.0625F, 0.125F,
					0.9375F, 0.1875F);
			renderStandardBlock(par1BlockFenceGate, par2, par3, par4);
			par1BlockFenceGate.setBlockBounds(0.875F, 0.375F, 0.0625F, 1.0F,
					0.9375F, 0.1875F);
			renderStandardBlock(par1BlockFenceGate, par2, par3, par4);
			par1BlockFenceGate.setBlockBounds(0.0F, 0.375F, 0.1875F, 0.125F,
					0.5625F, 0.4375F);
			renderStandardBlock(par1BlockFenceGate, par2, par3, par4);
			par1BlockFenceGate.setBlockBounds(0.875F, 0.375F, 0.1875F, 1.0F,
					0.5625F, 0.4375F);
			renderStandardBlock(par1BlockFenceGate, par2, par3, par4);
			par1BlockFenceGate.setBlockBounds(0.0F, 0.75F, 0.1875F, 0.125F,
					0.9375F, 0.4375F);
			renderStandardBlock(par1BlockFenceGate, par2, par3, par4);
			par1BlockFenceGate.setBlockBounds(0.875F, 0.75F, 0.1875F, 1.0F,
					0.9375F, 0.4375F);
			renderStandardBlock(par1BlockFenceGate, par2, par3, par4);
		}
	 ...
	 * x, y, z, texture
	 */
	public void renderBottomFace(Block par1Block, double par2, double par4,
			double par6, int par8) {
		Tessellator tessellator = Tessellator.instance;
		...
		if (enableAO) {
			tessellator.setColorOpaque_F(colorRedTopLeft, colorGreenTopLeft,
					colorBlueTopLeft);
			tessellator.setBrightness(brightnessTopLeft);
			tessellator.addVertexWithUV(d8, d10, d12, d5, d7);
			tessellator.setColorOpaque_F(colorRedBottomLeft,
					colorGreenBottomLeft, colorBlueBottomLeft);
			tessellator.setBrightness(brightnessBottomLeft);
			tessellator.addVertexWithUV(d8, d10, d11, d, d2);
			tessellator.setColorOpaque_F(colorRedBottomRight,
					colorGreenBottomRight, colorBlueBottomRight);
			tessellator.setBrightness(brightnessBottomRight);
			tessellator.addVertexWithUV(d9, d10, d11, d4, d6);
			tessellator.setColorOpaque_F(colorRedTopRight, colorGreenTopRight,
					colorBlueTopRight);
	 ...
	 * y, z, texture
	 */
	public void renderTopFace(Block par1Block, double par2, double par4,
			double par6, int par8) {
		Tessellator tessellator = Tessellator.instance;
	 ...
	 */
	public void renderEastFace(Block par1Block, double par2, double par4,
			double par6, int par8) {
		Tessellator tessellator = Tessellator.instance;
	 ...
	 * Args: block, x, y, z, texture
	 */
	public void renderWestFace(Block par1Block, double par2, double par4,
			double par6, int par8) {
		Tessellator tessellator = Tessellator.instance;
	 ...
	 * Args: block, x, y, z, texture
	 */
	public void renderNorthFace(Block par1Block, double par2, double par4,
			double par6, int par8) {
		Tessellator tessellator = Tessellator.instance;
	 ...
	 * Args: block, x, y, z, texture
	 */
	public void renderSouthFace(Block par1Block, double par2, double par4,
			double par6, int par8) {
		Tessellator tessellator = Tessellator.instance;
	...
	public void renderBlockAsItem(Block par1Block, int par2, float par3) {
		...
		if (j == 0 || j == 16) {
			...
			renderBottomFace(par1Block, 0.0D, 0.0D, 0.0D,
					par1Block.getBlockTextureFromSideAndMetadata(0, par2));
			tessellator.draw();
			...
			renderTopFace(par1Block, 0.0D, 0.0D, 0.0D,
					par1Block.getBlockTextureFromSideAndMetadata(1, par2));
			tessellator.draw();
			...
			renderEastFace(par1Block, 0.0D, 0.0D, 0.0D,
					par1Block.getBlockTextureFromSideAndMetadata(2, par2));
			tessellator.draw();
			tessellator.startDrawingQuads();
			tessellator.setNormal(0.0F, 0.0F, 1.0F);
			renderWestFace(par1Block, 0.0D, 0.0D, 0.0D,
					par1Block.getBlockTextureFromSideAndMetadata(3, par2));
			tessellator.draw();
			tessellator.startDrawingQuads();
			tessellator.setNormal(-1F, 0.0F, 0.0F);
			renderNorthFace(par1Block, 0.0D, 0.0D, 0.0D,
					par1Block.getBlockTextureFromSideAndMetadata(4, par2));
			tessellator.draw();
			tessellator.startDrawingQuads();
			tessellator.setNormal(1.0F, 0.0F, 0.0F);
			renderSouthFace(par1Block, 0.0D, 0.0D, 0.0D,
					par1Block.getBlockTextureFromSideAndMetadata(5, par2));
			tessellator.draw();
			GL11.glTranslatef(0.5F, 0.5F, 0.5F);
		} else if (j == 1) {
			tessellator.startDrawingQuads();
			...
			tessellator.setNormal(0.0F, -1F, 0.0F);
			par1Block.setBlockBoundsForItemRender();
			renderBlockStemSmall(par1Block, par2, par1Block.maxY, -0.5D, -0.5D,
					-0.5D);
			tessellator.draw();
		} else if (j == 23) {
			tessellator.startDrawingQuads();
			...
			for (int l1 = 0; l1 < 8; l1++) {
				...
				i1 += byte0;
				par1Block.setBlockBounds(0.5F - f9, f11, 0.5F - f9, 0.5F + f9,
						f10, 0.5F + f9);
				tessellator.setNormal(0.0F, -1F, 0.0F);
				renderBottomFace(par1Block, 0.0D, 0.0D, 0.0D,
						par1Block.getBlockTextureFromSide(0));
			...
			for (int j1 = 0; j1 < 4; j1++) {
				...
				if (j1 == 0) {
					par1Block.setBlockBounds(0.5F - f4, 0.0F, 0.0F, 0.5F + f4,
							1.0F, f4 * 2.0F);
				}

				if (j1 == 1) {
					par1Block.setBlockBounds(0.5F - f4, 0.0F, 1.0F - f4 * 2.0F,
							0.5F + f4, 1.0F, 1.0F);
				}
				...
				if (j1 == 2) {
					par1Block.setBlockBounds(0.5F - f4, 1.0F - f4 * 3F,
							-f4 * 2.0F, 0.5F + f4, 1.0F - f4, 1.0F + f4 * 2.0F);
				}

				if (j1 == 3) {
					par1Block.setBlockBounds(0.5F - f4, 0.5F - f4 * 3F,
							-f4 * 2.0F, 0.5F + f4, 0.5F - f4, 1.0F + f4 * 2.0F);
				}
			...
			for (int k1 = 0; k1 < 3; k1++) {
				...
				if (k1 == 0) {
					par1Block.setBlockBounds(0.5F - f5, 0.3F, 0.0F, 0.5F + f5,
							1.0F, f5 * 2.0F);
				}

				if (k1 == 1) {
					par1Block.setBlockBounds(0.5F - f5, 0.3F, 1.0F - f5 * 2.0F,
							0.5F + f5, 1.0F, 1.0F);
				}
				...
				if (k1 == 2) {
					par1Block.setBlockBounds(0.5F - f5, 0.5F, 0.0F, 0.5F + f5,
							1.0F - f5, 1.0F);
				}
