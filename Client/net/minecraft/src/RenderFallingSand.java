...
public class RenderFallingSand extends Render {
	 ...
	 */
	public void doRenderFallingSand(EntityFallingSand par1EntityFallingSand,
		...
		if (block == Block.dragonEgg) {
			...
			tessellator.setTranslation((float) (-MathHelper
					.floor_double(par1EntityFallingSand.posX)) - 0.5F,
					(float) (-MathHelper
							.floor_double(par1EntityFallingSand.posY)) - 0.5F,
					(float) (-MathHelper
							.floor_double(par1EntityFallingSand.posZ)) - 0.5F);
	...
	public void doRender(Entity par1Entity, double par2, double par4,
		...
		doRenderFallingSand((EntityFallingSand) par1Entity, par2, par4, par6,
				par8, par9);
	}
}
