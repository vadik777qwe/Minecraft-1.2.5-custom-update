...
import net.minecraft.crafting.recipes.RecipesTools;
import net.minecraft.crafting.recipes.RecipesDyes;
import net.minecraft.crafting.recipes.RecipeSorter;
import net.minecraft.crafting.recipes.RecipesIngots;
import net.minecraft.crafting.recipes.RecipesCrafting;
import net.minecraft.crafting.recipes.RecipesArmor;
import net.minecraft.crafting.recipes.RecipesFood;
...
import net.minecraft.crafting.recipes.ShapedRecipes;
import net.minecraft.crafting.recipes.ShapelessRecipes;
...
public class CraftingManager {
	...
	private CraftingManager() {
		...
		addRecipe(new ItemStack(Block.netherFence, 6), new Object[] { "###",
				"###", '#', Block.netherBrick });
		addRecipe(new ItemStack(Block.fenceGate, 1), new Object[] { "#W#",
				"#W#", '#', Item.stick, 'W', Block.planks });
		addRecipe(new ItemStack(Block.jukebox, 1), new Object[] { "###", "#X#",
				"###", '#', Block.planks, 'X', Item.diamond });
		addRecipe(new ItemStack(Block.music, 1), new Object[] { "###", "#X#",
		...
		addRecipe(new ItemStack(Block.cloth, 1), new Object[] { "##", "##",
				'#', Item.silk });
		addRecipe(new ItemStack(Block.tnt, 1), new Object[] { "X#X", "#X#",
				"X#X", 'X', Item.gunpowder, '#', Block.sand });
		...
		addRecipe(new ItemStack(Item.stick, 4), new Object[] { "#", "#", '#',
				Block.planks });
		addRecipe(new ItemStack(Block.torchWood, 4), new Object[] { "X", "#",
		...
		addRecipe(new ItemStack(Block.railPowered, 6), new Object[] { "X X",
				"X#X", "XRX", 'X', Item.ingotGold, 'R', Item.redstone, '#',
				Item.stick });
		addRecipe(new ItemStack(Block.railDetector, 6), new Object[] { "X X",
				"X#X", "XRX", 'X', Item.ingotIron, 'R', Item.redstone, '#',
		...
		addRecipe(new ItemStack(Item.minecartCrate, 1), new Object[] { "A",
				"B", 'A', Block.chest, 'B', Item.minecartEmpty });
		addRecipe(new ItemStack(Item.minecartPowered, 1), new Object[] { "A",
				"B", 'A', Block.stoneOvenIdle, 'B', Item.minecartEmpty });
		addRecipe(new ItemStack(Item.boat, 1), new Object[] { "# #", "###",
				'#', Block.planks });
		addRecipe(new ItemStack(Item.bucketEmpty, 1), new Object[] { "# #",
				" # ", '#', Item.ingotIron });
		addRecipe(new ItemStack(Item.flintAndSteel, 1), new Object[] { "A ",
				" B", 'A', Item.ingotIron, 'B', Item.flint });
		...
		addRecipe(new ItemStack(Item.redstoneRepeater, 1), new Object[] {
				"#X#", "III", '#', Block.torchRedstoneActive, 'X',
				Item.redstone, 'I', Block.stone });
		addRecipe(new ItemStack(Item.pocketSundial, 1), new Object[] { " # ",
				"#X#", " # ", '#', Item.ingotGold, 'X', Item.redstone });
		addRecipe(new ItemStack(Item.compass, 1), new Object[] { " # ", "#X#",
				" # ", '#', Item.ingotIron, 'X', Item.redstone });
		addRecipe(new ItemStack(Item.map, 1), new Object[] { "###", "#X#",
		...
		addRecipe(new ItemStack(Block.dispenser, 1), new Object[] { "###",
				"#X#", "#R#", '#', Block.cobblestone, 'X', Item.bow, 'R',
				Item.redstone });
		addRecipe(new ItemStack(Block.pistonBase, 1), new Object[] { "TTT",
				"#X#", "#R#", '#', Block.cobblestone, 'X', Item.ingotIron, 'R',
				Item.redstone, 'T', Block.planks });
		addRecipe(new ItemStack(Block.pistonStickyBase, 1), new Object[] { "S",
	 ...
	 */
	public final void addRecipe(ItemStack par1ItemStack, Object par2ArrayOfObj[]) {
		String s = "";
		int i = 0;
		int j = 0;
		int k = 0;
