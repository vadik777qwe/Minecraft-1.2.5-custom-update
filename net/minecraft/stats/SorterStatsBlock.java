...
import net.minecraft.gui.GuiSlotStatsBlock;
...
public class SorterStatsBlock implements Comparator {
	...
	public SorterStatsBlock(GuiSlotStatsBlock par1GuiSlotStatsBlock,
			GuiStats par2GuiStats) {
		slotStatsBlockGUI = par1GuiSlotStatsBlock;
		statsGUI = par2GuiStats;
	}

	public int func_27297_a(StatCrafting par1StatCrafting,
		...
		if (statbase != null || statbase1 != null) {
			...
			int k = GuiStats
					.getStatsFileWriter(slotStatsBlockGUI.field_27274_a)
					.writeStat(statbase);
			int l = GuiStats
					.getStatsFileWriter(slotStatsBlockGUI.field_27274_a)
					.writeStat(statbase1);
