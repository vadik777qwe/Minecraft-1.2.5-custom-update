...
public class ComponentNetherBridgeStraight extends ComponentNetherBridgePiece {
	public ComponentNetherBridgeStraight(int par1, Random par2Random,
	...
	public static ComponentNetherBridgeStraight createValidComponent(
		...
		if (!isAboveGround(structureboundingbox)
			...
			return new ComponentNetherBridgeStraight(par6, par1Random,
	...
	public boolean addComponentParts(World par1World, Random par2Random,
		...
		for (int i = 0; i <= 4; i++) {
			for (int j = 0; j <= 2; j++) {
				...
				fillCurrentPositionBlocksDownwards(par1World,
						Block.netherBrick.blockID, 0, i, -1, 18 - j,
						par3StructureBoundingBox);
			}
		}
