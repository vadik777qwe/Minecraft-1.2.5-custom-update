...
public class ComponentVillageTorch extends ComponentVillage {
	...
	public ComponentVillageTorch(int par1, Random par2Random,
	...
	public static StructureBoundingBox findValidPlacement(List par0List,
		...
		StructureBoundingBox structureboundingbox = StructureBoundingBox
				.getComponentToAddBoundingBox(par2, par3, par4, 0, 0, 0, 3, 4,
						2, par5);
	...
	public boolean addComponentParts(World par1World, Random par2Random,
		...
		placeBlockAtCurrentPosition(par1World, Block.torchWood.blockID, 15, 0,
				3, 0, par3StructureBoundingBox);
		placeBlockAtCurrentPosition(par1World, Block.torchWood.blockID, 15, 1,
				3, 1, par3StructureBoundingBox);
		placeBlockAtCurrentPosition(par1World, Block.torchWood.blockID, 15, 2,
				3, 0, par3StructureBoundingBox);
		placeBlockAtCurrentPosition(par1World, Block.torchWood.blockID, 15, 1,
				3, -1, par3StructureBoundingBox);
		return true;
