...
import net.minecraft.enums.EnumDoorHelper;
...
public abstract class ComponentStronghold extends StructureComponent {
	 ...
	 */
	protected void placeDoor(World par1World, Random par2Random,
		...
		case 4:
			...
			placeBlockAtCurrentPosition(par1World, Block.stoneBrick.blockID, 0,
					par5 + 2, par6, par7, par3StructureBoundingBox);
			placeBlockAtCurrentPosition(par1World, Block.doorSteel.blockID, 0,
					par5 + 1, par6, par7, par3StructureBoundingBox);
			placeBlockAtCurrentPosition(par1World, Block.doorSteel.blockID, 8,
					par5 + 1, par6 + 1, par7, par3StructureBoundingBox);
			placeBlockAtCurrentPosition(par1World, Block.button.blockID,
					getMetadataWithOffset(Block.button.blockID, 4), par5 + 2,
					par6 + 1, par7 + 1, par3StructureBoundingBox);
			placeBlockAtCurrentPosition(par1World, Block.button.blockID,
					getMetadataWithOffset(Block.button.blockID, 3), par5 + 2,
					par6 + 1, par7 - 1, par3StructureBoundingBox);
			break;
		}
	}
	...
	protected StructureComponent getNextComponentNormal(
			ComponentStrongholdStairs2 par1ComponentStrongholdStairs2,
