...
public class ComponentNetherBridgeCorridor2 extends ComponentNetherBridgePiece {
	public ComponentNetherBridgeCorridor2(int par1, Random par2Random,
	...
	public static ComponentNetherBridgeCorridor2 createValidComponent(
		...
		if (!isAboveGround(structureboundingbox)
			...
			return new ComponentNetherBridgeCorridor2(par6, par1Random,
	...
	public boolean addComponentParts(World par1World, Random par2Random,
		...
		fillWithBlocks(par1World, par3StructureBoundingBox, 4, 2, 0, 4, 5, 0,
				Block.netherBrick.blockID, Block.netherBrick.blockID, false);
		fillWithBlocks(par1World, par3StructureBoundingBox, 1, 2, 4, 4, 5, 4,
				Block.netherBrick.blockID, Block.netherBrick.blockID, false);
