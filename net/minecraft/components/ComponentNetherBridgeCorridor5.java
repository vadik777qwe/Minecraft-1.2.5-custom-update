...
public class ComponentNetherBridgeCorridor5 extends ComponentNetherBridgePiece {
	public ComponentNetherBridgeCorridor5(int par1, Random par2Random,
	 ...
	 */
	public static ComponentNetherBridgeCorridor5 createValidComponent(
		...
		if (!isAboveGround(structureboundingbox)
			...
			return new ComponentNetherBridgeCorridor5(par6, par1Random,
	...
	public boolean addComponentParts(World par1World, Random par2Random,
		...
		fillWithBlocks(par1World, par3StructureBoundingBox, 0, 2, 0, 4, 5, 4,
				0, 0, false);
		fillWithBlocks(par1World, par3StructureBoundingBox, 0, 2, 0, 0, 5, 4,
				Block.netherBrick.blockID, Block.netherBrick.blockID, false);
		fillWithBlocks(par1World, par3StructureBoundingBox, 4, 2, 0, 4, 5, 4,
				Block.netherBrick.blockID, Block.netherBrick.blockID, false);
		fillWithBlocks(par1World, par3StructureBoundingBox, 0, 3, 1, 0, 4, 1,
				Block.netherFence.blockID, Block.netherFence.blockID, false);
		fillWithBlocks(par1World, par3StructureBoundingBox, 0, 3, 3, 0, 4, 3,
				Block.netherFence.blockID, Block.netherFence.blockID, false);
