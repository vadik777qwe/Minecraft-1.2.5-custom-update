...
public class ComponentVillageWell extends ComponentVillage {
	...
	public boolean addComponentParts(World par1World, Random par2Random,
		...
		if (averageGroundLevel < 0) {
			...
			boundingBox.offset(0, (averageGroundLevel - boundingBox.maxY) + 3,
					0);
		}
			...
			for (int j = 0; j <= 5; j++) {
				if (j == 0 || j == 5 || i == 0 || i == 5) {
					placeBlockAtCurrentPosition(par1World,
							Block.gravel.blockID, 0, j, 11, i,
							par3StructureBoundingBox);
					clearCurrentPositionBlocksUpwards(par1World, j, 12, i,
							par3StructureBoundingBox);
				}
			}
		}
