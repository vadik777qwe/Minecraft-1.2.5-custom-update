...
public class ComponentVillageField2 extends ComponentVillage {
	...
	public ComponentVillageField2(int par1, Random par2Random,
	 ...
	 */
	public static ComponentVillageField2 findValidPlacement(List par0List,
		...
		StructureBoundingBox structureboundingbox = StructureBoundingBox
				.getComponentToAddBoundingBox(par2, par3, par4, 0, 0, 0, 7, 4,
						9, par5);
		...
		if (!canVillageGoDeeper(structureboundingbox)
			...
			return new ComponentVillageField2(par6, par1Random,
