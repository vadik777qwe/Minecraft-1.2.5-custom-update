...
public class ComponentVillageField extends ComponentVillage {
	...
	public ComponentVillageField(int par1, Random par2Random,
	 ...
	 */
	public static ComponentVillageField findValidPlacement(List par0List,
		...
		StructureBoundingBox structureboundingbox = StructureBoundingBox
				.getComponentToAddBoundingBox(par2, par3, par4, 0, 0, 0, 13, 4,
						9, par5);
		...
		if (!canVillageGoDeeper(structureboundingbox)
			...
			return new ComponentVillageField(par6, par1Random,
	...
	public boolean addComponentParts(World par1World, Random par2Random,
		...
		fillWithBlocks(par1World, par3StructureBoundingBox, 0, 1, 0, 12, 4, 8,
				0, 0, false);
		...
		fillWithBlocks(par1World, par3StructureBoundingBox, 6, 0, 0, 6, 0, 8,
				Block.wood.blockID, Block.wood.blockID, false);
		fillWithBlocks(par1World, par3StructureBoundingBox, 12, 0, 0, 12, 0, 8,
				Block.wood.blockID, Block.wood.blockID, false);
		fillWithBlocks(par1World, par3StructureBoundingBox, 1, 0, 0, 11, 0, 0,
				Block.wood.blockID, Block.wood.blockID, false);
		fillWithBlocks(par1World, par3StructureBoundingBox, 1, 0, 8, 11, 0, 8,
				Block.wood.blockID, Block.wood.blockID, false);
		fillWithBlocks(par1World, par3StructureBoundingBox, 3, 0, 1, 3, 0, 7,
				Block.waterMoving.blockID, Block.waterMoving.blockID, false);
		fillWithBlocks(par1World, par3StructureBoundingBox, 9, 0, 1, 9, 0, 7,
				Block.waterMoving.blockID, Block.waterMoving.blockID, false);

		for (int i = 1; i <= 7; i++) {
			placeBlockAtCurrentPosition(par1World, Block.crops.blockID,
					MathHelper.getRandomIntegerInRange(par2Random, 2, 7), 1, 1,
					i, par3StructureBoundingBox);
			placeBlockAtCurrentPosition(par1World, Block.crops.blockID,
			...
			placeBlockAtCurrentPosition(par1World, Block.crops.blockID,
					...
					i, par3StructureBoundingBox);
			placeBlockAtCurrentPosition(par1World, Block.crops.blockID,
					MathHelper.getRandomIntegerInRange(par2Random, 2, 7), 7, 1,
					i, par3StructureBoundingBox);
			placeBlockAtCurrentPosition(par1World, Block.crops.blockID,
					MathHelper.getRandomIntegerInRange(par2Random, 2, 7), 8, 1,
					i, par3StructureBoundingBox);
			placeBlockAtCurrentPosition(par1World, Block.crops.blockID,
					MathHelper.getRandomIntegerInRange(par2Random, 2, 7), 10,
					1, i, par3StructureBoundingBox);
			placeBlockAtCurrentPosition(par1World, Block.crops.blockID,
					MathHelper.getRandomIntegerInRange(par2Random, 2, 7), 11,
					1, i, par3StructureBoundingBox);
		}

		for (int j = 0; j < 9; j++) {
			for (int k = 0; k < 13; k++) {
				clearCurrentPositionBlocksUpwards(par1World, k, 4, j,
						par3StructureBoundingBox);
				fillCurrentPositionBlocksDownwards(par1World,
						Block.dirt.blockID, 0, k, -1, j,
						par3StructureBoundingBox);
			}
		}
