...
public class MinecraftApplet extends Applet {
	...
	public void init() {
		...
		if (getParameter("username") != null
			...
			System.out.println((new StringBuilder()).append("Setting user: ")
					.append(mc.session.username).append(", ")
					.append(mc.session.sessionId).toString());
	...
	/**
	 * Removes all the components from the applet and lays it out again. Called
	 * on shutdown.
	 */
