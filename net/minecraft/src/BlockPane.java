...
public class BlockPane extends Block {
	...
	protected BlockPane(int par1, int par2, int par3, Material par4Material,
			boolean par5) {
	...
	public void getCollidingBoundingBoxes(World par1World, int par2, int par3,
		...
		boolean flag = canThisPaneConnectToThisBlockID(par1World.getBlockId(
				par2, par3, par4 - 1));
		boolean flag1 = canThisPaneConnectToThisBlockID(par1World.getBlockId(
				par2, par3, par4 + 1));
		boolean flag2 = canThisPaneConnectToThisBlockID(par1World.getBlockId(
				par2 - 1, par3, par4));
		boolean flag3 = canThisPaneConnectToThisBlockID(par1World.getBlockId(
				par2 + 1, par3, par4));
	...
	public void setBlockBoundsBasedOnState(IBlockAccess par1IBlockAccess,
		...
		float f2 = 0.4375F;
		float f3 = 0.5625F;
		boolean flag = canThisPaneConnectToThisBlockID(par1IBlockAccess
				.getBlockId(par2, par3, par4 - 1));
		boolean flag1 = canThisPaneConnectToThisBlockID(par1IBlockAccess
				.getBlockId(par2, par3, par4 + 1));
		boolean flag2 = canThisPaneConnectToThisBlockID(par1IBlockAccess
				.getBlockId(par2 - 1, par3, par4));
		boolean flag3 = canThisPaneConnectToThisBlockID(par1IBlockAccess
				.getBlockId(par2 + 1, par3, par4));
