...
public class GuiButton extends Gui {
	...
	public GuiButton(int par1, int par2, int par3, int par4, int par5,
			String par6Str) {
		field_52008_a = 200;
		field_52007_b = 20;
		enabled = true;
	...
	public void drawButton(Minecraft par1Minecraft, int par2, int par3) {
		...
		boolean flag = par2 >= xPosition && par3 >= yPosition
				&& par2 < xPosition + field_52008_a
				&& par3 < yPosition + field_52007_b;
		int i = getHoverState(flag);
		drawTexturedModalRect(xPosition, yPosition, 0, 46 + i * 20,
				field_52008_a / 2, field_52007_b);
		drawTexturedModalRect(xPosition + field_52008_a / 2, yPosition,
				200 - field_52008_a / 2, 46 + i * 20, field_52008_a / 2,
				field_52007_b);
		...
		drawCenteredString(fontrenderer, displayString, xPosition
				+ field_52008_a / 2, yPosition + (field_52007_b - 8) / 2, j);
	}
