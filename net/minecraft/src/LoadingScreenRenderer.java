...
public class LoadingScreenRenderer implements IProgressUpdate {
	...
	public void func_597_c(String par1Str) {
		if (!mc.running) {
			...
			GL11.glOrtho(0.0D, scaledresolution.scaledWidthD,
					scaledresolution.scaledHeightD, 0.0D, 100D, 300D);
	...
	public void setLoadingProgress(int par1) {
		...
		mc.fontRenderer
				.drawStringWithShadow(currentlyDisplayedText,
						(i - mc.fontRenderer
								.getStringWidth(currentlyDisplayedText)) / 2,
						j / 2 - 4 - 16, 0xffffff);
		mc.fontRenderer.drawStringWithShadow(field_1004_a,
				(i - mc.fontRenderer.getStringWidth(field_1004_a)) / 2,
				(j / 2 - 4) + 8, 0xffffff);
		Display.update();
