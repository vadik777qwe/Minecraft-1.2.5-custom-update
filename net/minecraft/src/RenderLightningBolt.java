...
public class RenderLightningBolt extends Render {
	...
	public void doRenderLightningBolt(
			EntityLightningBolt par1EntityLightningBolt, double par2,
		...
		for (int i = 0; i < 4; i++) {
			...
			for (int k = 0; k < 3; k++) {
				...
				for (int j1 = l; j1 >= i1; j1--) {
					...
					float f = 0.5F;
					tessellator.setColorRGBA_F(0.9F * f, 0.9F * f, 1.0F * f,
							0.3F);
					...
					for (int k1 = 0; k1 < 5; k1++) {
						...
						tessellator.addVertex(d10 + d2, par4
								+ (double) (j1 * 16), d11 + d3);
						tessellator.addVertex(d8 + d4, par4
								+ (double) ((j1 + 1) * 16), d9 + d5);
					}
	...
	public void doRender(Entity par1Entity, double par2, double par4,
		...
		doRenderLightningBolt((EntityLightningBolt) par1Entity, par2, par4,
				par6, par8, par9);
	}
}
