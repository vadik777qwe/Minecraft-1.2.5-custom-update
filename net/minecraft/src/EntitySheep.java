...
public class EntitySheep extends EntityAnimal {
	public static final float fleeceColorTable[][] = { { 1.0F, 1.0F, 1.0F },
			...
			{ 0.6F, 0.7F, 0.95F }, { 0.9F, 0.9F, 0.2F }, { 0.5F, 0.8F, 0.1F },
			{ 0.95F, 0.7F, 0.8F }, { 0.3F, 0.3F, 0.3F }, { 0.6F, 0.6F, 0.6F },
			{ 0.3F, 0.6F, 0.7F }, { 0.7F, 0.4F, 0.9F }, { 0.2F, 0.4F, 0.8F },
			{ 0.5F, 0.4F, 0.3F }, { 0.4F, 0.5F, 0.2F }, { 0.8F, 0.3F, 0.3F },
			{ 0.1F, 0.1F, 0.1F } };
	...
	public EntitySheep(World par1World) {
		...
		tasks.addTask(3, new EntityAITempt(this, 0.25F,
	...
	public boolean interact(EntityPlayer par1EntityPlayer) {
		...
		if (itemstack != null && itemstack.itemID == Item.shears.shiftedIndex
			...
			if (!worldObj.isRemote) {
				...
				for (int j = 0; j < i; j++) {
					EntityItem entityitem = entityDropItem(new ItemStack(
	...
	public void setFleeceColor(int par1) {
		...
		dataWatcher.updateObject(16,
				Byte.valueOf((byte) (byte0 & 0xf0 | par1 & 0xf)));
	}
	...
	public void setSheared(boolean par1) {
		...
		if (par1) {
			...
			dataWatcher.updateObject(16,
					Byte.valueOf((byte) (byte0 & 0xffffffef)));
		}
	}
