...
public class ChunkCache implements IBlockAccess {
	...
	public int getBlockId(int par1, int par2, int par3) {
		...
		if (i < 0 || i >= chunkArray.length || j < 0
				|| j >= chunkArray[i].length) {
			return 0;
		}
	...
	public TileEntity getBlockTileEntity(int par1, int par2, int par3) {
		int i = (par1 >> 4) - chunkX;
		int j = (par3 >> 4) - chunkZ;
		return chunkArray[i][j].getChunkBlockTileEntity(par1 & 0xf, par2,
				par3 & 0xf);
	}
	...
	public float getLightBrightness(int par1, int par2, int par3) {
		return worldObj.worldProvider.lightBrightnessTable[getLightValue(par1,
				par2, par3)];
	}
	...
	public int getLightValueExt(int par1, int par2, int par3, boolean par4) {
		...
		if (par2 >= 256) {
			...
			return chunkArray[k][i1].getBlockLightValue(par1 & 0xf, par2,
					par3 & 0xf, worldObj.skylightSubtracted);
		}
	}
	...
	public int getBlockMetadata(int par1, int par2, int par3) {
		...
		if (par2 >= 256) {
			...
			int i = (par1 >> 4) - chunkX;
			int j = (par3 >> 4) - chunkZ;
			return chunkArray[i][j].getBlockMetadata(par1 & 0xf, par2,
					par3 & 0xf);
		}
	}
	...
	public int getSkyBlockTypeBrightness(EnumSkyBlock par1EnumSkyBlock,
		...
		if (par3 < 0 || par3 >= 256 || par2 < 0xfe363c80 || par4 < 0xfe363c80
				|| par2 >= 0x1c9c380 || par4 > 0x1c9c380) {
			return par1EnumSkyBlock.defaultLightValue;
		}

		if (Block.useNeighborBrightness[getBlockId(par2, par3, par4)]) {
			int i = getSpecialBlockBrightness(par1EnumSkyBlock, par2, par3 + 1,
					par4);
			int k = getSpecialBlockBrightness(par1EnumSkyBlock, par2 + 1, par3,
					par4);
			int i1 = getSpecialBlockBrightness(par1EnumSkyBlock, par2 - 1,
					par3, par4);
			int j1 = getSpecialBlockBrightness(par1EnumSkyBlock, par2, par3,
					par4 + 1);
			int k1 = getSpecialBlockBrightness(par1EnumSkyBlock, par2, par3,
					par4 - 1);
			...
			int j = (par2 >> 4) - chunkX;
			int l = (par4 >> 4) - chunkZ;
			return chunkArray[j][l].getSavedLightValue(par1EnumSkyBlock,
					par2 & 0xf, par3, par4 & 0xf);
		}
	}
	...
	public int getSpecialBlockBrightness(EnumSkyBlock par1EnumSkyBlock,
		...
		if (par3 < 0 || par3 >= 256 || par2 < 0xfe363c80 || par4 < 0xfe363c80
			...
			int i = (par2 >> 4) - chunkX;
			int j = (par4 >> 4) - chunkZ;
			return chunkArray[i][j].getSavedLightValue(par1EnumSkyBlock,
					par2 & 0xf, par3, par4 & 0xf);
		}
	}
