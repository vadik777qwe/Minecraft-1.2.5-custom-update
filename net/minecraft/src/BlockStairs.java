...
public class BlockStairs extends Block {
	...
	public int getMixedBrightnessForBlock(IBlockAccess par1IBlockAccess,
			int par2, int par3, int par4) {
		return modelBlock.getMixedBrightnessForBlock(par1IBlockAccess, par2,
				par3, par4);
	}
	...
	public float getBlockBrightness(IBlockAccess par1IBlockAccess, int par2,
			int par3, int par4) {
		return modelBlock
				.getBlockBrightness(par1IBlockAccess, par2, par3, par4);
	}
	...
	public AxisAlignedBB getSelectedBoundingBoxFromPool(World par1World,
			int par2, int par3, int par4) {
		return modelBlock.getSelectedBoundingBoxFromPool(par1World, par2, par3,
				par4);
	}
	...
	public void velocityToAddToEntity(World par1World, int par2, int par3,
		...
		modelBlock.velocityToAddToEntity(par1World, par2, par3, par4,
				par5Entity, par6Vec3D);
	}
	...
	public boolean blockActivated(World par1World, int par2, int par3,
		...
		return modelBlock.blockActivated(par1World, par2, par3, par4,
				par5EntityPlayer);
	}
