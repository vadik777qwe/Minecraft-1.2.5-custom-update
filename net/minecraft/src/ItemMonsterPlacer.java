...
public class ItemMonsterPlacer extends Item {
	...
	public boolean onItemUse(ItemStack par1ItemStack,
		...
		if (par7 == 1 && i == Block.fence.blockID
				|| i == Block.netherFence.blockID) {
			d = 0.5D;
		}

		if (func_48440_a(par3World, par1ItemStack.getItemDamage(),
				(double) par4 + 0.5D, (double) par5 + d, (double) par6 + 0.5D)
	...
	public static boolean func_48440_a(World par0World, int par1, double par2,
		...
		if (entity != null) {
			entity.setLocationAndAngles(par2, par4, par6,
					par0World.rand.nextFloat() * 360F, 0.0F);
