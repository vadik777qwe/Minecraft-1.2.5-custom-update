...
public class GuiGameOver extends GuiScreen {
	...
	public void initGui() {
		...
		if (mc.theWorld.getWorldInfo().isHardcoreModeEnabled()) {
			controlList.add(new GuiButton(1, width / 2 - 100, height / 4 + 96,
					StatCollector.translateToLocal("deathScreen.deleteWorld")));
		} else {
			controlList.add(new GuiButton(1, width / 2 - 100, height / 4 + 72,
					StatCollector.translateToLocal("deathScreen.respawn")));
			controlList.add(new GuiButton(2, width / 2 - 100, height / 4 + 96,
		...
		drawCenteredString(
				...
				(new StringBuilder())
						.append(StatCollector
								.translateToLocal("deathScreen.score"))
						.append(": \247e").append(mc.thePlayer.getScore())
						.toString(), width / 2, 100, 0xffffff);
