...
public class GLAllocation {
	/**
	 * An ArrayList that stores the first index and the length of each display
	 * list.
	 */
	...
	/**
	 * Deletes all textures and display lists. Called when Minecraft is shutdown
	...
	public static synchronized ByteBuffer createDirectByteBuffer(int par0) {
		ByteBuffer bytebuffer = ByteBuffer.allocateDirect(par0).order(
