...
public class EntityAIBreakDoor extends EntityAIDoorInteract {
	...
	public boolean shouldExecute() {
		if (!super.shouldExecute()) {
			...
			return !targetDoor.func_48213_h(theEntity.worldObj, entityPosX,
	...
	public boolean continueExecuting() {
		...
		return field_48329_i >= 0
				&& !targetDoor.func_48213_h(theEntity.worldObj, entityPosX,
						entityPosY, entityPosZ) && d < 4D;
	}
