...
public class StringTranslate {
	...
	private void loadLanguage(Properties par1Properties, String par2Str)
			throws IOException {
		BufferedReader bufferedreader = new BufferedReader(
				new InputStreamReader((net.minecraft.src.StringTranslate.class)
						.getResourceAsStream((new StringBuilder())
								.append("/lang/").append(par2Str)
								.append(".lang").toString()), "UTF-8"));
	...
	public String translateNamedKey(String par1Str) {
		return translateTable.getProperty((new StringBuilder()).append(par1Str)
