...
public class LongHashMap {
	...
	public Object getValueByKey(long par1) {
		...
		for (LongHashMapEntry longhashmapentry = hashArray[getHashIndex(i,
				hashArray.length)]; longhashmapentry != null; longhashmapentry = longhashmapentry.nextEntry) {
	...
	private void createKey(int par1, long par2, Object par4Obj, int par5) {
		...
		hashArray[par5] = new LongHashMapEntry(par1, par2, par4Obj,
				longhashmapentry);
