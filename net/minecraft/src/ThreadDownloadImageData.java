...
public class ThreadDownloadImageData {
	...
	/**
	 * The GL texture name associated with this image, or -1 if the texture has
	 * not been allocated
	 */
	public int textureName;

	/**
	 * True if the texture has been allocated and the image copied to the
	 * texture. This is reset if global rendering settings change, so that
	 * setupTexture will be called again.
	 */
