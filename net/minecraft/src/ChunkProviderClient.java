...
public class ChunkProviderClient implements IChunkProvider {
	...
	public Chunk provideChunk(int par1, int par2) {
		Chunk chunk = (Chunk) chunkMapping.getValueByKey(ChunkCoordIntPair
	...
	public String makeString() {
		return (new StringBuilder()).append("MultiplayerChunkCache: ")
				.append(chunkMapping.getNumHashElements()).toString();
	}
