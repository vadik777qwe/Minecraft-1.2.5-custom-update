...
public class NoiseGeneratorPerlin extends NoiseGenerator {
	...
	public void func_805_a(double par1ArrayOfDouble[], double par2,
		...
		if (par9 == 1) {
			...
			for (int j3 = 0; j3 < par8; j3++) {
				...
				for (int i4 = 0; i4 < par10; i4++) {
					...
					double d2 = lerp(d10,
							func_4110_a(permutations[k], d7, d12),
							grad(permutations[i1], d7 - 1.0D, 0.0D, d12));
					double d4 = lerp(
							d10,
							grad(permutations[k + 1], d7, 0.0D, d12 - 1.0D),
							grad(permutations[i1 + 1], d7 - 1.0D, 0.0D,
									d12 - 1.0D));
			...
			for (int k5 = 0; k5 < par10; k5++) {
				...
				for (int j6 = 0; j6 < par9; j6++) {
					...
					if (j6 == 0 || l6 != j1) {
						...
						d6 = lerp(d15, grad(permutations[l1], d13, d19, d17),
								grad(permutations[l2], d13 - 1.0D, d19, d17));
						d8 = lerp(
								d15,
								grad(permutations[i2], d13, d19 - 1.0D, d17),
								grad(permutations[i3], d13 - 1.0D, d19 - 1.0D,
										d17));
						d9 = lerp(
								d15,
								grad(permutations[l1 + 1], d13, d19, d17 - 1.0D),
								grad(permutations[l2 + 1], d13 - 1.0D, d19,
										d17 - 1.0D));
						d11 = lerp(
								d15,
								grad(permutations[i2 + 1], d13, d19 - 1.0D,
										d17 - 1.0D),
								grad(permutations[i3 + 1], d13 - 1.0D,
										d19 - 1.0D, d17 - 1.0D));
					}
