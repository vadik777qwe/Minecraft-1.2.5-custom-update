...
class GuiSlotStatsGeneral extends GuiSlot {
	...
	protected void drawSlot(int par1, int par2, int par3, int par4,
		...
		field_27276_a.drawString(GuiStats.getFontRenderer1(field_27276_a),
				StatCollector.translateToLocal(statbase.getName()), par2 + 2,
				par3 + 1, par1 % 2 != 0 ? 0x909090 : 0xffffff);
		String s = statbase.func_27084_a(GuiStats.getStatsFileWriter(
				field_27276_a).writeStat(statbase));
		field_27276_a.drawString(GuiStats.getFontRenderer2(field_27276_a), s,
				(par2 + 2 + 213)
						- GuiStats.getFontRenderer3(field_27276_a)
								.getStringWidth(s), par3 + 1,
				par1 % 2 != 0 ? 0x909090 : 0xffffff);
	}
}
