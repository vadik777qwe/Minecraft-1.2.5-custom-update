...
public interface IChunkProvider {
	 ...
	 * saved.
	 */
	public abstract boolean saveChunks(boolean flag,
	 ...
	 * given location.
	 */
	public abstract List getPossibleCreatures(
			EnumCreatureType enumcreaturetype, int i, int j, int k);

	/**
	 * Returns the location of the closest structure of the specified type. If
	 * not found returns null.
	 */
	public abstract ChunkPosition findClosestStructure(World world, String s,
			int i, int j, int k);
}
