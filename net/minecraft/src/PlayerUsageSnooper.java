...
public class PlayerUsageSnooper {
	...
	public PlayerUsageSnooper(String par1Str) {
		...
		try {
			field_52024_b = new URL((new StringBuilder())
					.append("http://snoop.minecraft.net/").append(par1Str)
					.toString());
	...
	public void func_52021_a() {
		PlayerUsageSnooperThread playerusagesnooperthread = new PlayerUsageSnooperThread(
				this, "reporter");
