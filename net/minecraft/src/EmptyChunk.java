...
public class EmptyChunk extends Chunk {
	 ...
	 * blockID, metadata
	 */
	public boolean setBlockIDWithMetadata(int par1, int par2, int par3, int i,
			int j) {
		return true;
	}
	...
	public void getEntitiesWithinAABBForEntity(Entity entity,
			AxisAlignedBB axisalignedbb, List list) {
	}
	 ...
	 */
	public void getEntitiesOfTypeWithinAAAB(Class class1,
			AxisAlignedBB axisalignedbb, List list) {
	}
