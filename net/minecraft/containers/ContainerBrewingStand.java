...
import net.minecraft.inventory.slot.SlotBrewingStandIngredient;
import net.minecraft.inventory.slot.SlotBrewingStandPotion;
...
public class ContainerBrewingStand extends Container {
	...
	public ContainerBrewingStand(InventoryPlayer par1InventoryPlayer,
		...
		addSlot(new SlotBrewingStandPotion(this, par1InventoryPlayer.player,
				par2TileEntityBrewingStand, 0, 56, 46));
		addSlot(new SlotBrewingStandPotion(this, par1InventoryPlayer.player,
				par2TileEntityBrewingStand, 1, 79, 53));
		addSlot(new SlotBrewingStandPotion(this, par1InventoryPlayer.player,
				par2TileEntityBrewingStand, 2, 102, 46));
		addSlot(new SlotBrewingStandIngredient(this,
				par2TileEntityBrewingStand, 3, 79, 17));
