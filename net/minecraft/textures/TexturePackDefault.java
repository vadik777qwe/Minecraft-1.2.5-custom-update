...
public class TexturePackDefault extends TexturePackBase {
	/**
	 * The allocated OpenGL for this TexturePack, or -1 if it hasn't been loaded
	 * yet.
	 */
	...
	public TexturePackDefault() {
		...
		try {
			texturePackThumbnail = ImageIO
					.read((net.minecraft.textures.TexturePackDefault.class)
							.getResource("/pack.png"));
