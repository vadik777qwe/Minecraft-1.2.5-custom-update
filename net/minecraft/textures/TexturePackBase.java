...
public abstract class TexturePackBase {
	/**
	 * The file name of the texture pack, or Default if not from a custom
	 * texture pack.
	 */
	public String texturePackFileName;

	/**
	 * The first line of the texture pack description (read from the pack.txt
	 * file)
	 */
	public String firstDescriptionLine;

	/**
	 * The second line of the texture pack description (read from the pack.txt
	 * file)
	 */
