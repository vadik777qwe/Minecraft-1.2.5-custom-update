...
public class TexturePackFolder extends TexturePackBase {
			...
			try {
				try {
					try {
						...
						firstDescriptionLine = func_48188_b(bufferedreader
								.readLine());
						secondDescriptionLine = func_48188_b(bufferedreader
								.readLine());
	...
	public void bindThumbnailTexture(Minecraft par1Minecraft) {
		if (field_48189_f != null && field_48191_e < 0) {
			field_48191_e = par1Minecraft.renderEngine
					.allocateAndSetupTexture(field_48189_f);
		}
