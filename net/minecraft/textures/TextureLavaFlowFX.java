...
public class TextureLavaFlowFX extends TextureFX {
	...
	public void onTick() {
		...
		for (int i = 0; i < 16; i++) {
			for (int j = 0; j < 16; j++) {
				float f = 0.0F;
				int l = (int) (MathHelper
						.sin(((float) j * (float) Math.PI * 2.0F) / 16F) * 1.2F);
				int i1 = (int) (MathHelper
						.sin(((float) i * (float) Math.PI * 2.0F) / 16F) * 1.2F);
				...
				field_1142_h[i + j * 16] = f
						/ 10F
						+ ((field_1141_i[(i + 0 & 0xf) + (j + 0 & 0xf) * 16]
								+ field_1141_i[(i + 1 & 0xf) + (j + 0 & 0xf)
										* 16]
								+ field_1141_i[(i + 1 & 0xf) + (j + 1 & 0xf)
										* 16] + field_1141_i[(i + 0 & 0xf)
								+ (j + 1 & 0xf) * 16]) / 4F) * 0.8F;
