...
public class ItemReed extends Item {
	...
	public boolean onItemUse(ItemStack par1ItemStack,
		...
		if (par3World
				.canBlockBePlacedAt(spawnID, par4, par5, par6, false, par7)) {
			...
			if (par3World.setBlockWithNotify(par4, par5, par6, spawnID)) {
				if (par3World.getBlockId(par4, par5, par6) == spawnID) {
					Block.blocksList[spawnID].onBlockPlaced(par3World, par4,
							par5, par6, par7);
					Block.blocksList[spawnID].onBlockPlacedBy(par3World, par4,
