...
public class BlockPistonExtension extends Block {
	...
	public void onBlockRemoval(World par1World, int par2, int par3, int par4) {
		...
		if (l == Block.pistonBase.blockID
			...
			if (BlockPistonBase.isExtended(j)) {
				Block.blocksList[l].dropBlockAsItem(par1World, par2, par3,
						par4, j, 0);
	...
	public void onNeighborBlockChange(World par1World, int par2, int par3,
		...
		int j = par1World.getBlockId(par2 - Facing.offsetsXForSide[i], par3
				- Facing.offsetsYForSide[i], par4 - Facing.offsetsZForSide[i]);

		if (j != Block.pistonBase.blockID
				&& j != Block.pistonStickyBase.blockID) {
			par1World.setBlockWithNotify(par2, par3, par4, 0);
		} else {
			Block.blocksList[j].onNeighborBlockChange(par1World, par2
					- Facing.offsetsXForSide[i], par3
					- Facing.offsetsYForSide[i], par4
					- Facing.offsetsZForSide[i], par5);
		}
	}
