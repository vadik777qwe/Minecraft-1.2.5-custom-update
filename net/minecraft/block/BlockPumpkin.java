...
public class BlockPumpkin extends BlockDirectional {
	...
	public void onBlockAdded(World par1World, int par2, int par3, int par4) {
		...
		if (par1World.getBlockId(par2, par3 - 1, par4) == Block.blockSnow.blockID
			...
			if (!par1World.isRemote) {
				...
				entitysnowman
						.setLocationAndAngles((double) par2 + 0.5D,
								(double) par3 - 1.95D, (double) par4 + 0.5D,
								0.0F, 0.0F);
			...
			for (int i = 0; i < 120; i++) {
				par1World.spawnParticle("snowshovel", (double) par2
						+ par1World.rand.nextDouble(), (double) (par3 - 2)
						+ par1World.rand.nextDouble() * 2.5D, (double) par4
			...
			boolean flag = par1World.getBlockId(par2 - 1, par3 - 1, par4) == Block.blockSteel.blockID
					&& par1World.getBlockId(par2 + 1, par3 - 1, par4) == Block.blockSteel.blockID;
			boolean flag1 = par1World.getBlockId(par2, par3 - 1, par4 - 1) == Block.blockSteel.blockID
			...
			if (flag || flag1) {
				...
				for (int j = 0; j < 120; j++) {
					par1World.spawnParticle("snowballpoof", (double) par2
							+ par1World.rand.nextDouble(),
							(double) (par3 - 2) + par1World.rand.nextDouble()
									* 3.8999999999999999D, (double) par4
									+ par1World.rand.nextDouble(), 0.0D, 0.0D,
							0.0D);
				}
	...
	public void onBlockPlacedBy(World par1World, int par2, int par3, int par4,
		...
		int i = MathHelper
				.floor_double((double) ((par5EntityLiving.rotationYaw * 4F) / 360F) + 2.5D) & 3;
