...
public class BlockFence extends Block {
	...
	public AxisAlignedBB getCollisionBoundingBoxFromPool(World par1World,
		...
		return AxisAlignedBB.getBoundingBoxFromPool((float) par2 + f, par3,
				(float) par4 + f2, (float) par2 + f1, (float) par3 + 1.5F,
				(float) par4 + f3);
	}
	...
	public void setBlockBoundsBasedOnState(IBlockAccess par1IBlockAccess,
		...
		boolean flag1 = canConnectFenceTo(par1IBlockAccess, par2, par3,
				par4 + 1);
		boolean flag2 = canConnectFenceTo(par1IBlockAccess, par2 - 1, par3,
				par4);
		boolean flag3 = canConnectFenceTo(par1IBlockAccess, par2 + 1, par3,
				par4);
		float f = 0.375F;
		float f1 = 0.625F;
		float f2 = 0.375F;
