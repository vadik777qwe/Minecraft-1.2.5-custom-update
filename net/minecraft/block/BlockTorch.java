...
public class BlockTorch extends Block {
	...
	private boolean canPlaceTorchOn(World par1World, int par2, int par3,
		...
		if (i == Block.fence.blockID || i == Block.netherFence.blockID
				|| i == Block.glass.blockID) {
			return true;
		}

		if (Block.blocksList[i] != null
				&& (Block.blocksList[i] instanceof BlockStairs)) {
	...
	public void onBlockPlaced(World par1World, int par2, int par3, int par4,
		...
		if (par5 == 2
				&& par1World.isBlockNormalCubeDefault(par2, par3, par4 + 1,
						true)) {
			i = 4;
		}
		...
		if (par5 == 4
				&& par1World.isBlockNormalCubeDefault(par2 + 1, par3, par4,
						true)) {
			i = 2;
		}
	...
	public void onBlockAdded(World par1World, int par2, int par3, int par4) {
		...
		} else if (par1World.isBlockNormalCubeDefault(par2 + 1, par3, par4,
				true)) {
			par1World.setBlockMetadataWithNotify(par2, par3, par4, 2);
		} else if (par1World.isBlockNormalCubeDefault(par2, par3, par4 - 1,
				true)) {
	 ...
	 */
	private boolean dropTorchIfCantStay(World par1World, int par2, int par3,
			int par4) {
	...
	public void randomDisplayTick(World par1World, int par2, int par3,
		...
		if (i == 1) {
			par1World.spawnParticle("smoke", d - d4, d1 + d3, d2, 0.0D, 0.0D,
					0.0D);
			par1World.spawnParticle("flame", d - d4, d1 + d3, d2, 0.0D, 0.0D,
					0.0D);
		} else if (i == 2) {
			par1World.spawnParticle("smoke", d + d4, d1 + d3, d2, 0.0D, 0.0D,
					0.0D);
			...
			par1World.spawnParticle("smoke", d, d1 + d3, d2 - d4, 0.0D, 0.0D,
					0.0D);
			par1World.spawnParticle("flame", d, d1 + d3, d2 - d4, 0.0D, 0.0D,
					0.0D);
		} else if (i == 4) {
			par1World.spawnParticle("smoke", d, d1 + d3, d2 + d4, 0.0D, 0.0D,
					0.0D);
