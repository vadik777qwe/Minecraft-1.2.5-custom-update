...
public class Material {
	...
	/**
	 * Mobility information / flag of the material. 0 = normal, 1 = can't be
	 * push but enabled piston to move over it, 2 = can't be pushed and stop
	 * pistons
	 */
	...
	static {
		...
		leaves = (new Material(MapColor.foliageColor)).setBurning()
				.setTranslucent().setNoPushMobility();
		plants = (new MaterialLogic(MapColor.foliageColor)).setNoPushMobility();
		vine = (new MaterialLogic(MapColor.foliageColor)).setBurning()
				.setNoPushMobility().setGroundCover();
		...
		snow = (new MaterialLogic(MapColor.snowColor)).setGroundCover()
				.setTranslucent().setNoHarvest().setNoPushMobility();
		craftedSnow = (new Material(MapColor.snowColor)).setNoHarvest();
		cactus = (new Material(MapColor.foliageColor)).setTranslucent()
				.setNoPushMobility();
		...
		web = (new MaterialWeb(MapColor.clothColor)).setNoHarvest()
				.setNoPushMobility();
