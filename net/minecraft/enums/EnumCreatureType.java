...
public enum EnumCreatureType {
	monster(net.minecraft.src.IMob.class, 70, Material.air, false), creature(
			net.minecraft.entity.EntityAnimal.class, 15, Material.air, true), waterCreature(
			net.minecraft.entity.EntityWaterMob.class, 5, Material.water, true);
