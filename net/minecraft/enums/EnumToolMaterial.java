...
public enum EnumToolMaterial {
	WOOD(0, 59, 2.0F, 0, 15), STONE(1, 131, 4F, 1, 5), IRON(2, 250, 6F, 2, 14), EMERALD(
			3, 1561, 8F, 3, 10), GOLD(0, 32, 12F, 0, 22);
	...
	/**
	 * The number of uses this material allows. (wood = 59, stone = 131, iron =
	 * 250, diamond = 1561, gold = 32)
	 */
