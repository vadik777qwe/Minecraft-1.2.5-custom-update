...
public class InventoryLargeChest implements IInventory {
	...
	public ItemStack getStackInSlot(int par1) {
		if (par1 >= upperChest.getSizeInventory()) {
			return lowerChest.getStackInSlot(par1
					- upperChest.getSizeInventory());
		} else {
	...
	public ItemStack decrStackSize(int par1, int par2) {
		if (par1 >= upperChest.getSizeInventory()) {
			return lowerChest.decrStackSize(
					par1 - upperChest.getSizeInventory(), par2);
		} else {
	...
	public ItemStack getStackInSlotOnClosing(int par1) {
		if (par1 >= upperChest.getSizeInventory()) {
			return lowerChest.getStackInSlotOnClosing(par1
					- upperChest.getSizeInventory());
		} else {
