...
import net.minecraft.containers.ContainerBrewingStand;
...
public class SlotBrewingStandPotion extends Slot {
	...
	public SlotBrewingStandPotion(
			ContainerBrewingStand par1ContainerBrewingStand,
			EntityPlayer par2EntityPlayer, IInventory par3IInventory, int par4,
			int par5, int par6) {
	...
	public boolean isItemValid(ItemStack par1ItemStack) {
		return par1ItemStack != null
				&& (par1ItemStack.itemID == Item.potion.shiftedIndex || par1ItemStack.itemID == Item.glassBottle.shiftedIndex);
	}
	...
	public void onPickupFromSlot(ItemStack par1ItemStack) {
		if (par1ItemStack.itemID == Item.potion.shiftedIndex
