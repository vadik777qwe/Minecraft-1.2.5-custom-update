...
public class EnchantmentProtection extends Enchantment {
	private static final String protectionName[] = { "all", "fire", "fall",
	...
	public int getMinEnchantability(int par1) {
		return baseEnchantability[protectionType] + (par1 - 1)
	...
	public String getName() {
		return (new StringBuilder()).append("enchantment.protect.")
				.append(protectionName[protectionType]).toString();
	}
	...
	public boolean canApplyTogether(Enchantment par1Enchantment) {
		if (par1Enchantment instanceof EnchantmentProtection) {
			...
			return protectionType == 2
					|| enchantmentprotection.protectionType == 2;
		} else {
