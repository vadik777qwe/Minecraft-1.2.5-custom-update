...
public class EnchantmentDamage extends Enchantment {
	private static final String protectionName[] = { "all", "undead",
			"arthropods" };
	...
	public int getMinEnchantability(int par1) {
		return baseEnchantability[damageType] + (par1 - 1)
				* levelEnchantability[damageType];
	}
	...
	public String getName() {
		return (new StringBuilder()).append("enchantment.damage.")
				.append(protectionName[damageType]).toString();
	}
