...
public class Achievement extends StatBase {
	...
	public Achievement(int par1, String par2Str, int par3, int par4,
	...
	public Achievement(int par1, String par2Str, int par3, int par4,
			ItemStack par5ItemStack, Achievement par6Achievement) {
		super(0x500000 + par1, (new StringBuilder()).append("achievement.")
				.append(par2Str).toString());
		theItemStack = par5ItemStack;
		achievementDescription = (new StringBuilder()).append("achievement.")
				.append(par2Str).append(".desc").toString();
		displayColumn = par3;
		displayRow = par4;
	...
	public String getDescription() {
		if (statStringFormatter != null) {
			return statStringFormatter.formatString(StatCollector
	...
	public Achievement setStatStringFormatter(
			IStatStringFormat par1IStatStringFormat) {
