...
public class EntityBubbleFX extends EntityFX {
	public EntityBubbleFX(World par1World, double par2, double par4,
		...
		motionX = par8 * 0.20000000298023224D
				+ (double) ((float) (Math.random() * 2D - 1.0D) * 0.02F);
		motionY = par10 * 0.20000000298023224D
				+ (double) ((float) (Math.random() * 2D - 1.0D) * 0.02F);
		motionZ = par12 * 0.20000000298023224D
				+ (double) ((float) (Math.random() * 2D - 1.0D) * 0.02F);
