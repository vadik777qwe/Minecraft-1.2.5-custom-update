...
public class EntityOcelot extends EntityTameable {
	...
	public EntityOcelot(World par1World) {
		...
		tasks.addTask(3, aiTempt = new EntityAITempt(this, 0.18F,
				Item.fishRaw.shiftedIndex, true));
		tasks.addTask(4, new EntityAIAvoidEntity(this,
				net.minecraft.entity.EntityPlayer.class, 16F, 0.23F, 0.4F));
		...
		tasks.addTask(11, new EntityAIWatchClosest(this,
				net.minecraft.entity.EntityPlayer.class, 10F));
		targetTasks.addTask(1, new EntityAITargetNonTamed(this,
				net.minecraft.entity.EntityChicken.class, 14F, 750, false));
	}
	...
	public boolean interact(EntityPlayer par1EntityPlayer) {
		...
		if (!isTamed()) {
			if (aiTempt.func_48270_h() && itemstack != null
					&& itemstack.itemID == Item.fishRaw.shiftedIndex
					&& par1EntityPlayer.getDistanceSqToEntity(this) < 9D) {
				itemstack.stackSize--;
	...
	public boolean isWheat(ItemStack par1ItemStack) {
		return par1ItemStack != null
				&& par1ItemStack.itemID == Item.fishRaw.shiftedIndex;
	}
