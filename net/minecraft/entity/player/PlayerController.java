...
public abstract class PlayerController {
	...
	public boolean onPlayerDestroyBlock(int par1, int par2, int par3, int par4) {
		...
		world.playAuxSFX(2001, par1, par2, par3,
				block.blockID
						+ (world.getBlockMetadata(par1, par2, par3) << 12));
	...
	public boolean sendUseItem(EntityPlayer par1EntityPlayer, World par2World,
		...
		ItemStack itemstack = par3ItemStack.useItemRightClick(par2World,
				par1EntityPlayer);

		if (itemstack != par3ItemStack || itemstack != null
	 ...
	 */
	public abstract boolean onPlayerRightClick(EntityPlayer entityplayer,
			World world, ItemStack itemstack, int i, int j, int k, int l);

	public EntityPlayer createPlayer(World par1World) {
		return new EntityPlayerSP(mc, par1World, mc.session,
				par1World.worldProvider.worldType);
	}
	...
	public ItemStack windowClick(int par1, int par2, int par3, boolean par4,
		...
		return par5EntityPlayer.craftingInventory.slotClick(par2, par3, par4,
				par5EntityPlayer);
	}
