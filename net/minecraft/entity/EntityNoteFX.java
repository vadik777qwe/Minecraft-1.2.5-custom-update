...
public class EntityNoteFX extends EntityFX {
	...
	public EntityNoteFX(World par1World, double par2, double par4, double par6,
		...
		particleRed = MathHelper.sin(((float) par8 + 0.0F) * (float) Math.PI
				* 2.0F) * 0.65F + 0.35F;
		particleGreen = MathHelper.sin(((float) par8 + 0.3333333F)
				* (float) Math.PI * 2.0F) * 0.65F + 0.35F;
		particleBlue = MathHelper.sin(((float) par8 + 0.6666667F)
				* (float) Math.PI * 2.0F) * 0.65F + 0.35F;
		particleScale *= 0.75F;
		particleScale *= par14;
