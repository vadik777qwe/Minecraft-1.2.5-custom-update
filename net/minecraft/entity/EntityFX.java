...
public class EntityFX extends Entity {
	...
	public EntityFX(World par1World, double par2, double par4, double par6,
		...
		motionY = (motionY / (double) f1) * (double) f * 0.40000000596046448D
	...
	public EntityFX multiplyVelocity(float par1) {
		motionX *= par1;
		motionY = (motionY - 0.10000000149011612D) * (double) par1
				+ 0.10000000149011612D;
		motionZ *= par1;
		return this;
	}
	...
	public void renderParticle(Tessellator par1Tessellator, float par2,
		...
		float f8 = 1.0F;
		par1Tessellator.setColorOpaque_F(particleRed * f8, particleGreen * f8,
				particleBlue * f8);
