...
public class ModelMinecart extends ModelBase {
	...
	public ModelMinecart() {
		...
		int i = 4;
		sideModels[0]
				.addBox(-byte0 / 2, -byte2 / 2, -1F, byte0, byte2, 2, 0.0F);
		sideModels[0].setRotationPoint(0.0F, i, 0.0F);
		sideModels[5].addBox(-byte0 / 2 + 1, -byte2 / 2 + 1, -1F, byte0 - 2,
				byte2 - 2, 1, 0.0F);
		sideModels[5].setRotationPoint(0.0F, i, 0.0F);
		sideModels[1].addBox(-byte0 / 2 + 2, -byte1 - 1, -1F, byte0 - 4, byte1,
				2, 0.0F);
		sideModels[1].setRotationPoint(-byte0 / 2 + 1, i, 0.0F);
		sideModels[2].addBox(-byte0 / 2 + 2, -byte1 - 1, -1F, byte0 - 4, byte1,
				2, 0.0F);
		sideModels[2].setRotationPoint(byte0 / 2 - 1, i, 0.0F);
		sideModels[3].addBox(-byte0 / 2 + 2, -byte1 - 1, -1F, byte0 - 4, byte1,
				2, 0.0F);
		sideModels[3].setRotationPoint(0.0F, i, -byte2 / 2 + 1);
		sideModels[4].addBox(-byte0 / 2 + 2, -byte1 - 1, -1F, byte0 - 4, byte1,
				2, 0.0F);
