...
public class ModelOcelot extends ModelBase {
	...
	public void setRotationAngles(float par1, float par2, float par3,
		...
		if (field_48227_o != 3) {
			...
			if (field_48227_o == 2) {
				field_48225_a.rotateAngleX = MathHelper.cos(par1 * 0.6662F)
						* 1.0F * par2;
				field_48223_b.rotateAngleX = MathHelper
						.cos(par1 * 0.6662F + 0.3F) * 1.0F * par2;
				field_48224_c.rotateAngleX = MathHelper.cos(par1 * 0.6662F
						+ (float) Math.PI + 0.3F)
						* 1.0F * par2;
				field_48221_d.rotateAngleX = MathHelper.cos(par1 * 0.6662F
						+ (float) Math.PI)
						* 1.0F * par2;
				field_48219_f.rotateAngleX = 1.727876F
						+ ((float) Math.PI / 10F) * MathHelper.cos(par1) * par2;
			} else {
				field_48225_a.rotateAngleX = MathHelper.cos(par1 * 0.6662F)
						* 1.0F * par2;
				field_48223_b.rotateAngleX = MathHelper.cos(par1 * 0.6662F
						+ (float) Math.PI)
						* 1.0F * par2;
				field_48224_c.rotateAngleX = MathHelper.cos(par1 * 0.6662F
						+ (float) Math.PI)
				...
				if (field_48227_o == 1) {
					field_48219_f.rotateAngleX = 1.727876F
							+ ((float) Math.PI / 4F) * MathHelper.cos(par1)
							* par2;
				} else {
					field_48219_f.rotateAngleX = 1.727876F + 0.4712389F
							* MathHelper.cos(par1) * par2;
				}
			}
		}
	}
