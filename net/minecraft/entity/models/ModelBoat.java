...
public class ModelBoat extends ModelBase {
	...
	public ModelBoat() {
		...
		byte byte2 = 20;
		int i = 4;
		boatSides[0].addBox(-byte0 / 2, -byte2 / 2 + 2, -3F, byte0, byte2 - 4,
				4, 0.0F);
		boatSides[0].setRotationPoint(0.0F, i, 0.0F);
		boatSides[1].addBox(-byte0 / 2 + 2, -byte1 - 1, -1F, byte0 - 4, byte1,
				2, 0.0F);
		boatSides[1].setRotationPoint(-byte0 / 2 + 1, i, 0.0F);
		boatSides[2].addBox(-byte0 / 2 + 2, -byte1 - 1, -1F, byte0 - 4, byte1,
				2, 0.0F);
		boatSides[2].setRotationPoint(byte0 / 2 - 1, i, 0.0F);
		boatSides[3].addBox(-byte0 / 2 + 2, -byte1 - 1, -1F, byte0 - 4, byte1,
				2, 0.0F);
		boatSides[3].setRotationPoint(0.0F, i, -byte2 / 2 + 1);
		boatSides[4].addBox(-byte0 / 2 + 2, -byte1 - 1, -1F, byte0 - 4, byte1,
				2, 0.0F);
