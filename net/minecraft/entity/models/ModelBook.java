...
public class ModelBook extends ModelBase {
	...
	public ModelBook() {
		coverRight = (new ModelRenderer(this)).setTextureOffset(0, 0).addBox(
				-6F, -5F, 0.0F, 6, 10, 0);
		coverLeft = (new ModelRenderer(this)).setTextureOffset(16, 0).addBox(
				0.0F, -5F, 0.0F, 6, 10, 0);
		bookSpine = (new ModelRenderer(this)).setTextureOffset(12, 0).addBox(
				-1F, -5F, 0.0F, 2, 10, 0);
		pagesRight = (new ModelRenderer(this)).setTextureOffset(0, 10).addBox(
				0.0F, -4F, -0.99F, 5, 8, 1);
		pagesLeft = (new ModelRenderer(this)).setTextureOffset(12, 10).addBox(
				0.0F, -4F, -0.01F, 5, 8, 1);
		flippingPageRight = (new ModelRenderer(this)).setTextureOffset(24, 10)
				.addBox(0.0F, -4F, 0.0F, 5, 8, 0);
		flippingPageLeft = (new ModelRenderer(this)).setTextureOffset(24, 10)
				.addBox(0.0F, -4F, 0.0F, 5, 8, 0);
