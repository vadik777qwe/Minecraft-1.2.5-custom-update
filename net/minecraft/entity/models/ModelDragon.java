...
public class ModelDragon extends ModelBase {
	...
	public void render(Entity par1Entity, float par2, float par3, float par4,
		...
		float f = entitydragon.field_40173_aw
				+ (entitydragon.field_40172_ax - entitydragon.field_40173_aw)
				* field_40317_s;
		...
		float f6 = updateRotations(entitydragon.func_40160_a(5, field_40317_s)[0]
				- entitydragon.func_40160_a(10, field_40317_s)[0]);
		float f7 = updateRotations(entitydragon.func_40160_a(5, field_40317_s)[0]
				+ (double) (f6 / 2.0F));
		f2 += 2.0F;
		...
		for (int i = 0; i < 5; i++) {
			...
			neck.rotateAngleY = ((updateRotations(ad3[0] - ad[0]) * (float) Math.PI) / 180F)
					* f5;
			neck.rotateAngleX = f10
					+ (((float) (ad3[1] - ad[1]) * (float) Math.PI) / 180F)
					* f5 * 5F;
			neck.rotateAngleZ = ((-updateRotations(ad3[0] - (double) f7) * (float) Math.PI) / 180F)
					* f5;
			neck.rotationPointY = f2;
			neck.rotationPointZ = f3;
			neck.rotationPointX = f4;
			f2 = (float) ((double) f2 + Math.sin(neck.rotateAngleX) * 10D);
			f3 = (float) ((double) f3 - Math.cos(neck.rotateAngleY)
					* Math.cos(neck.rotateAngleX) * 10D);
			f4 = (float) ((double) f4 - Math.sin(neck.rotateAngleY)
					* Math.cos(neck.rotateAngleX) * 10D);
			neck.render(par7);
		}
		...
		for (int k = 0; k < 12; k++) {
			...
			neck.rotateAngleX = f9
					+ (((float) (ad2[1] - ad[1]) * (float) Math.PI) / 180F)
					* f5 * 5F;
			neck.rotateAngleZ = ((updateRotations(ad2[0] - (double) f7) * (float) Math.PI) / 180F)
					* f5;
			neck.rotationPointY = f2;
			neck.rotationPointZ = f3;
			neck.rotationPointX = f4;
