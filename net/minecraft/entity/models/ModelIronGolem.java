...
public class ModelIronGolem extends ModelBase {
	...
	public void setLivingAnimations(EntityLiving par1EntityLiving, float par2,
		...
		if (i > 0) {
			field_48233_c.rotateAngleX = -2F + 1.5F
					* func_48228_a((float) i - par4, 10F);
			field_48230_d.rotateAngleX = -2F + 1.5F
					* func_48228_a((float) i - par4, 10F);
		} else {
			int j = entityirongolem.func_48117_D_();

			if (j > 0) {
				field_48233_c.rotateAngleX = -0.8F + 0.025F
						* func_48228_a(j, 70F);
				field_48230_d.rotateAngleX = 0.0F;
			} else {
				field_48233_c.rotateAngleX = (-0.2F + 1.5F * func_48228_a(par2,
						13F)) * par3;
				field_48230_d.rotateAngleX = (-0.2F - 1.5F * func_48228_a(par2,
						13F)) * par3;
			}
		}
	}
