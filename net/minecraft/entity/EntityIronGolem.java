...
public class EntityIronGolem extends EntityGolem {
	...
	public EntityIronGolem(World par1World) {
		...
		targetTasks.addTask(3, new EntityAINearestAttackableTarget(this,
				net.minecraft.entity.EntityMob.class, 16F, 0, false, true));
	}
	...
	public void onLivingUpdate() {
		...
		if (motionX * motionX + motionZ * motionZ > 2.5000002779052011E-007D
				&& rand.nextInt(5) == 0) {
			...
			if (l > 0) {
				worldObj.spawnParticle(
						(new StringBuilder()).append("tilecrack_").append(l)
								.toString(), posX
						...
						boundingBox.minY + 0.10000000000000001D, posZ
								+ ((double) rand.nextFloat() - 0.5D)
								* (double) width,
						4D * ((double) rand.nextFloat() - 0.5D), 0.5D,
						((double) rand.nextFloat() - 0.5D) * 4D);
			}
		}
	}
	...
	public boolean func_48100_a(Class par1Class) {
		if (func_48112_E_()
				&& (net.minecraft.entity.EntityPlayer.class)
						.isAssignableFrom(par1Class)) {
			return false;
		} else {
