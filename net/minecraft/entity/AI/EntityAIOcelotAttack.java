...
public class EntityAIOcelotAttack extends EntityAIBase {
	...
	public void updateTask() {
		theEntity.getLookHelper().setLookPositionWithEntity(field_48362_c, 30F,
				30F);
		double d = theEntity.width * 2.0F * (theEntity.width * 2.0F);
		double d1 = theEntity.getDistanceSq(field_48362_c.posX,
				field_48362_c.boundingBox.minY, field_48362_c.posZ);
		float f = 0.23F;
