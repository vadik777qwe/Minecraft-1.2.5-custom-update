...
public class EntityAIFollowParent extends EntityAIBase {
	...
	public boolean shouldExecute() {
		...
		List list = childAnimal.worldObj.getEntitiesWithinAABB(
				childAnimal.getClass(),
				childAnimal.boundingBox.expand(8D, 4D, 8D));
	...
	public void updateTask() {
		if (--field_48246_d > 0) {
			...
			field_48246_d = 10;
			childAnimal.getNavigator()
					.func_48667_a(parentAnimal, field_48248_c);
			return;
		}
	}
}
