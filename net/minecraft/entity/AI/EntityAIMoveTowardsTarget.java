...
public class EntityAIMoveTowardsTarget extends EntityAIBase {
	...
	public boolean shouldExecute() {
		...
		Vec3D vec3d = RandomPositionGenerator.func_48620_a(theEntity, 16, 7,
				Vec3D.createVector(targetEntity.posX, targetEntity.posY,
						targetEntity.posZ));
	...
	public boolean continueExecuting() {
		return !theEntity.getNavigator().noPath()
				...
				&& targetEntity.getDistanceSqToEntity(theEntity) < (double) (field_48331_g * field_48331_g);
	}
	...
	public void startExecuting() {
		theEntity.getNavigator().func_48666_a(movePosX, movePosY, movePosZ,
				field_48330_f);
	}
}
