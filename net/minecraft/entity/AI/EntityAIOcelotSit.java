...
public class EntityAIOcelotSit extends EntityAIBase {
	...
	public boolean shouldExecute() {
		return field_50085_a.isTamed()
				&& !field_50085_a.isSitting()
				&& field_50085_a.getRNG().nextDouble() <= 0.0065000001341104507D
				&& func_50077_h();
	}
	...
	public boolean continueExecuting() {
		return field_50084_c <= field_50081_d
				&& field_52011_h <= 60
				&& func_50078_a(field_50085_a.worldObj, field_50082_e,
						field_50079_f, field_50080_g);
	}
	...
	public void startExecuting() {
		field_50085_a.getNavigator().func_48666_a(
				(double) (float) field_50082_e + 0.5D, field_50079_f + 1,
				(double) (float) field_50080_g + 0.5D, field_50083_b);
		field_50084_c = 0;
		field_52011_h = 0;
		field_50081_d = field_50085_a.getRNG().nextInt(
				field_50085_a.getRNG().nextInt(1200) + 1200) + 1200;
	...
	public void updateTask() {
		...
		if (field_50085_a.getDistanceSq(field_50082_e, field_50079_f + 1,
				field_50080_g) > 1.0D) {
			field_50085_a.func_48140_f(false);
			field_50085_a.getNavigator().func_48666_a(
					(double) (float) field_50082_e + 0.5D, field_50079_f + 1,
	...
	private boolean func_50077_h() {
		...
		for (int j = (int) field_50085_a.posX - 8; (double) j < field_50085_a.posX + 8D; j++) {
			for (int k = (int) field_50085_a.posZ - 8; (double) k < field_50085_a.posZ + 8D; k++) {
				if (!func_50078_a(field_50085_a.worldObj, j, i, k)
						|| !field_50085_a.worldObj.isAirBlock(j, i + 1, k)) {
					continue;
				}
