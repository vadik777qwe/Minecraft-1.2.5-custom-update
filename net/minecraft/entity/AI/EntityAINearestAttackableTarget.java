...
public class EntityAINearestAttackableTarget extends EntityAITarget {
	...
	public EntityAINearestAttackableTarget(EntityLiving par1EntityLiving,
			Class par2Class, float par3, int par4, boolean par5, boolean par6) {
		super(par1EntityLiving, par3, par5, par6);
		targetClass = par2Class;
		field_48379_d = par3;
		field_48386_f = par4;
		field_48387_g = new EntityAINearestAttackableTargetSorter(this,
				par1EntityLiving);
		setMutexBits(1);
	}
	...
	public boolean shouldExecute() {
		label0: {
			if (field_48386_f > 0
					&& taskOwner.getRNG().nextInt(field_48386_f) != 0) {
				return false;
			}
			...
			List list = taskOwner.worldObj.getEntitiesWithinAABB(targetClass,
					taskOwner.boundingBox.expand(field_48379_d, 4D,
							field_48379_d));
