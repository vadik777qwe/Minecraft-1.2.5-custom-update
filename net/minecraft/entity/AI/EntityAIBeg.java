...
public class EntityAIBeg extends EntityAIBase {
	...
	public boolean shouldExecute() {
		field_48348_b = field_48349_c.getClosestPlayerToEntity(theWolf,
				field_48346_d);
	...
	public void updateTask() {
		theWolf.getLookHelper().setLookPosition(field_48348_b.posX,
				field_48348_b.posY + (double) field_48348_b.getEyeHeight(),
				field_48348_b.posZ, 10F, theWolf.getVerticalFaceSpeed());
		field_48347_e--;
	}
