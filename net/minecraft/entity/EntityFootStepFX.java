...
public class EntityFootStepFX extends EntityFX {
	...
	public EntityFootStepFX(RenderEngine par1RenderEngine, World par2World,
	...
	public void renderParticle(Tessellator par1Tessellator, float par2,
		...
		float f6 = worldObj.getLightBrightness(MathHelper.floor_double(posX),
				MathHelper.floor_double(posY), MathHelper.floor_double(posZ));
		currentFootSteps.bindTexture(currentFootSteps
				.getTexture("/misc/footprint.png"));
