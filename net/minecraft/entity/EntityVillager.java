...
public class EntityVillager extends EntityAgeable {
	...
	public EntityVillager(World par1World, int par2) {
		...
		tasks.addTask(1, new EntityAIAvoidEntity(this,
				net.minecraft.entity.EntityZombie.class, 8F, 0.3F, 0.35F));
		...
		tasks.addTask(9, new EntityAIWatchClosest2(this,
				net.minecraft.entity.EntityPlayer.class, 3F, 1.0F));
		tasks.addTask(9, new EntityAIWatchClosest2(this,
				net.minecraft.entity.EntityVillager.class, 5F, 0.02F));
		tasks.addTask(9, new EntityAIWander(this, 0.3F));
		tasks.addTask(10, new EntityAIWatchClosest(this,
				net.minecraft.entity.EntityLiving.class, 8F));
	}
	...
	protected void updateAITick() {
		if (--randomTickDivider <= 0) {
			...
			if (villageObj == null) {
				...
				setHomeArea(chunkcoordinates.posX, chunkcoordinates.posY,
						chunkcoordinates.posZ, villageObj.getVillageRadius());
			}
		}
