...
public class EntityPickupFX extends EntityFX {
	...
	public EntityPickupFX(World par1World, Entity par2Entity,
			Entity par3Entity, float par4) {
	...
	public void renderParticle(Tessellator par1Tessellator, float par2,
		...
		double d3 = entityPickingUp.lastTickPosX
				+ (entityPickingUp.posX - entityPickingUp.lastTickPosX)
				* (double) par2;
		double d4 = entityPickingUp.lastTickPosY
				+ (entityPickingUp.posY - entityPickingUp.lastTickPosY)
				* (double) par2 + (double) yOffs;
		double d5 = entityPickingUp.lastTickPosZ
		...
		OpenGlHelper.setLightmapTextureCoords(OpenGlHelper.lightmapTexUnit,
				(float) i1 / 1.0F, (float) j1 / 1.0F);
		GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
		d6 -= interpPosX;
		d7 -= interpPosY;
		d8 -= interpPosZ;
		RenderManager.instance.renderEntityWithPosYaw(entityToPickUp,
				(float) d6, (float) d7, (float) d8, entityToPickUp.rotationYaw,
				par2);
	}
