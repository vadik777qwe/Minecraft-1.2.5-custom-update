...
public abstract class EntityAnimal extends EntityAgeable {
	...
	protected void attackEntity(Entity par1Entity, float par2) {
		if (par1Entity instanceof EntityPlayer) {
			...
			if (entityplayer.getCurrentEquippedItem() == null
					|| !isWheat(entityplayer.getCurrentEquippedItem())) {
				entityToAttack = null;
			}
	...
	private void procreate(EntityAnimal par1EntityAnimal) {
		...
		if (entityanimal != null) {
			...
			entityanimal.setLocationAndAngles(posX, posY, posZ, rotationYaw,
					rotationPitch);
	...
	/**
	 * Used when an entity is close enough to attack but cannot be seen (Creeper
	 * de-fuse)
	 */
        @Override
	...
	protected Entity findPlayerToAttack() {
		...
		if (inLove > 0) {
			List list = worldObj.getEntitiesWithinAABB(getClass(),
			...
			List list2 = worldObj.getEntitiesWithinAABB(getClass(),
					boundingBox.expand(f, f, f));
