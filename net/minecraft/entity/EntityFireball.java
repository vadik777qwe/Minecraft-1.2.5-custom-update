...
public class EntityFireball extends Entity {
	...
	public EntityFireball(World par1World, double par2, double par4,
		...
		double d = MathHelper.sqrt_double(par8 * par8 + par10 * par10 + par12
				* par12);
	...
	public EntityFireball(World par1World, EntityLiving par2EntityLiving,
		...
		double d = MathHelper.sqrt_double(par3 * par3 + par5 * par5 + par7
				* par7);
	...
	public void onUpdate() {
		...
		motionY *= f1;
		motionZ *= f1;
		worldObj.spawnParticle("smoke", posX, posY + 0.5D, posZ, 0.0D, 0.0D,
				0.0D);
		setPosition(posX, posY, posZ);
	}
