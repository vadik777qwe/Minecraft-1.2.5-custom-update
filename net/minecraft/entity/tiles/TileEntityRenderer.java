package net.minecraft.entity.tiles;

import net.minecraft.entity.EntityLiving;
import java.util.*;
import net.minecraft.render.FontRenderer;
import net.minecraft.src.OpenGlHelper;
import net.minecraft.render.RenderEnchantmentTable;
import net.minecraft.render.RenderEndPortal;
...
public class TileEntityRenderer {
	...
	private TileEntityRenderer() {
		...
		specialRendererMap.put(net.minecraft.entity.tiles.TileEntitySign.class,
				new TileEntitySignRenderer());
		specialRendererMap.put(net.minecraft.entity.tiles.TileEntityMobSpawner.class,
				new TileEntityMobSpawnerRenderer());
		specialRendererMap.put(net.minecraft.entity.tiles.TileEntityPiston.class,
				new TileEntityRendererPiston());
		specialRendererMap.put(net.minecraft.entity.tiles.TileEntityChest.class,
				new TileEntityChestRenderer());
		specialRendererMap.put(
				net.minecraft.entity.tiles.TileEntityEnchantmentTable.class,
				new RenderEnchantmentTable());
		specialRendererMap.put(net.minecraft.entity.tiles.TileEntityEndPortal.class,
				new RenderEndPortal());
		TileEntitySpecialRenderer tileentityspecialrenderer;

		for (Iterator iterator = specialRendererMap.values().iterator(); iterator
				.hasNext(); tileentityspecialrenderer
				.setTileEntityRenderer(this)) {
			tileentityspecialrenderer = (TileEntitySpecialRenderer) iterator
					.next();
		}
	}
	...
	public TileEntitySpecialRenderer getSpecialRendererForClass(Class par1Class) {
		...
		if (tileentityspecialrenderer == null
				&& par1Class != (net.minecraft.entity.tiles.TileEntity.class)) {
			tileentityspecialrenderer = getSpecialRendererForClass(par1Class
					.getSuperclass());
	...
	public void cacheActiveRenderInfo(World par1World,
			...
			EntityLiving par4EntityLiving, float par5) {
	...
	public void renderTileEntity(TileEntity par1TileEntity, float par2) {
		if (par1TileEntity.getDistanceFrom(playerX, playerY, playerZ) < 4096D) {
			...
			renderTileEntityAt(par1TileEntity, (double) par1TileEntity.xCoord
					- staticPlayerX, (double) par1TileEntity.yCoord
					- staticPlayerY, (double) par1TileEntity.zCoord
					- staticPlayerZ, par2);
		}
	}
	...
	public void renderTileEntityAt(TileEntity par1TileEntity, double par2,
		...
		if (tileentityspecialrenderer != null) {
			tileentityspecialrenderer.renderTileEntityAt(par1TileEntity, par2,
					par4, par6, par8);
		}
	}

	/**
	 * Called from cacheActiveRenderInfo() to cache render-related references
	 * for TileEntitySpecialRenderers in specialRendererMap. Currently only the
	 * world reference from cacheActiveRenderInfo() is passed to this method.
	 */
	public void cacheSpecialRenderInfo(World par1World) {
		...
		do {
			...
			TileEntitySpecialRenderer tileentityspecialrenderer = (TileEntitySpecialRenderer) iterator
					.next();
