...
public class TileEntity {
	...
	private static void addMapping(Class par0Class, String par1Str) {
		if (classToNameMap.containsKey(par1Str)) {
			throw new IllegalArgumentException((new StringBuilder())
					.append("Duplicate id: ").append(par1Str).toString());
		} else {
	...
	public static TileEntity createAndLoadEntity(
		...
		try {
			Class class1 = (Class) nameToClassMap.get(par0NBTTagCompound
					.getString("id"));
	...
	static {
		addMapping(net.minecraft.entity.tiles.TileEntityFurnace.class, "Furnace");
		addMapping(net.minecraft.entity.tiles.TileEntityChest.class, "Chest");
		addMapping(net.minecraft.entity.tiles.TileEntityRecordPlayer.class,
				"RecordPlayer");
		addMapping(net.minecraft.entity.tiles.TileEntityDispenser.class, "Trap");
		addMapping(net.minecraft.entity.tiles.TileEntitySign.class, "Sign");
		addMapping(net.minecraft.entity.tiles.TileEntityMobSpawner.class, "MobSpawner");
		addMapping(net.minecraft.entity.tiles.TileEntityNote.class, "Music");
		addMapping(net.minecraft.entity.tiles.TileEntityPiston.class, "Piston");
		addMapping(net.minecraft.entity.tiles.TileEntityBrewingStand.class, "Cauldron");
		addMapping(net.minecraft.entity.tiles.TileEntityEnchantmentTable.class,
				"EnchantTable");
		addMapping(net.minecraft.entity.tiles.TileEntityEndPortal.class, "Airportal");
	}
}
