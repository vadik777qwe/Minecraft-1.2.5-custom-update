...
import net.minecraft.entity.models.ModelChest;
import net.minecraft.entity.models.ModelLargeChest;
...
public class TileEntityChestRenderer extends TileEntitySpecialRenderer {
	...
	public void renderTileEntityChestAt(TileEntityChest par1TileEntityChest,
		...
		GL11.glTranslatef(-0.5F, -0.5F, -0.5F);
		float f = par1TileEntityChest.prevLidAngle
				+ (par1TileEntityChest.lidAngle - par1TileEntityChest.prevLidAngle)
				* par8;

		if (par1TileEntityChest.adjacentChestZNeg != null) {
			float f1 = par1TileEntityChest.adjacentChestZNeg.prevLidAngle
		...
		if (par1TileEntityChest.adjacentChestXNeg != null) {
			float f2 = par1TileEntityChest.adjacentChestXNeg.prevLidAngle
	...
	public void renderTileEntityAt(TileEntity par1TileEntity, double par2,
		...
		renderTileEntityChestAt((TileEntityChest) par1TileEntity, par2, par4,
				par6, par8);
	}
}
