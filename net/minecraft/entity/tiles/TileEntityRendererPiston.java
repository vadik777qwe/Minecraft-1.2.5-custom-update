...
public class TileEntityRendererPiston extends TileEntitySpecialRenderer {
	...
	public void renderPiston(TileEntityPiston par1TileEntityPiston,
		...
		if (block != null && par1TileEntityPiston.getProgress(par8) < 1.0F) {
			...
			if (block == Block.pistonExtension
				...
				blockRenderer.renderPistonBaseAllFaces(block,
						par1TileEntityPiston.xCoord,
						par1TileEntityPiston.yCoord,
						par1TileEntityPiston.zCoord);
			} else {
				blockRenderer.renderBlockAllFaces(block,
						par1TileEntityPiston.xCoord,
						par1TileEntityPiston.yCoord,
						par1TileEntityPiston.zCoord);
			}
	...
	/**
	 * Called from TileEntityRenderer.cacheSpecialRenderInfo() to cache
	 * render-related references (currently world only). Used by
	 * TileEntityRendererPiston to create and store a RenderBlocks instance in
	 * the blockRenderer field.
	 */
