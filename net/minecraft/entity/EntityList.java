...
public class EntityList {
	...
	private static void addMapping(Class par0Class, String par1Str, int par2,
		...
		entityEggs.put(Integer.valueOf(par2), new EntityEggInfo(par2, par3,
				par4));
	}
	...
	public static Entity createEntityByName(String par0Str, World par1World) {
		...
		try {
			...
			if (class1 != null) {
				entity = (Entity) class1.getConstructor(
	...
	public static Entity createEntityFromNBT(NBTTagCompound par0NBTTagCompound,
		...
		try {
			Class class1 = (Class) stringToClassMapping.get(par0NBTTagCompound
					.getString("id"));
		...
		if (entity != null) {
			...
			System.out.println((new StringBuilder())
					...
					.append(par0NBTTagCompound.getString("id")).toString());
		}
		...
		if (entity == null) {
			System.out
					.println((new StringBuilder())
							.append("Skipping Entity with id ").append(par0)
							.toString());
		}
	...
	public static int getEntityID(Entity par0Entity) {
		return ((Integer) classToIDMapping.get(par0Entity.getClass()))
				.intValue();
	}
	...
	static {
		...
		addMapping(net.minecraft.entity.EntitySmallFireball.class,
				"SmallFireball", 13);
		addMapping(net.minecraft.entity.EntityEnderPearl.class,
				"ThrownEnderpearl", 14);
		addMapping(net.minecraft.entity.EntityEnderEye.class, "EyeOfEnderSignal",
				15);
		addMapping(net.minecraft.entity.EntityPotion.class, "ThrownPotion", 16);
		addMapping(net.minecraft.entity.EntityExpBottle.class, "ThrownExpBottle",
				17);
		...
		addMapping(net.minecraft.entity.EntityZombie.class, "Zombie", 54, 44975,
				0x799c65);
		addMapping(net.minecraft.entity.EntitySlime.class, "Slime", 55, 0x51a03e,
				0x7ebf6e);
		addMapping(net.minecraft.entity.EntityGhast.class, "Ghast", 56, 0xf9f9f9,
				0xbcbcbc);
		...
		addMapping(net.minecraft.entity.EntitySilverfish.class, "Silverfish", 60,
				0x6e6e6e, 0x303030);
		addMapping(net.minecraft.entity.EntityBlaze.class, "Blaze", 61, 0xf6b201,
				0xfff87e);
		addMapping(net.minecraft.entity.EntityMagmaCube.class, "LavaSlime", 62,
				0x340000, 0xfcfc00);
		addMapping(net.minecraft.entity.EntityDragon.class, "EnderDragon", 63);
		addMapping(net.minecraft.entity.EntityPig.class, "Pig", 90, 0xf0a5a2,
				0xdb635f);
		addMapping(net.minecraft.entity.EntitySheep.class, "Sheep", 91, 0xe7e7e7,
				0xffb5b5);
		addMapping(net.minecraft.entity.EntityCow.class, "Cow", 92, 0x443626,
				0xa1a1a1);
		addMapping(net.minecraft.entity.EntityChicken.class, "Chicken", 93,
				0xa1a1a1, 0xff0000);
		addMapping(net.minecraft.entity.EntitySquid.class, "Squid", 94, 0x223b4d,
				0x708899);
		addMapping(net.minecraft.entity.EntityWolf.class, "Wolf", 95, 0xd7d3d3,
				0xceaf96);
		...
		addMapping(net.minecraft.entity.EntityOcelot.class, "Ozelot", 98,
				0xefde7d, 0x564434);
		addMapping(net.minecraft.entity.EntityIronGolem.class, "VillagerGolem", 99);
		addMapping(net.minecraft.entity.EntityVillager.class, "Villager", 120,
				0x563c33, 0xbd8b72);
		addMapping(net.minecraft.entity.EntityEnderCrystal.class, "EnderCrystal",
				200);
	}
}
