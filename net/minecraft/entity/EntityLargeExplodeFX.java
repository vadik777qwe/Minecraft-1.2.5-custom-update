...
public class EntityLargeExplodeFX extends EntityFX {
	...
	public EntityLargeExplodeFX(RenderEngine par1RenderEngine, World par2World,
			double par3, double par5, double par7, double par9, double par11,
			double par13) {
	...
	public void renderParticle(Tessellator par1Tessellator, float par2,
		...
		if (i > 15) {
			...
			field_35128_az.bindTexture(field_35128_az
					.getTexture("/misc/explosion.png"));
			...
			par1Tessellator.addVertexWithUV(f5 - par3 * f4 - par6 * f4, f6
					- par4 * f4, f7 - par5 * f4 - par7 * f4, f1, f3);
			par1Tessellator.addVertexWithUV((f5 - par3 * f4) + par6 * f4, f6
					+ par4 * f4, (f7 - par5 * f4) + par7 * f4, f1, f2);
			par1Tessellator.addVertexWithUV(f5 + par3 * f4 + par6 * f4, f6
					+ par4 * f4, f7 + par5 * f4 + par7 * f4, f, f2);
			par1Tessellator.addVertexWithUV((f5 + par3 * f4) - par6 * f4, f6
					- par4 * f4, (f7 + par5 * f4) - par7 * f4, f, f3);
