...
public class EntityDiggingFX extends EntityFX {
	...
	public EntityDiggingFX(World par1World, double par2, double par4,
			double par6, double par8, double par10, double par12,
			Block par14Block, int par15, int par16) {
		super(par1World, par2, par4, par6, par8, par10, par12);
		blockInstance = par14Block;
		setParticleTextureIndex(par14Block.getBlockTextureFromSideAndMetadata(
				0, par16));
	...
	public void renderParticle(Tessellator par1Tessellator, float par2,
		...
		float f8 = 1.0F;
		par1Tessellator.setColorOpaque_F(f8 * particleRed, f8 * particleGreen,
				f8 * particleBlue);
		par1Tessellator.addVertexWithUV(f5 - par3 * f4 - par6 * f4, f6 - par4
				* f4, f7 - par5 * f4 - par7 * f4, f, f3);
		par1Tessellator.addVertexWithUV((f5 - par3 * f4) + par6 * f4, f6 + par4
				* f4, (f7 - par5 * f4) + par7 * f4, f, f2);
		par1Tessellator.addVertexWithUV(f5 + par3 * f4 + par6 * f4, f6 + par4
				* f4, f7 + par5 * f4 + par7 * f4, f1, f2);
		par1Tessellator.addVertexWithUV((f5 + par3 * f4) - par6 * f4, f6 - par4
				* f4, (f7 + par5 * f4) - par7 * f4, f1, f3);
	}
}
