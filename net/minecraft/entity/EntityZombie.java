...
public class EntityZombie extends EntityMob {
	public EntityZombie(World par1World) {
		...
		tasks.addTask(2, new EntityAIAttackOnCollide(this,
				net.minecraft.entity.EntityPlayer.class, moveSpeed, false));
		tasks.addTask(3, new EntityAIAttackOnCollide(this,
				net.minecraft.entity.EntityVillager.class, moveSpeed, true));
		...
		targetTasks.addTask(2, new EntityAINearestAttackableTarget(this,
				net.minecraft.entity.EntityPlayer.class, 16F, 0, true));
		targetTasks.addTask(2, new EntityAINearestAttackableTarget(this,
				net.minecraft.entity.EntityVillager.class, 16F, 0, false));
	}
