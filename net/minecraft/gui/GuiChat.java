...
public class GuiChat extends GuiScreen {
	...
	public void initGui() {
		...
		field_50064_a = new GuiTextField(fontRenderer, 4, height - 12,
				width - 4, 12);
			...
			if (chatclickdata != null) {
				...
				if (uri != null) {
					...
					mc.displayGuiScreen(new GuiChatConfirmLink(this, this,
							chatclickdata.func_50088_a(), 0, chatclickdata));
					return;
				}
			}
		}
		...
		if (par2 == 0) {
			if (par1) {
				try {
					...
					Object obj = class1.getMethod("getDesktop", new Class[0])
							.invoke(null, new Object[0]);
					class1.getMethod("browse",
							new Class[] { java.net.URI.class }).invoke(obj,
							new Object[] { field_50065_j });
	...
	public void completePlayerName() {
		if (field_50060_d) {
			...
			Iterator iterator = ((EntityClientPlayerMP) mc.thePlayer).sendQueue.playerNames
					.iterator();
		...
		if (field_50068_i.size() > 1) {
			...
			for (Iterator iterator1 = field_50068_i.iterator(); iterator1
					.hasNext(); stringbuilder.append(guiplayerinfo1.name)) {
		...
		field_50064_a.func_50031_b(((GuiPlayerInfo) field_50068_i
				.get(field_50067_h++)).name);
	}
