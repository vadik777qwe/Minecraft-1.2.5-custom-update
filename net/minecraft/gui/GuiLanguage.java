...
public class GuiLanguage extends GuiScreen {
	...
	public void initGui() {
		...
		controlList.add(doneButton = new GuiSmallButton(6, width / 2 - 75,
				height - 38, stringtranslate.translateKey("gui.done")));
	...
	public void drawScreen(int par1, int par2, float par3) {
		...
		drawCenteredString(fontRenderer,
				stringtranslate.translateKey("options.language"), width / 2,
				16, 0xffffff);
		drawCenteredString(
				fontRenderer,
				(new StringBuilder())
						...
						.append(stringtranslate
								.translateKey("options.languageWarning"))
						.append(")").toString(), width / 2, height - 56,
				0x808080);
