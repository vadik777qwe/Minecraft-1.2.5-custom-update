...
import net.minecraft.entity.models.ModelBook;
import net.minecraft.containers.ContainerEnchantment;
import net.minecraft.enchants.EnchantmentNameParts;
...
public class GuiEnchantment extends GuiContainer {
	...
	public GuiEnchantment(InventoryPlayer par1InventoryPlayer, World par2World,
			int par3, int par4, int par5) {
		super(new ContainerEnchantment(par1InventoryPlayer, par2World, par3,
				par4, par5));
	...
	protected void drawGuiContainerForegroundLayer() {
		fontRenderer.drawString(
				StatCollector.translateToLocal("container.enchant"), 12, 6,
				0x404040);
		fontRenderer.drawString(
	...
	protected void mouseClicked(int par1, int par2, int par3) {
		...
		for (int k = 0; k < 3; k++) {
			...
			if (l >= 0 && i1 >= 0 && l < 108 && i1 < 19
					&& containerEnchantment.enchantItem(mc.thePlayer, k)) {
				mc.playerController.func_40593_a(containerEnchantment.windowId,
						k);
			}
		}
	}
	...
	protected void drawGuiContainerBackgroundLayer(float par1, int par2,
		...
		GL11.glViewport(((scaledresolution.getScaledWidth() - 320) / 2)
				* scaledresolution.scaleFactor,
				((scaledresolution.getScaledHeight() - 240) / 2)
						* scaledresolution.scaleFactor,
				320 * scaledresolution.scaleFactor,
				240 * scaledresolution.scaleFactor);
		...
		mc.renderEngine.bindTexture(mc.renderEngine
				.getTexture("/item/book.png"));
		GL11.glRotatef(20F, 1.0F, 0.0F, 0.0F);
		float f2 = field_40221_n + (field_40224_m - field_40221_n) * par1;
		GL11.glTranslatef((1.0F - f2) * 0.2F, (1.0F - f2) * 0.1F,
				(1.0F - f2) * 0.25F);
		GL11.glRotatef(-(1.0F - f2) * 90F - 90F, 0.0F, 1.0F, 0.0F);
		GL11.glRotatef(180F, 1.0F, 0.0F, 0.0F);
		float f3 = field_40225_j + (field_40229_i - field_40225_j) * par1
				+ 0.25F;
		float f4 = field_40225_j + (field_40229_i - field_40225_j) * par1
				+ 0.75F;
		...
		EnchantmentNameParts.instance
				.setRandSeed(containerEnchantment.nameSeed);
		...
		for (int l = 0; l < 3; l++) {
			...
			if (mc.thePlayer.experienceLevel < i1
					&& !mc.thePlayer.capabilities.isCreativeMode) {
				drawTexturedModalRect(j + 60, k + 14 + 19 * l, 0, 185, 108, 19);
				fontrenderer.drawSplitString(s, j + 62, k + 16 + 19 * l, 104,
						(j1 & 0xfefefe) >> 1);
				fontrenderer = mc.fontRenderer;
				j1 = 0x407f10;
				fontrenderer.drawStringWithShadow(s1, (j + 62 + 104)
						- fontrenderer.getStringWidth(s1), k + 16 + 19 * l + 7,
						j1);
				continue;
			}
			...
			fontrenderer = mc.fontRenderer;
			j1 = 0x80ff20;
			fontrenderer.drawStringWithShadow(s1,
					(j + 62 + 104) - fontrenderer.getStringWidth(s1), k + 16
							+ 19 * l + 7, j1);
		}
	}
	...
	public void func_40219_x_() {
		...
		if (!ItemStack.areItemStacksEqual(itemstack, field_40222_o)) {
			...
			do {
				field_40226_k += field_40230_x.nextInt(4)
						- field_40230_x.nextInt(4);
			} while (field_40229_i <= field_40226_k + 1.0F
					&& field_40229_i >= field_40226_k - 1.0F);
		}
