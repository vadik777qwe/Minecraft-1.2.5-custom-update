...
import java.util.*;
import net.minecraft.stats.SorterStatsItem;
...
public class GuiSlotStatsItem extends GuiSlotStats {
	...
	protected void func_27260_a(int par1, int par2, Tessellator par3Tessellator) {
		...
		if (field_27268_b == 0) {
			GuiStats.drawSprite(field_27275_a, ((par1 + 115) - 18) + 1,
					par2 + 1 + 1, 72, 18);
		} else {
			GuiStats.drawSprite(field_27275_a, (par1 + 115) - 18, par2 + 1, 72,
					18);
		}

		if (field_27268_b == 1) {
			GuiStats.drawSprite(field_27275_a, ((par1 + 165) - 18) + 1,
					par2 + 1 + 1, 18, 18);
		} else {
			GuiStats.drawSprite(field_27275_a, (par1 + 165) - 18, par2 + 1, 18,
					18);
		}

		if (field_27268_b == 2) {
			GuiStats.drawSprite(field_27275_a, ((par1 + 215) - 18) + 1,
					par2 + 1 + 1, 36, 18);
		} else {
			GuiStats.drawSprite(field_27275_a, (par1 + 215) - 18, par2 + 1, 36,
					18);
		}
	}
	...
	protected void drawSlot(int par1, int par2, int par3, int par4,
		...
		func_27265_a((StatCrafting) StatList.objectBreakStats[i], par2 + 115,
				par3, par1 % 2 == 0);
		func_27265_a((StatCrafting) StatList.objectCraftStats[i], par2 + 165,
				par3, par1 % 2 == 0);
