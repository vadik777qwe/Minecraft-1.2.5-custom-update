...
class GuiSlotLanguage extends GuiSlot {
	...
	public GuiSlotLanguage(GuiLanguage par1GuiLanguage) {
		super(par1GuiLanguage.mc, par1GuiLanguage.width,
		...
		for (Iterator iterator = field_44014_c.keySet().iterator(); iterator
				.hasNext(); field_44013_b.add(s)) {
	...
	protected void elementClicked(int par1, boolean par2) {
		StringTranslate.getInstance().setLanguage(
				(String) field_44013_b.get(par1));
		field_44015_a.mc.fontRenderer.setUnicodeFlag(StringTranslate
				.getInstance().isUnicode());
		GuiLanguage.func_44005_a(field_44015_a).language = (String) field_44013_b
				.get(par1);
		field_44015_a.fontRenderer
				.setBidiFlag(StringTranslate.isBidrectional(GuiLanguage
						.func_44005_a(field_44015_a).language));
		GuiLanguage.func_46028_b(field_44015_a).displayString = StringTranslate
	...
	protected boolean isSelected(int par1) {
		return ((String) field_44013_b.get(par1)).equals(StringTranslate
	...
	protected void drawSlot(int par1, int par2, int par3, int par4,
		...
		field_44015_a.drawCenteredString(field_44015_a.fontRenderer,
				(String) field_44014_c.get(field_44013_b.get(par1)),
				field_44015_a.width / 2, par3 + 1, 0xffffff);
		field_44015_a.fontRenderer
				.setBidiFlag(StringTranslate.isBidrectional(GuiLanguage
						.func_44005_a(field_44015_a).language));
	}
