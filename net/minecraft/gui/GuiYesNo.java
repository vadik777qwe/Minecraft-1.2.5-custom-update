...
public class GuiYesNo extends GuiScreen {
	...
	public GuiYesNo(GuiScreen par1GuiScreen, String par2Str, String par3Str,
			int par4) {
	...
	public GuiYesNo(GuiScreen par1GuiScreen, String par2Str, String par3Str,
			String par4Str, String par5Str, int par6) {
		parentScreen = par1GuiScreen;
		message1 = par2Str;
		message2 = par3Str;
		buttonText1 = par4Str;
	 ...
	 */
	public void initGui() {
		controlList.add(new GuiSmallButton(0, width / 2 - 155, height / 6 + 96,
				buttonText1));
