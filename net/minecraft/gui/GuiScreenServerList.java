...
public class GuiScreenServerList extends GuiScreen {
	...
	public GuiScreenServerList(GuiScreen par1GuiScreen,
	...
	public void initGui() {
		...
		controlList.add(new GuiButton(0, width / 2 - 100, height / 4 + 96 + 12,
				stringtranslate.translateKey("selectServer.select")));
		...
		((GuiButton) controlList.get(0)).enabled = serverTextField.getText()
				.length() > 0
	...
	public void drawScreen(int par1, int par2, float par3) {
		...
		drawCenteredString(fontRenderer,
				stringtranslate.translateKey("selectServer.direct"), width / 2,
				(height / 4 - 60) + 20, 0xffffff);
		drawString(fontRenderer,
				stringtranslate.translateKey("addServer.enterIp"),
				width / 2 - 100, 100, 0xa0a0a0);
