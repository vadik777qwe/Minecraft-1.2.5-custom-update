...
public class GuiBrewingStand extends GuiContainer {
	...
	public GuiBrewingStand(InventoryPlayer par1InventoryPlayer,
		...
		super(new ContainerBrewingStand(par1InventoryPlayer,
	...
	protected void drawGuiContainerForegroundLayer() {
		fontRenderer.drawString(
				StatCollector.translateToLocal("container.brewing"), 56, 6,
				0x404040);
		fontRenderer.drawString(
	...
	protected void drawGuiContainerBackgroundLayer(float par1, int par2,
		...
		if (l > 0) {
			...
			if (i1 > 0) {
				drawTexturedModalRect(j + 65, (k + 14 + 29) - i1, 185, 29 - i1,
						12, i1);
			}
		}
	}
