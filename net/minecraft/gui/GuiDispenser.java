...
import net.minecraft.containers.ContainerDispenser;
...
public class GuiDispenser extends GuiContainer {
	public GuiDispenser(InventoryPlayer par1InventoryPlayer,
	...
	protected void drawGuiContainerForegroundLayer() {
		fontRenderer.drawString(
				StatCollector.translateToLocal("container.dispenser"), 60, 6,
				0x404040);
		fontRenderer.drawString(
