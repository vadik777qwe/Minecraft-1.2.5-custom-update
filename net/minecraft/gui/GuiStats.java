...
public class GuiStats extends GuiScreen {
	...
	public void addHeaderButtons() {
		...
		controlList.add(new GuiButton(0, width / 2 + 4, height - 28, 150, 20,
				stringtranslate.translateKey("gui.done")));
		controlList.add(new GuiButton(1, width / 2 - 154, height - 52, 100, 20,
				stringtranslate.translateKey("stat.generalButton")));
		GuiButton guibutton;
		controlList.add(guibutton = new GuiButton(2, width / 2 - 46,
				height - 52, 100, 20, stringtranslate
						.translateKey("stat.blocksButton")));
		GuiButton guibutton1;
		controlList.add(guibutton1 = new GuiButton(3, width / 2 + 62,
				height - 52, 100, 20, stringtranslate
						.translateKey("stat.itemsButton")));
	...
	private void drawItemSprite(int par1, int par2, int par3) {
		...
		renderItem.drawItemIntoGui(fontRenderer, mc.renderEngine, par3, 0,
				Item.itemsList[par3].getIconFromDamage(0), par1 + 2, par2 + 2);
	...
	private void drawSprite(int par1, int par2, int par3, int par4) {
		...
		tessellator.addVertexWithUV(par1 + 0, par2 + 18, zLevel,
				(float) (par3 + 0) * 0.0078125F,
				(float) (par4 + 18) * 0.0078125F);
		tessellator.addVertexWithUV(par1 + 18, par2 + 18, zLevel,
				(float) (par3 + 18) * 0.0078125F,
				(float) (par4 + 18) * 0.0078125F);
		tessellator.addVertexWithUV(par1 + 18, par2 + 0, zLevel,
				(float) (par3 + 18) * 0.0078125F,
	 ...
	 * Draws a sprite from /gui/slot.png.
	 */
	static void drawSprite(GuiStats par0GuiStats, int par1, int par2, int par3,
			int par4) {
	...
	static void drawGradientRect(GuiStats par0GuiStats, int par1, int par2,
	 ...
	 */
	static void drawGradientRect1(GuiStats par0GuiStats, int par1, int par2,
			int par3, int par4, int par5, int par6) {
		par0GuiStats.drawGradientRect(par1, par2, par3, par4, par5, par6);
	}
	 ...
	 * Draws the item sprite on top of the background sprite.
	 */
	static void drawItemSprite(GuiStats par0GuiStats, int par1, int par2,
			int par3) {
