...
public class GuiConnecting extends GuiScreen {
	...
	public GuiConnecting(Minecraft par1Minecraft, String par2Str, int par3) {
		cancelled = false;
		System.out.println((new StringBuilder()).append("Connecting to ")
				.append(par2Str).append(", ").append(par3).toString());
	...
	public void initGui() {
		...
		controlList.clear();
		controlList.add(new GuiButton(0, width / 2 - 100,
	...
	public void drawScreen(int par1, int par2, float par3) {
		...
		if (clientHandler == null) {
			...
			drawCenteredString(fontRenderer,
					...
					width / 2, height / 2 - 50, 0xffffff);
			drawCenteredString(fontRenderer, clientHandler.field_1209_a,
	 ...
	 */
	public static NetClientHandler setNetClientHandler(
			GuiConnecting par0GuiConnecting,
			NetClientHandler par1NetClientHandler) {
		return par0GuiConnecting.clientHandler = par1NetClientHandler;
	}

	/**
	 * Returns true if the connection attempt has been cancelled, false
	 * otherwise.
	 */
