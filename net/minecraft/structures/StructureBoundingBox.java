...
public class StructureBoundingBox {
	...
	public static StructureBoundingBox getNewBoundingBox() {
		return new StructureBoundingBox(0x7fffffff, 0x7fffffff, 0x7fffffff,
	...
	public static StructureBoundingBox getComponentToAddBoundingBox(int par0,
		...
		switch (par9) {
		default:
			return new StructureBoundingBox(par0 + par3, par1 + par4, par2
					+ par5, ((par0 + par6) - 1) + par3, ((par1 + par7) - 1)
					+ par4, ((par2 + par8) - 1) + par5);

		case 2:
			return new StructureBoundingBox(par0 + par3, par1 + par4,
					(par2 - par8) + 1 + par5, ((par0 + par6) - 1) + par3,
		...
		case 1:
			return new StructureBoundingBox((par0 - par8) + 1 + par5, par1
					+ par4, par2 + par3, par0 + par5, ((par1 + par7) - 1)
					+ par4, ((par2 + par6) - 1) + par3);

		case 3:
			return new StructureBoundingBox(par0 + par5, par1 + par4, par2
					+ par3, ((par0 + par8) - 1) + par5, ((par1 + par7) - 1)
					+ par4, ((par2 + par6) - 1) + par3);
		}
	}
	...
	public boolean intersectsWith(StructureBoundingBox par1StructureBoundingBox) {
		return maxX >= par1StructureBoundingBox.minX
				&& minX <= par1StructureBoundingBox.maxX
				&& maxZ >= par1StructureBoundingBox.minZ
				&& minZ <= par1StructureBoundingBox.maxZ
				&& maxY >= par1StructureBoundingBox.minY
				&& minY <= par1StructureBoundingBox.maxY;
	}
	...
	public boolean isVecInside(int par1, int par2, int par3) {
		return par1 >= minX && par1 <= maxX && par3 >= minZ && par3 <= maxZ
				&& par2 >= minY && par2 <= maxY;
	}
	...
	public String toString() {
		return (new StringBuilder()).append("(").append(minX).append(", ")
