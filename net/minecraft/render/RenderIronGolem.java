...
import net.minecraft.entity.models.ModelIronGolem;
...
public class RenderIronGolem extends RenderLiving {
	...
	public void func_48421_a(EntityIronGolem par1EntityIronGolem, double par2,
			double par4, double par6, float par8, float par9) {
		super.doRenderLiving(par1EntityIronGolem, par2, par4, par6, par8, par9);
	}

	protected void func_48420_a(EntityIronGolem par1EntityIronGolem,
		...
		if ((double) par1EntityIronGolem.field_704_R < 0.01D) {
			...
			float f = 13F;
			float f1 = (par1EntityIronGolem.field_703_S - par1EntityIronGolem.field_704_R
					* (1.0F - par4)) + 6F;
	...
	protected void func_48419_a(EntityIronGolem par1EntityIronGolem, float par2) {
		...
		if (par1EntityIronGolem.func_48117_D_() == 0) {
			...
			GL11.glPushMatrix();
			GL11.glRotatef(5F
					+ (180F * field_48422_c.field_48233_c.rotateAngleX)
					/ (float) Math.PI, 1.0F, 0.0F, 0.0F);
	...
	public void doRenderLiving(EntityLiving par1EntityLiving, double par2,
			double par4, double par6, float par8, float par9) {
		func_48421_a((EntityIronGolem) par1EntityLiving, par2, par4, par6,
				par8, par9);
	}
