...
import net.minecraft.entity.models.ModelMinecart;
...
public class RenderMinecart extends Render {
	...
	public void func_152_a(EntityMinecart par1EntityMinecart, double par2,
		...
		double d = par1EntityMinecart.lastTickPosX
				+ (par1EntityMinecart.posX - par1EntityMinecart.lastTickPosX)
				* (double) par9;
		double d1 = par1EntityMinecart.lastTickPosY
				+ (par1EntityMinecart.posY - par1EntityMinecart.lastTickPosY)
				* (double) par9;
		double d2 = par1EntityMinecart.lastTickPosZ
				+ (par1EntityMinecart.posZ - par1EntityMinecart.lastTickPosZ)
				* (double) par9;
		double d3 = 0.30000001192092896D;
		Vec3D vec3d = par1EntityMinecart.func_514_g(d, d1, d2);
		float f3 = par1EntityMinecart.prevRotationPitch
				+ (par1EntityMinecart.rotationPitch - par1EntityMinecart.prevRotationPitch)
				* par9;
		...
		if (f4 > 0.0F) {
			GL11.glRotatef(((MathHelper.sin(f4) * f4 * f5) / 10F)
					* (float) par1EntityMinecart.func_41030_m(), 1.0F, 0.0F,
					0.0F);
		}
		...
		if (par1EntityMinecart.minecartType != 0) {
			...
			if (par1EntityMinecart.minecartType == 1) {
				...
				(new RenderBlocks()).renderBlockAsItem(Block.chest, 0,
						par1EntityMinecart.getBrightness(par9));
				GL11.glRotatef(-90F, 0.0F, 1.0F, 0.0F);
				GL11.glTranslatef(0.5F, 0.0F, -0.5F);
				...
				GL11.glRotatef(90F, 0.0F, 1.0F, 0.0F);
				(new RenderBlocks()).renderBlockAsItem(Block.stoneOvenIdle, 0,
						par1EntityMinecart.getBrightness(par9));
				GL11.glRotatef(-90F, 0.0F, 1.0F, 0.0F);
				GL11.glTranslatef(0.0F, -0.3125F, 0.0F);
				GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
		...
		modelMinecart.render(par1EntityMinecart, 0.0F, 0.0F, -0.1F, 0.0F, 0.0F,
				0.0625F);
		GL11.glPopMatrix();
	}
