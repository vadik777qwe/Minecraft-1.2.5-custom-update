...
public class RenderSquid extends RenderLiving {
	...
	public void func_21008_a(EntitySquid par1EntitySquid, double par2,
			double par4, double par6, float par8, float par9) {
		super.doRenderLiving(par1EntitySquid, par2, par4, par6, par8, par9);
	}

	protected void func_21007_a(EntitySquid par1EntitySquid, float par2,
			float par3, float par4) {
		float f = par1EntitySquid.field_21088_b
				+ (par1EntitySquid.field_21089_a - par1EntitySquid.field_21088_b)
				* par4;
		float f1 = par1EntitySquid.field_21086_f
				+ (par1EntitySquid.field_21087_c - par1EntitySquid.field_21086_f)
				* par4;
	...
	protected float handleRotationFloat(EntitySquid par1EntitySquid, float par2) {
		float f = par1EntitySquid.lastTentacleAngle
				+ (par1EntitySquid.tentacleAngle - par1EntitySquid.lastTentacleAngle)
				* par2;
		return f;
	}
	...
	public void doRenderLiving(EntityLiving par1EntityLiving, double par2,
			double par4, double par6, float par8, float par9) {
		func_21008_a((EntitySquid) par1EntityLiving, par2, par4, par6, par8,
				par9);
	}
