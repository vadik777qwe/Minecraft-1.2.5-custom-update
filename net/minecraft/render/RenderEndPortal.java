...
import net.minecraft.entity.tiles.TileEntitySpecialRenderer;
import net.minecraft.entity.tiles.TileEntity;
import net.minecraft.entity.tiles.TileEntityEndPortal;
...
public class RenderEndPortal extends TileEntitySpecialRenderer {
	...
	public void func_40446_a(TileEntityEndPortal par1TileEntityEndPortal,
		...
		for (int i = 0; i < 16; i++) {
			...
			GL11.glTranslatef(0.0F,
					(float) (System.currentTimeMillis() % 0xaae60L) / 700000F,
					0.0F);
			...
			GL11.glTranslatef((ActiveRenderInfo.objectX * f4) / f8,
					(ActiveRenderInfo.objectZ * f4) / f8, -f1);
	...
	private FloatBuffer func_40447_a(float par1, float par2, float par3,
			float par4) {
		field_40448_a.clear();
	...
	public void renderTileEntityAt(TileEntity par1TileEntity, double par2,
		...
		func_40446_a((TileEntityEndPortal) par1TileEntity, par2, par4, par6,
				par8);
	}
}
