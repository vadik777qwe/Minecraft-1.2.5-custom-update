...
public class RenderPlayer extends RenderLiving {
	 ...
	 */
	protected int setArmorModel(EntityPlayer par1EntityPlayer, int par2,
			float par3) {
		ItemStack itemstack = par1EntityPlayer.inventory
		...
		if (itemstack != null) {
			...
			if (item instanceof ItemArmor) {
				...
				loadTexture((new StringBuilder()).append("/armor/")
						...
						.append("_").append(par2 != 2 ? 1 : 2).append(".png")
						.toString());
				ModelBiped modelbiped = par2 != 2 ? modelArmorChestplate
						: modelArmor;
	...
	public void renderPlayer(EntityPlayer par1EntityPlayer, double par2,
		...
		modelArmorChestplate.heldItemRight = modelArmor.heldItemRight = modelBipedMain.heldItemRight = itemstack == null ? 0
				: 1;
	 ...
	 */
	protected void renderName(EntityPlayer par1EntityPlayer, double par2,
			...
			if (f2 < f3) {
				...
				if (!par1EntityPlayer.isSneaking()) {
					if (par1EntityPlayer.isPlayerSleeping()) {
						...
						renderLivingLabel(par1EntityPlayer, s, par2, par4,
								par6, 64);
					}
				} else {
	 ...
	 */
	protected void renderPlayerSleep(EntityPlayer par1EntityPlayer,
		...
		if (par1EntityPlayer.isEntityAlive()
			...
			super.renderLivingAt(par1EntityPlayer, par2
					+ (double) par1EntityPlayer.field_22063_x, par4
					+ (double) par1EntityPlayer.field_22062_y, par6
					+ (double) par1EntityPlayer.field_22061_z);
		} else {
	 ...
	 * rotateCorpse.
	 */
	protected void rotatePlayer(EntityPlayer par1EntityPlayer, float par2,
