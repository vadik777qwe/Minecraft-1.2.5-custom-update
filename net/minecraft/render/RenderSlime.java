...
public class RenderSlime extends RenderLiving {
	...
	public RenderSlime(ModelBase par1ModelBase, ModelBase par2ModelBase,
			float par3) {
	...
	protected void scaleSlime(EntitySlime par1EntitySlime, float par2) {
		...
		float f = (par1EntitySlime.field_767_b + (par1EntitySlime.field_768_a - par1EntitySlime.field_767_b)
				* par2)
				/ ((float) i * 0.5F + 1.0F);
