...
import net.minecraft.entity.models.ModelMagmaCube;
...
public class RenderMagmaCube extends RenderLiving {
	...
	public void renderMagmaCube(EntityMagmaCube par1EntityMagmaCube,
	...
	protected void scaleMagmaCube(EntityMagmaCube par1EntityMagmaCube,
			float par2) {
		int i = par1EntityMagmaCube.getSlimeSize();
		float f = (par1EntityMagmaCube.field_767_b + (par1EntityMagmaCube.field_768_a - par1EntityMagmaCube.field_767_b)
				* par2)
				/ ((float) i * 0.5F + 1.0F);
