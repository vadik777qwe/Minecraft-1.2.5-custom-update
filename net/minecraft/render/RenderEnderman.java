...
import net.minecraft.entity.models.ModelEnderman;
...
public class RenderEnderman extends RenderLiving {
	 ...
	 */
	public void renderEnderman(EntityEnderman par1EntityEnderman, double par2,
	 ...
	 */
	protected int renderEyes(EntityEnderman par1EntityEnderman, int par2,
			float par3) {
		if (par2 != 0) {
			return -1;
		} else {
