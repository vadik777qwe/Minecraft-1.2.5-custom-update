...
import net.minecraft.entity.models.ModelSilverfish;
...
public class RenderSilverfish extends RenderLiving {
	...
	protected float getSilverfishDeathRotation(
			EntitySilverfish par1EntitySilverfish) {
		return 180F;
	}
	 ...
	 */
	public void renderSilverfish(EntitySilverfish par1EntitySilverfish,
	...
	protected int shouldSilverfishRenderPass(
			EntitySilverfish par1EntitySilverfish, int par2, float par3) {
		return -1;
	}
