...
public class RenderChicken extends RenderLiving {
	...
	public void renderChicken(EntityChicken par1EntityChicken, double par2,
	...
	protected float getWingRotation(EntityChicken par1EntityChicken, float par2) {
		float f = par1EntityChicken.field_756_e
				+ (par1EntityChicken.field_752_b - par1EntityChicken.field_756_e)
				* par2;
		float f1 = par1EntityChicken.field_757_d
				+ (par1EntityChicken.destPos - par1EntityChicken.field_757_d)
				* par2;
	...
	public void doRenderLiving(EntityLiving par1EntityLiving, double par2,
			double par4, double par6, float par8, float par9) {
		renderChicken((EntityChicken) par1EntityLiving, par2, par4, par6, par8,
				par9);
	}
