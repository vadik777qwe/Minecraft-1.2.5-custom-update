...
import net.minecraft.entity.models.ModelCreeper;
...
public class RenderCreeper extends RenderLiving {
	 ...
	 */
	protected void updateCreeperScale(EntityCreeper par1EntityCreeper,
			float par2) {
	 ...
	 * getColorMultiplier
	 */
	protected int updateCreeperColorMultiplier(EntityCreeper par1EntityCreeper,
	...
	protected int func_27006_a(EntityCreeper par1EntityCreeper, int par2,
			float par3) {
	...
	protected int func_27007_b(EntityCreeper par1EntityCreeper, int par2,
			float par3) {
		return -1;
	}
