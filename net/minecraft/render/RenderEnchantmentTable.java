...
public class RenderEnchantmentTable extends TileEntitySpecialRenderer {
	...
	public void func_40449_a(
			TileEntityEnchantmentTable par1TileEntityEnchantmentTable,
		...
		for (f1 = par1TileEntityEnchantmentTable.bookRotation2
				- par1TileEntityEnchantmentTable.bookRotationPrev; f1 >= (float) Math.PI; f1 -= ((float) Math.PI * 2F)) {
		}
		...
		float f3 = par1TileEntityEnchantmentTable.pageFlipPrev
				+ (par1TileEntityEnchantmentTable.pageFlip - par1TileEntityEnchantmentTable.pageFlipPrev)
				* par8 + 0.25F;
		float f4 = par1TileEntityEnchantmentTable.pageFlipPrev
				+ (par1TileEntityEnchantmentTable.pageFlip - par1TileEntityEnchantmentTable.pageFlipPrev)
				* par8 + 0.75F;
		...
		float f5 = par1TileEntityEnchantmentTable.bookSpreadPrev
	...
	public void renderTileEntityAt(TileEntity par1TileEntity, double par2,
		...
		func_40449_a((TileEntityEnchantmentTable) par1TileEntity, par2, par4,
				par6, par8);
	}
}
