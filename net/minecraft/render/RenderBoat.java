...
import net.minecraft.entity.models.ModelBoat;
...
public class RenderBoat extends Render {
	 ...
	 */
	public void renderBoat(EntityBoat par1EntityBoat, double par2, double par4,
		...
		if (f > 0.0F) {
			GL11.glRotatef(((MathHelper.sin(f) * f * f1) / 10F)
					* (float) par1EntityBoat.getForwardDirection(), 1.0F, 0.0F,
					0.0F);
		}
