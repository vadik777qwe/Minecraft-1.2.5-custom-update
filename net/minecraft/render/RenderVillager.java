...
import net.minecraft.entity.models.ModelVillager;
...
public class RenderVillager extends RenderLiving {
	...
	protected int func_40293_a(EntityVillager par1EntityVillager, int par2,
			float par3) {
		return -1;
	}

	public void renderVillager(EntityVillager par1EntityVillager, double par2,
			double par4, double par6, float par8, float par9) {
		super.doRenderLiving(par1EntityVillager, par2, par4, par6, par8, par9);
	}

	protected void func_40290_a(EntityVillager entityvillager, double d,
			double d1, double d2) {
	}
