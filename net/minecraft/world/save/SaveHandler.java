...
public class SaveHandler implements ISaveHandler {
	...
	/**
	 * gets the File object corresponding to the base directory of this save
	 * (saves/404 for a save called 404 etc)
	 */
	...
	public void saveWorldInfoAndPlayer(WorldInfo par1WorldInfo, List par2List) {
		NBTTagCompound nbttagcompound = par1WorldInfo
				.getNBTTagCompoundWithPlayers(par2List);
	...
	public File getMapFileFromName(String par1Str) {
		return new File(mapDataDir, (new StringBuilder()).append(par1Str)
				.append(".dat").toString());
	}
