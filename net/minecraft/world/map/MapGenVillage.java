...
import net.minecraft.structures.StructureVillageStart;
import java.util.*;
...
public class MapGenVillage extends MapGenStructure {
	...
	protected boolean canSpawnStructureAtCoords(int par1, int par2) {
		...
		if (par1 == k && par2 == l) {
			boolean flag = worldObj.getWorldChunkManager().areBiomesViable(
					par1 * 16 + 8, par2 * 16 + 8, 0, villageSpawnBiomes);
	...
	protected StructureStart getStructureStart(int par1, int par2) {
		return new StructureVillageStart(worldObj, rand, par1, par2,
				terrainType);
	}
