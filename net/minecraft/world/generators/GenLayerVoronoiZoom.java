package net.minecraft.world.generators;
	...
	public int[] getInts(int par1, int par2, int par3, int par4) {
		...
		for (int l1 = 0; l1 < i1 - 1; l1++) {
			...
			for (int l2 = 0; l2 < l - 1; l2++) {
				...
				double d3 = ((double) nextInt(1024) / 1024D - 0.5D) * d
						+ (double) i;
				...
				double d6 = ((double) nextInt(1024) / 1024D - 0.5D) * d
						+ (double) i;
				initChunkSeed(l2 + j + 1 << byte0, l1 + k + 1 << byte0);
				double d7 = ((double) nextInt(1024) / 1024D - 0.5D) * d
						+ (double) i;
				double d8 = ((double) nextInt(1024) / 1024D - 0.5D) * d
						+ (double) i;
				...
				for (int k3 = 0; k3 < i; k3++) {
					...
					for (int i4 = 0; i4 < i; i4++) {
						double d9 = ((double) k3 - d2) * ((double) k3 - d2)
								+ ((double) i4 - d1) * ((double) i4 - d1);
						double d10 = ((double) k3 - d4) * ((double) k3 - d4)
								+ ((double) i4 - d3) * ((double) i4 - d3);
						double d11 = ((double) k3 - d6) * ((double) k3 - d6)
								+ ((double) i4 - d5) * ((double) i4 - d5);
						double d12 = ((double) k3 - d8) * ((double) k3 - d8)
								+ ((double) i4 - d7) * ((double) i4 - d7);
		...
		for (int j2 = 0; j2 < par4; j2++) {
			System.arraycopy(ai1, (j2 + (par2 & i - 1)) * (l << byte0)
					+ (par1 & i - 1), ai2, j2 * par3, par3);
		}
