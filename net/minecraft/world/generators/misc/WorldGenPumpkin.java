	...
	public boolean generate(World par1World, Random par2Random, int par3,
		...
		for (int i = 0; i < 64; i++) {
			...
			if (par1World.isAirBlock(j, k, l)
					&& par1World.getBlockId(j, k - 1, l) == Block.grass.blockID
					&& Block.pumpkin.canPlaceBlockAt(par1World, j, k, l)) {
				par1World.setBlockAndMetadata(j, k, l, Block.pumpkin.blockID,
