		...
		for (int i = 0; i < par4; i++) {
			for (int j = 0; j < par3; j++) {
				...
				if (k == BiomeGenBase.mushroomIsland.biomeID) {
					...
					if (l == BiomeGenBase.ocean.biomeID
							|| k1 == BiomeGenBase.ocean.biomeID
							|| j2 == BiomeGenBase.ocean.biomeID
							|| i3 == BiomeGenBase.ocean.biomeID) {
				...
				if (k != BiomeGenBase.ocean.biomeID
						&& k != BiomeGenBase.river.biomeID
						&& k != BiomeGenBase.swampland.biomeID
						&& k != BiomeGenBase.extremeHills.biomeID) {
					int i1 = ai[j + 1 + ((i + 1) - 1) * (par3 + 2)];
					int l1 = ai[j + 1 + 1 + (i + 1) * (par3 + 2)];
					int k2 = ai[((j + 1) - 1) + (i + 1) * (par3 + 2)];
					int j3 = ai[j + 1 + (i + 1 + 1) * (par3 + 2)];

					if (i1 == BiomeGenBase.ocean.biomeID
							|| l1 == BiomeGenBase.ocean.biomeID
							|| k2 == BiomeGenBase.ocean.biomeID
							|| j3 == BiomeGenBase.ocean.biomeID) {
				...
				if (k == BiomeGenBase.extremeHills.biomeID) {
					...
					if (j1 != BiomeGenBase.extremeHills.biomeID
							|| i2 != BiomeGenBase.extremeHills.biomeID
							|| l2 != BiomeGenBase.extremeHills.biomeID
							|| k3 != BiomeGenBase.extremeHills.biomeID) {
